...
contract('BorrowerOperations', async accounts => {
  ...
  const testCorpus = ({ withProxy = false }) => {
    ...
    it('withdrawLUSD(): reverts when withdrawal would leave trove with ICR < MCR', async () => {
      ...
      await assertRevert(
        borrowerOperations.withdrawLUSD(th._100pct, LUSDwithdrawal, alice, alice, { from: alice }),
        'BorrowerOps: An operation that would result in ICR < MCR is not permitted'
      );
    });
    ...
    it('withdrawLUSD(): decays a non-zero base rate', async () => {
      ...
      await openTrove({
        extraLUSDAmount: toBN(dec(20, 18)),
        ICR: toBN(dec(2, 18)),
        extraParams: { from: A },
      });
      await openTrove({
      ...
      // D withdraws LUSD
      await borrowerOperations.withdrawLUSD(th._100pct, dec(1, 18), A, A, {
        from: D,
      });
    ...
    it('withdrawLUSD(): reverts if max fee > 100%', async () => {
      ...
      await assertRevert(
        borrowerOperations.withdrawLUSD(dec(2, 18), dec(1, 18), A, A, {
          from: A,
        }),
        'Max fee percentage must be between 0.5% and 100%'
      );
      await assertRevert(
        borrowerOperations.withdrawLUSD('1000000000000000001', dec(1, 18), A, A, { from: A }),
        'Max fee percentage must be between 0.5% and 100%'
      );
    });
    ...
    it('withdrawLUSD(): reverts if max fee < 0.5% in Normal mode', async () => {
      ...
      await assertRevert(
        borrowerOperations.withdrawLUSD(0, dec(1, 18), A, A, { from: A }),
        'Max fee percentage must be between 0.5% and 100%'
      );
      await assertRevert(
        borrowerOperations.withdrawLUSD(1, dec(1, 18), A, A, { from: A }),
        'Max fee percentage must be between 0.5% and 100%'
      );
      await assertRevert(
        borrowerOperations.withdrawLUSD('4999999999999999', dec(1, 18), A, A, {
          from: A,
        }),
        'Max fee percentage must be between 0.5% and 100%'
      );
    ...
    it('withdrawLUSD(): reverts if fee exceeds max fee percentage', async () => {
      await openTrove({
        extraLUSDAmount: toBN(dec(60, 18)),
        ICR: toBN(dec(2, 18)),
        extraParams: { from: A },
      });
      await openTrove({
      ...
      await openTrove({
        extraLUSDAmount: toBN(dec(70, 18)),
        ICR: toBN(dec(2, 18)),
        extraParams: { from: C },
      });
      await openTrove({
        extraLUSDAmount: toBN(dec(80, 18)),
        ICR: toBN(dec(2, 18)),
        extraParams: { from: D },
      });
      await openTrove({
        extraLUSDAmount: toBN(dec(180, 18)),
        ICR: toBN(dec(2, 18)),
        extraParams: { from: E },
      });
      ...
      await assertRevert(
        borrowerOperations.withdrawLUSD(lessThan5pct, dec(3, 18), A, A, {
          from: A,
        }),
      ...
      await assertRevert(
        borrowerOperations.withdrawLUSD(dec(1, 16), dec(1, 18), A, A, {
          from: B,
        }),
        'Fee exceeded provided maximum'
      );
      ...
      await assertRevert(
        borrowerOperations.withdrawLUSD(dec(3754, 13), dec(1, 18), A, A, {
          from: C,
        }),
        'Fee exceeded provided maximum'
      );
      ...
      await assertRevert(
        borrowerOperations.withdrawLUSD(dec(5, 15), dec(1, 18), A, A, {
          from: D,
        }),
        'Fee exceeded provided maximum'
      );
    ...
    it('withdrawLUSD(): succeeds when fee is less than max fee percentage', async () => {
      ...
      const tx4 = await borrowerOperations.withdrawLUSD(dec(37659, 13), dec(1, 18), A, A, {
        from: D,
      });
    ...
    it("withdrawLUSD(): doesn't change base rate if it is already zero", async () => {
      ...
      // D withdraws LUSD
      await borrowerOperations.withdrawLUSD(th._100pct, dec(37, 18), A, A, {
        from: D,
      });
      ...
      // E opens trove
      await borrowerOperations.withdrawLUSD(th._100pct, dec(12, 18), A, A, {
        from: E,
      });
    ...
    it("withdrawLUSD(): lastFeeOpTime doesn't update if less time than decay interval has passed since the last fee operation", async () => {
      ...
      await borrowerOperations.withdrawLUSD(th._100pct, dec(1, 18), C, C, {
        from: C,
      });
    ...
    it('withdrawLUSD(): reverts when calling address does not have active trove', async () => {
      ...
      const txBob = await borrowerOperations.withdrawLUSD(th._100pct, dec(100, 18), bob, bob, {
        from: bob,
      });
      assert.isTrue(txBob.receipt.status);
    ...
    it('withdrawLUSD(): reverts when requested withdrawal amount is zero LUSD', async () => {
      ...
      try {
        const txAlice = await borrowerOperations.withdrawLUSD(th._100pct, 0, alice, alice, {
          from: alice,
        });
    ...
    it('withdrawLUSD(): reverts when system is in Recovery Mode', async () => {
      ...
      // Withdrawal possible when recoveryMode == false
      const txAlice = await borrowerOperations.withdrawLUSD(th._100pct, dec(100, 18), alice, alice, {
        from: alice,
      });
      assert.isTrue(txAlice.receipt.status);
    ...
    it('withdrawLUSD(): reverts when a withdrawal would cause the TCR of the system to fall below the CCR', async () => {
      ...
      try {
        const txBob = await borrowerOperations.withdrawLUSD(th._100pct, dec(1, 18), bob, bob, {
          from: bob,
        });
        assert.isFalse(txBob.receipt.status);
      } catch (err) {
    ...
    it('withdrawLUSD(): reverts if system is in Recovery Mode', async () => {
      ...
      try {
        const txData = await borrowerOperations.withdrawLUSD(th._100pct, '200', alice, alice, {
          from: alice,
        });
        assert.isFalse(txData.receipt.status);
      } catch (err) {
    ...
    it("withdrawLUSD(): increases the Trove's LUSD debt by the correct amount", async () => {
      ...
      await borrowerOperations.withdrawLUSD(th._100pct, await getNetBorrowingAmount(100), alice, alice, {
        from: alice,
      });
    ...
    it('withdrawLUSD(): increases LUSD debt in ActivePool by correct amount', async () => {
      ...
      await borrowerOperations.withdrawLUSD(th._100pct, await getNetBorrowingAmount(dec(10000, 18)), alice, alice, {
        from: alice,
      });
    ...
    it('repayLUSD(): reverts when repayment would leave trove with ICR < MCR', async () => {
      ...
      await assertRevert(
        borrowerOperations.repayLUSD(LUSDRepayment, alice, alice, {
          from: alice,
        }),
        'BorrowerOps: An operation that would result in ICR < MCR is not permitted'
      );
    ...
    it('repayLUSD(): Succeeds when it would leave trove with net debt >= minimum net debt', async () => {
      ...
      const repayTxB = await borrowerOperations.repayLUSD(dec(19, 25), B, B, {
        from: B,
      });
    ...
    it('repayLUSD(): reverts when calling address does not have active trove', async () => {
      ...
      const txBob = await borrowerOperations.repayLUSD(dec(10, 18), bob, bob, {
        from: bob,
      });
      assert.isTrue(txBob.receipt.status);
      ...
      try {
        const txCarol = await borrowerOperations.repayLUSD(dec(10, 18), carol, carol, {
          from: carol,
        });
        assert.isFalse(txCarol.receipt.status);
      } catch (err) {
    ...
    it('repayLUSD(): reverts when attempted repayment is > the debt of the trove', async () => {
      ...
      try {
        const txAlice = await borrowerOperations.repayLUSD(aliceDebt.add(toBN(dec(1, 18))), alice, alice, {
          from: alice,
        });
        assert.isFalse(txAlice.receipt.status);
      } catch (err) {
    ...
    it('repayLUSD(): can repay debt in Recovery Mode', async () => {
      ...
      const tx = await borrowerOperations.repayLUSD(aliceDebtBefore.div(toBN(10)), alice, alice, {
        from: alice,
      });
    ...
    it('repayLUSD(): Reverts if borrower has insufficient LUSD balance to cover his debt repayment', async () => {
      ...
      await lusdToken.transfer(C, bobBalBefore.sub(toBN(dec(5, 18))), {
        from: B,
      });
    ...
    it('adjustTrove(): reverts when adjustment would leave trove with ICR < MCR', async () => {
      ...
      await assertRevert(
        borrowerOperations.adjustTrove(th._100pct, 0, LUSDRepayment, false, alice, alice, {
          from: alice,
          value: collTopUp,
        }),
        'BorrowerOps: An operation that would result in ICR < MCR is not permitted'
    ...
    it('adjustTrove(): borrowing at non-zero base rate sends LUSD fee to LQTY staking contract', async () => {
      ...
      // D adjusts trove
      await openTrove({
        extraLUSDAmount: toBN(dec(37, 18)),
        ICR: toBN(dec(2, 18)),
        extraParams: { from: D },
      });
    ...
    it('adjustTrove(): reverts when calling address has no active trove', async () => {
      ...
      await borrowerOperations.adjustTrove(th._100pct, 0, dec(50, 18), true, alice, alice, {
        from: alice,
        value: dec(1, 'ether'),
      });

      try {
        const txCarol = await borrowerOperations.adjustTrove(th._100pct, 0, dec(50, 18), true, carol, carol, {
          from: carol,
          value: dec(1, 'ether'),
        });
        assert.isFalse(txCarol.receipt.status);
    ...
    it('adjustTrove(): reverts in Recovery Mode when the adjustment would reduce the TCR', async () => {
      ...
      const txAlice = await borrowerOperations.adjustTrove(th._100pct, 0, dec(50, 18), true, alice, alice, {
        from: alice,
        value: dec(1, 'ether'),
      });
      assert.isTrue(txAlice.receipt.status);
      ...
      try {
        ...
        const txAlice = await borrowerOperations.adjustTrove(th._100pct, dec(1, 'ether'), 0, false, alice, alice, {
          from: alice,
        });
        assert.isFalse(txAlice.receipt.status);
      } catch (err) {
      ...
      try {
        ...
        const txBob = await borrowerOperations.adjustTrove(th._100pct, 0, dec(111, 18), true, bob, bob, {
          from: bob,
          value: dec(1, 'ether'),
        });
        assert.isFalse(txBob.receipt.status);
    ...
    it('adjustTrove(): A trove with ICR < CCR in Recovery Mode can adjust their trove to ICR > CCR', async () => {
      ...
      const tx = await borrowerOperations.adjustTrove(th._100pct, 0, debtIncrease, true, alice, alice, {
        from: alice,
        value: collIncrease,
      });
      assert.isTrue(tx.receipt.status);
    ...
    it('adjustTrove(): debt increase in Recovery Mode charges no fee', async () => {
      ...
      await openTrove({
        extraLUSDAmount: toBN(dec(200000, 18)),
        ICR: toBN(dec(2, 18)),
        extraParams: { from: bob },
      });
    ...
    it('adjustTrove(): reverts when change would cause the ICR of the trove to fall below the MCR', async () => {
      ...
      try {
        const txBob = await borrowerOperations.adjustTrove(th._100pct, 0, dec(100, 18), true, bob, bob, {
          from: bob,
          value: dec(1, 'ether'),
        });
        assert.isFalse(txBob.receipt.status);
    ...
    it("adjustTrove(): updates borrower's debt and coll with a decrease in both", async () => {
      ...
      await borrowerOperations.adjustTrove(th._100pct, dec(500, 'finney'), dec(50, 18), false, alice, alice, {
        from: alice,
      });
    ...
    it("adjustTrove(): updates borrower's  debt and coll with coll increase, debt decrease", async () => {
      ...
      await borrowerOperations.adjustTrove(th._100pct, 0, dec(50, 18), false, alice, alice, {
        from: alice,
    ...
    it('adjustTrove(): changes LUSDToken balance by the requested decrease', async () => {
      ...
      // Alice adjusts trove - coll decrease and debt decrease
      await borrowerOperations.adjustTrove(th._100pct, dec(100, 'finney'), dec(10, 18), false, alice, alice, {
        from: alice,
      });
    ...
    it('adjustTrove(): Reverts if requested coll withdrawal and ether is sent', async () => {
      ...
      await assertRevert(
        borrowerOperations.adjustTrove(th._100pct, dec(1, 'ether'), dec(100, 18), true, alice, alice, {
          from: alice,
          value: dec(3, 'ether'),
        }),
    ...
    it("adjustTrove(): Reverts if requested coll withdrawal is greater than trove's collateral", async () => {
      ...
      await assertRevert(
        borrowerOperations.adjustTrove(th._100pct, aliceColl.add(toBN(dec(37, 'ether'))), 0, false, bob, bob, {
          from: bob,
        })
      );
    });
    ...
    if (!withProxy) {
      ...
      it('Internal _adjustTrove(): reverts when op is a withdrawal and _borrower param is not the msg.sender', async () => {
        ...
        const txPromise_B = borrowerOperations.callInternalAdjustLoan(bob, dec(1, 18), dec(1, 18), true, alice, alice, {
          from: owner,
        });
    ...
    it("closeTrove(): reduces a Trove's collateral to zero", async () => {
      ...
      // To compensate borrowing fees
      await lusdToken.transfer(alice, dennisLUSD.div(toBN(2)), {
        from: dennis,
      });
    ...
    it('closeTrove(): applies pending rewards', async () => {
      ...
      assert.isAtMost(
        th.getDifference(defaultPool_LUSDDebt_afterAliceCloses, defaultPool_LUSDDebt.sub(pendingDebtReward_A)),
        1000
      );
    ...
    it('openTrove(): reverts if net debt < minimum net debt', async () => {
      ...
      const txCPromise = borrowerOperations.openTrove(th._100pct, MIN_NET_DEBT.sub(toBN(dec(173, 18))), C, C, {
        from: C,
        value: dec(100, 30),
      });
    ...
    it('openTrove(): decays a non-zero base rate', async () => {
      ...
      // E opens trove
      await openTrove({
        extraLUSDAmount: toBN(dec(12, 18)),
        ICR: toBN(dec(2, 18)),
        extraParams: { from: E },
      });
    ...
    if (!withProxy) {
      ...
      it('openTrove(): borrowing at non-zero base records the (drawn debt + fee  + liq. reserve) on the Trove struct', async () => {
        ...
        // D withdraws LUSD
        const openTroveTx = await borrowerOperations.openTrove(th._100pct, D_LUSDRequest, ZERO_ADDRESS, ZERO_ADDRESS, {
          from: D,
          value: dec(200, 'ether'),
        });
    ...
    it('openTrove(): Borrowing at non-zero base rate sends requested amount to the user', async () => {
      ...
      await borrowerOperations.openTrove(th._100pct, LUSDRequest_D, D, D, {
        from: D,
        value: dec(500, 'ether'),
      });
    ...
    it('openTrove(): Borrowing at zero base rate charges minimum fee', async () => {
      ...
      const txC = await borrowerOperations.openTrove(th._100pct, LUSDRequest, ZERO_ADDRESS, ZERO_ADDRESS, {
        value: dec(100, 'ether'),
        from: C,
      });
    ...
    it('openTrove(): creates a new Trove and assigns the correct collateral and debt amount', async () => {
      ...
      const expectedDebt = LUSDRequest.add(await troveManager.getBorrowingFee(LUSDRequest)).add(LUSD_GAS_COMPENSATION);
    ...
    it("openTrove(): increases the Trove's LUSD debt by the correct amount", async () => {
      ...
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveLUSDAmount(dec(10000, 18)), alice, alice, {
        from: alice,
        value: dec(100, 'ether'),
      });
    ...
    describe('getNewTCRFromTroveChange() returns the correct TCR', async () => {
      ...
      it('collChange = 0, debtChange = 0', async () => {
        ...
        await borrowerOperations.openTrove(th._100pct, troveLUSDAmount, alice, alice, {
          from: alice,
          value: troveColl,
        });
        await borrowerOperations.openTrove(th._100pct, troveLUSDAmount, bob, bob, {
          from: bob,
          value: troveColl,
        });
        ...
        const expectedTCR = troveColl.add(liquidatedColl).mul(price).div(troveTotalDebt.add(liquidatedDebt));
    ...
    if (!withProxy) {
      it('closeTrove(): fails if owner cannot receive ETH', async () => {
        ...
        await lusdToken.transfer(nonPayable.address, dec(10000, 18), {
          from: alice,
        });
