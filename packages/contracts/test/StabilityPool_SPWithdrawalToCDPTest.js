  ...
  async accounts => {
    ...
    describe('Stability Pool Withdrawal', async () => {
      ...
      */
      ...
      it('withdrawETHGainToTrove(): Depositor withdraws correct compounded deposit after liquidation empties the pool', async () => {
        ...
        assert.isAtMost(
          th.getDifference(
            (await stabilityPool.getCompoundedLUSDDeposit(flyn)).toString(),
            '0'
          ),
          100000
        );
        assert.isAtMost(
          th.getDifference(
            (await stabilityPool.getCompoundedLUSDDeposit(graham)).toString(),
            '0'
          ),
          100000
        );
        assert.isAtMost(
          th.getDifference(
            (await stabilityPool.getCompoundedLUSDDeposit(harriet)).toString(),
            '0'
          ),
          100000
        );
    ...
    */
      ...
      it('withdrawETHGainToTrove(): Large liquidated coll/debt, deposits and ETH price', async () => {
        ...
        // Check LUSD balances
        const aliceLUSDBalance = await stabilityPool.getCompoundedLUSDDeposit(
          alice
        );
        ...
        const bobLUSDBalance = await stabilityPool.getCompoundedLUSDDeposit(
          bob
        );
