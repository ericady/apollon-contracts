...
contract DebtToken is CheckContract, IDebtToken {
    ...
    bool immutable internal _IS_STABLE_COIN;
    ...
    function getPrice(PriceCache memory _priceCache) override external returns (uint) {
    ...
    function domainSeparator() view external override returns (bytes32) {
