...
interface ITroveManager is IBBase {
    ...
    function getCurrentICR(address _borrower, PriceCache memory _priceCache) external returns (uint ICR, uint currentDebtInStable);
...
//    ) external;
    ...
    function increaseTroveColl(address _borrower, CollTokenAmount[] memory _collTokenAmounts) external;
    function decreaseTroveColl(address _borrower, CollTokenAmount[] memory _collTokenAmounts) external;
