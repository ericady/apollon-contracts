...
export function createCollTokenAddedEvent(_tokenAddress: Address, _isGovToken: boolean): CollTokenAdded {
...
export function createTokenManagerInitializedEvent(
  ...
  let tokenManagerInitializedEvent = changetype<TokenManagerInitialized>(newMockEvent());
