...
import { CollTokenAdded } from "../generated/schema"
import { CollTokenAdded as CollTokenAddedEvent } from "../generated/TokenManager/TokenManager"
...
describe("Describe entity assertions", () => {
  beforeAll(() => {
    ...
    let newCollTokenAddedEvent = createCollTokenAddedEvent(
      _tokenAddress,
      _isGovToken
    )
