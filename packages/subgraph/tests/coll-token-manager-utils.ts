...
export function createCollTokenAddedEvent(_collTokenAddress: Address): CollTokenAdded {
...
export function createCollTokenManagerInitializedEvent(_priceFeedAddress: Address): CollTokenManagerInitialized {
  let collTokenManagerInitializedEvent = changetype<CollTokenManagerInitialized>(newMockEvent());
