...
export interface DummyContractDataAbiInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "name"
      | "deprecate"
...
export interface DummyContractDataAbi extends BaseContract {
  connect(runner?: ContractRunner | null): DummyContractDataAbi;
  waitForDeployment(): Promise<this>;

  interface: DummyContractDataAbiInterface;
