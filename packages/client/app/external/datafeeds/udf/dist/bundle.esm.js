  ...
  _updateQuotes(updateType) {
    ...
    for (const listenerGuid in this._subscribers) {
      ...
      this._quotesProvider
        .getQuotes(
          updateType === 1 /* SymbolsType.Fast */ ? subscriptionRecord.fastSymbols : subscriptionRecord.symbols,
        )
        .then((data) => {
          this._requestsPending--;
          if (!this._subscribers.hasOwnProperty(listenerGuid)) {
        ...
        .then((response) => {
          ...
          if (response.s !== undefined) {
            ...
            const listedExchange =
              (_a = response.listed_exchange) !== null && _a !== void 0 ? _a : response['exchange-listed'];
            const tradedExchange =
              (_b = response.exchange) !== null && _b !== void 0 ? _b : response['exchange-traded'];
            ...
            const result = {
              ...
              original_unit_id:
                (_g = response.original_unit_id) !== null && _g !== void 0 ? _g : response['original-unit-id'],
              unit_conversion_types:
                (_h = response.unit_conversion_types) !== null && _h !== void 0
                  ? _h
                  : response['unit-conversion-types'],
              has_intraday:
                (_k = (_j = response.has_intraday) !== null && _j !== void 0 ? _j : response['has-intraday']) !==
                  null && _k !== void 0
                  ? _k
                  : false,
              visible_plots_set:
                (_l = response.visible_plots_set) !== null && _l !== void 0 ? _l : response['visible-plots-set'],
              minmov:
                (_o = (_m = response.minmovement) !== null && _m !== void 0 ? _m : response.minmov) !== null &&
                _o !== void 0
                  ? _o
                  : 0,
              ...
              session_holidays:
                (_r = response.session_holidays) !== null && _r !== void 0 ? _r : response['session-holidays'],
              supported_resolutions:
                (_u =
                  (_t =
                    (_s = response.supported_resolutions) !== null && _s !== void 0
                      ? _s
                      : response['supported-resolutions']) !== null && _t !== void 0
                    ? _t
                    : this._configuration.supported_resolutions) !== null && _u !== void 0
                  ? _u
                  : [],
              has_daily:
                (_w = (_v = response.has_daily) !== null && _v !== void 0 ? _v : response['has-daily']) !== null &&
                _w !== void 0
                  ? _w
                  : true,
              intraday_multipliers:
                (_y =
                  (_x = response.intraday_multipliers) !== null && _x !== void 0
                    ? _x
                    : response['intraday-multipliers']) !== null && _y !== void 0
                  ? _y
                  : ['1', '5', '15', '30', '60'],
              ...
              has_empty_bars:
                (_0 = response.has_empty_bars) !== null && _0 !== void 0 ? _0 : response['has-empty-bars'],
              volume_precision:
                (_1 = response.volume_precision) !== null && _1 !== void 0 ? _1 : response['volume-precision'],
