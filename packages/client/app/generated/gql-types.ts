...
export type GetAllDebtTokensQueryVariables = Exact<{ [key: string]: never; }>;


export type GetAllDebtTokensQuery = { __typename?: 'Query', getDebtTokens: Array<{ __typename?: 'DebtTokenMeta', token: { __typename?: 'Token', address: string } }> };
