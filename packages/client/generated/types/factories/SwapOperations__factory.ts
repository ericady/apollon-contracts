...
export class SwapOperations__factory {
  static readonly abi = _abi;
  static createInterface(): SwapOperationsInterface {
    return new Interface(_abi) as SwapOperationsInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): SwapOperations {
    return new Contract(address, _abi, runner) as unknown as SwapOperations;
  }
}
