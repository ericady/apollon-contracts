...
export interface BorrowerOperationsInterface extends Interface {
  ...
  encodeFunctionData(
    ...
    values: [AddressLike, AddressLike, IBase.TokenAmountStruct[], BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "repayDebtFromPoolBurn",
...
export namespace SentBorrowingFeesToReserveEvent {
  export type InputTuple = [_borrower: AddressLike, amount: BigNumberish];
  export type OutputTuple = [_borrower: string, amount: bigint];
  export interface OutputObject {
    _borrower: string;
    amount: bigint;
  }
...
export interface BorrowerOperations extends BaseContract {
  ...
  repayDebtFromPoolBurn: TypedContractMethod<
    [borrower: AddressLike, _debts: IBase.TokenAmountStruct[]],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "repayDebtFromPoolBurn"
  ): TypedContractMethod<
    [borrower: AddressLike, _debts: IBase.TokenAmountStruct[]],
    [void],
    "nonpayable"
  ...
  >;
  getEvent(
    key: "SentBorrowingFeesToReserve"
  ): TypedContractEvent<
    SentBorrowingFeesToReserveEvent.InputTuple,
    SentBorrowingFeesToReserveEvent.OutputTuple,
    SentBorrowingFeesToReserveEvent.OutputObject
  >;
  getEvent(
    key: "TroveCreated"
  ): TypedContractEvent<
  ...
  filters: {
    "BorrowerOperationsInitialized(address,address,address,address,address,address,address,address)": TypedContractEvent<
      BorrowerOperationsInitializedEvent.InputTuple,
      BorrowerOperationsInitializedEvent.OutputTuple,
      BorrowerOperationsInitializedEvent.OutputObject
    >;
    ...
    "SentBorrowingFeesToReserve(address,uint256)": TypedContractEvent<
      SentBorrowingFeesToReserveEvent.InputTuple,
      SentBorrowingFeesToReserveEvent.OutputTuple,
      SentBorrowingFeesToReserveEvent.OutputObject
    >;
    SentBorrowingFeesToReserve: TypedContractEvent<
      SentBorrowingFeesToReserveEvent.InputTuple,
      SentBorrowingFeesToReserveEvent.OutputTuple,
      SentBorrowingFeesToReserveEvent.OutputObject
    >;
