(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [2704],
  {
    ...
    40211: (e) => {
      e.exports = { container: 'container-c8Hkfy8e', separator: 'separator-c8Hkfy8e', section: 'section-c8Hkfy8e' };
    },
    55002: (e) => {
      e.exports = {
        ...
        return r.createElement(
          ...
          r.createElement(
            ...
            r.createElement(
              ...
              r.createElement('div', { className: s()(n ? E.textWrap : E.ellipsis) }, t),
              o && r.createElement('div', { className: s()(E.ellipsis, E.subtitle) }, o),
            ),
            u,
            i &&
              !v &&
              r.createElement(
                ...
                r.createElement(g.Icon, { className: E.icon, icon: y, 'data-name': 'close', 'data-role': 'button' }),
              ),
          ),
        );
      }
      ...
      class A extends r.PureComponent {
            ...
            (this._handleKeyDown = (e) => {
              if (!e.defaultPrevented) {
                ...
                (function (e) {
                  ...
                  ((n = e), [9, a.Modifiers.Shift + 9].includes((0, a.hashFromEvent)(n)) && n.stopPropagation());
              }
            }),
            (this._requestResize = () => {
        ...
        render() {
          ...
          return r.createElement(p.MatchMedia, { rule: h.DialogBreakpoints.SmallHeight }, (m) =>
            r.createElement(p.MatchMedia, { rule: h.DialogBreakpoints.TabletSmall }, (h) =>
              r.createElement(
                u.PopupDialog,
                {
                  rounded: !(h || R) && L,
                  ...
                  containerAriaLabel: U,
                  containerTabIndex: H,
                  calculateDialogPosition: R && V ? this._calculatePositionWithOffsets : void 0,
                  shadowed: $,
                  ...Y,
                },
                r.createElement(
                  'div',
                  { className: s()(S.wrapper, t), 'data-name': l, 'data-dialog-name': J },
                  void 0 !== i &&
                    r.createElement(b, {
                      draggable: D && !(h || R),
                  ...
                  A && r.createElement(d.Separator, { className: S.separator }),
                  r.createElement(f.PopupContext.Consumer, null, (e) => this._renderChildren(e, h || R)),
                ),
              ),
            ),
          );
    ...
    69654: (e, t, n) => {
      ...
      function u(e) {
        ...
        return r.createElement(
          ...
          u && r.createElement('div', { className: c.cancel, onClick: u }, s.t(null, void 0, n(20036))),
        );
      }
      function d(e) {
        const {
    ...
    28587: (e, t, n) => {
      ...
      const S = r.memo(
        function (e) {
          ...
          return r.createElement(
            'div',
            { className: h()(w.action, c && w.active, y, f && w.withDescription, d && w.selected), onClick: C, ref: p },
            m &&
              (void 0 !== n
        ...
        return r.createElement(I.AdaptivePopupDialog, {
          ...
          render: function () {
            return r.createElement(
              r.Fragment,
              null,
              r.createElement(L.DialogSearch, { placeholder: p.t(null, void 0, n(52298)), onChange: v, reference: h }),
              r.createElement(
                'div',
      ...
      function O(e) {
        ...
        return r.createElement(s.MatchMedia, { rule: c.DialogBreakpoints.TabletSmall }, (e) =>
          e
            ...
            : r.createElement(R, { ...n, ...C, position: (0, u.getPopupPositioner)(t, M), doNotCloseOn: t }),
        );
        function y() {
          ...
          (this._rootElem = document.createElement('div')),
            (this.close = () => {
              null !== this._rootElem &&
                ...
                i.favoriteCurrencyUnitConversionService.getOnChange().unsubscribe(this, this._render),
                (this._rootElem = null),
            ...
            return (
              n.forEach((e) => {
                ...
                if ((0, r.isString)(t) && f.test(t))
                  return (h = 3), void (d = null === (s = t.match(f)) || void 0 === s ? void 0 : s.index);
                if ((0, r.isString)(i) && f.test(i))
                  return (h = 2), void (d = null === (a = i.match(f)) || void 0 === a ? void 0 : a.index);
                if ((0, r.isString)(i) && p.test(i))
                  return (h = 2), void (d = null === (l = i.match(p)) || void 0 === l ? void 0 : l.index);
                if (Array.isArray(u))
                  for (const e of u)
                    if (f.test(e))
    ...
    95257: (e, t) => {
            ...
            b(s)
              ...
              : null != s &&
                (k(s) &&
                  ...
                  })(s, o + (!s.key || (l && l.key === s.key) ? '' : ('' + s.key).replace(A, '$&/') + '/') + e)),
                t.push(s)),
            1
          );
        if (((l = 0), (i = '' === i ? '.' : i + ':'), b(e)))
          ...
          for (e = u.call(e), c = 0; !(a = e.next()).done; ) l += D((a = a.value), t, o, (u = i + N(a, c++)), s);
        else if ('object' === a)
          throw (
            ((t = String(e)),
            Error(
      ...
      var L = { current: null },
        T = { transition: null },
        B = { ReactCurrentDispatcher: L, ReactCurrentBatchConfig: T, ReactCurrentOwner: w };
      (t.Children = {
        map: R,
        ...
        (t.cloneElement = function (e, t, r) {
          ...
          if (null != t) {
            ...
            for (c in t) _.call(t, c) && !S.hasOwnProperty(c) && (o[c] = void 0 === t[c] && void 0 !== l ? l[c] : t[c]);
          }
    ...
    76197: (e, t, n) => {
      ...
      const l = (0, r.forwardRef)(function (e, t) {
        const { open: n, summary: o, children: l, onStateChange: c, tabIndex: u, className: d, ...h } = e;
        return r.createElement(
          r.Fragment,
          null,
          r.createElement(
      ...
      function c(e, t) {
        return (n, c, u, d) => {
          ...
          const _ = E === r.Top ? -1 * C : C,
            ...
            x = { x: w - (v === s.FromRightToLeft ? n : 0) + g, y: S - (b === i.FromBottomToTop ? c : 0) + _ };
    ...
    84298: (e, t, n) => {
      ...
      function a(e, t, a) {
        ...
        return (E.length > 0 || y.length > 0) && l.push({ id: 'second_section', actions: y.concat(E) }), l;
      }
    },
    79188: (e, t, n) => {
      'use strict';
      ...
      class s extends i.AbstractJsonStoreService {
        constructor(e, t) {
          super(e, t, 'FAVORITE_CURRENCY_UNIT_CONVERSION_CHANGED', 'currencyUnitConversion.favorites', {
            currencies: new Set(),
            units: new Set(),
          });
        }
    ...
    14818: (e, t, n) => {
      ...
      function a(e, t, a) {
        ...
        (C.length > 0 || y.length > 0) &&
          m.actions.push(...y.sort((e, t) => e.label.toLowerCase().localeCompare(t.label.toLowerCase())), ...C),
          m.actions.length > 0 && l.push(m);
    ...
    89691: (e, t, n) => {
      ...
      function r(e, t, n, r, o, i, s, a) {
        return { id: e, label: t, icon: n, description: r, isActive: o, onClick: i, isFavorite: s, onFavoriteClick: a };
      }
