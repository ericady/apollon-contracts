  ...
  [2077],
  {
    ...
    67029: (e, t, n) => {
      ...
      function v(e, t) {
        const {
          ...
          { isGrouped: _, cellState: C, disablePositionAdjustment: R = !1 } = (0, r.useContext)(l.ControlGroupContext),
    ...
    78274: (e, t, n) => {
      ...
      function s(e) {
        ...
        return r.createElement('span', { className: o(a()['inner-slot'], n && a().interactive, i && a().icon, t) }, s);
      }
      function l(e) {
        const { className: t, children: n } = e;
        return r.createElement('span', { className: o(a()['inner-slot'], a()['inner-middle-slot'], t) }, n);
      }
      function u(e) {
        const { className: t, interactive: n = !0, icon: i = !1, children: s } = e;
        return r.createElement('span', { className: o(a()['inner-slot'], n && a().interactive, i && a().icon, t) }, s);
        ...
        return r.createElement(f.ControlSkeleton, {
          ...
          middleSlot: r.createElement(
            ...
            r.createElement('input', {
              ...V,
              className: o(p().input, p()[`size-${P}`], I, F && p()['with-start-slot'], U && p()['with-end-slot']),
              disabled: j,
              readOnly: T,
              ref: Z,
            }),
    ...
    48027: (e, t, n) => {
      ...
      function i(e) {
        ...
        return { ...e, intent: i || (l ? 'primary' : 'default'), highlight: null != a ? a : l, onFocus: c, onBlur: d };
      }
    },
    29202: (e, t, n) => {
      'use strict';
      ...
      const r = (() => {
        ...
        return () => {
          ...
          if (void 0 === e) {
            ...
            null === (t = n.parentNode) || void 0 === t || t.removeChild(n), (e = o - a);
          }
          return e;
        };
      })();
      ...
      function u(e) {
        ...
        if (e && 1 == ++s) {
          ...
          'hidden' !== e.toLowerCase() &&
            ...
            (o(n, 'right', `${r()}px`), (t.style.paddingRight = `${s + r()}px`), (l = !0)),
    ...
    95257: (e, t) => {
      ...
      function R(e, t, o, i, a) {
        ...
        if (((l = 0), (i = '' === i ? '.' : i + ':'), S(e)))
          ...
          for (e = c.call(e), u = 0; !(s = e.next()).done; ) l += R((s = s.value), t, o, (c = i + C(s, u++)), a);
        else if ('object' === s)
          throw (
            ((t = String(e)),
            Error(
      ...
      (t.Children = {
        ...
        (t.cloneElement = function (e, t, r) {
          ...
          if (null != t) {
            ...
            for (u in t) w.call(t, u) && !H.hasOwnProperty(u) && (o[u] = void 0 === t[u] && void 0 !== l ? l[u] : t[u]);
          }
    ...
    57163: (e, t, n) => {
      ...
      function g(e) {
        ...
        return r.createElement(f.Icon, { icon: h, className: a()('apply-common-tooltip', t), title: n ? p : m });
      }
      var v = n(94025),
        y = n(36274);
      var D = n(76894);
          ...
          r.createElement(
            ...
            r.createElement(
              ...
              r.createElement(
                ...
                r.createElement('div', { className: D.title }, s.t(null, void 0, n(99374))),
                r.createElement(g, { className: D.infoHint, isSecondsEnabled: (0, v.isSecondsEnabled)() }),
              ),
              r.createElement(
                'form',
                {
              ...
              b
                ...
                : r.createElement('div', { className: a()(D.hint, D.error) }, s.t(null, void 0, n(72572))),
            ),
          )
        );
      }
      var S = n(51826);
      function w(e) {
        if (S.dialogsOpenerManager.isOpened('ChangeIntervalDialog') || S.dialogsOpenerManager.isOpened('SymbolSearch'))
          return;
