        ...
        w = function (t, e) {
          var n,
            ...
            a =
              ...
              f(c, { x: r, y: o, width: i, height: s, top: o, right: r + i, bottom: s + o, left: r }),
              c);
    ...
    95257: (t, e) => {
      ...
      function R(t, e, r) {
        var o,
          ...
          u = null;
        if (null != e)
          for (o in (void 0 !== e.ref && (u = e.ref), void 0 !== e.key && (s = '' + e.key), e))
        ...
        return { $$typeof: n, type: t, key: s, ref: u, props: i, _owner: O.current };
      }
      function k(t) {
            ...
            g(s)
              ...
              : null != s &&
                (k(s) &&
                  ...
                  })(s, o + (!s.key || (c && c.key === s.key) ? '' : ('' + s.key).replace(T, '$&/') + '/') + t)),
                e.push(s)),
            1
          );
        if (((c = 0), (i = '' === i ? '.' : i + ':'), g(t)))
          ...
          for (t = f.call(t), a = 0; !(u = t.next()).done; ) c += x((u = u.value), e, o, (f = i + C(u, a++)), s);
        else if ('object' === u)
          throw (
            ((e = String(t)),
            Error(
      ...
      var j = { current: null },
        $ = { transition: null },
        P = { ReactCurrentDispatcher: j, ReactCurrentBatchConfig: $, ReactCurrentOwner: O };
      (e.Children = {
        map: M,
        ...
        (e.cloneElement = function (t, e, r) {
          ...
          if (null != e) {
            ...
            for (a in e) E.call(e, a) && !S.hasOwnProperty(a) && (o[a] = void 0 === e[a] && void 0 !== c ? c[a] : e[a]);
          }
          ...
          return { $$typeof: n, type: t.type, key: i, ref: s, props: o, _owner: u };
        }),
        ...
        (e.isValidElement = k),
        (e.lazy = function (t) {
          return { $$typeof: h, _payload: { _status: -1, _result: t }, _init: A };
        }),
        (e.memo = function (t, e) {
