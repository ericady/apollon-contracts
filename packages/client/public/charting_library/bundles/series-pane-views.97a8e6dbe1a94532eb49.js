  ...
  [4079],
  {
    1539: (t, e, a) => {
      ...
      class T {
        ...
        renderer() {
          return (
            this._invalidated && (this._updateImpl(), (this._invalidated = !1)), this._data ? this._renderer : null
          );
        }
        _updateImpl() {
          this._data = null;
          ...
          if (!t) {
            ...
            (m = e.dateFormatter().format(t)), this._series.isDWM() || (T = e.timeFormatter().format(t));
          }
        ...
        _getTargetBar(t) {
          ...
          return (
            t < a && null !== e.first()
              ...
              : t > l && null !== e.last()
              ? ((s = (0, i.ensureNotNull)(e.lastIndex())), (r = (0, i.ensureNotNull)(e.last()).value))
