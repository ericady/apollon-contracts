        ...
        _drawImpl(t) {
          ...
          if (
            (this._data.filled &&
              ...
              ((s.fillStyle = (0, l.generateColor)(this._data.backcolor, this._data.transparency)), s.fill()),
            ...
            if (this._data.rightend === a.LineEnd.Arrow) {
              const t = this._correctArrowPoints(this._points[r - 2], this._points[r - 1], s.lineWidth, d);
              (0, n.drawArrow)(t[0], t[1], s, s.lineWidth, 1);
            }
          }
      ...
      class l {
        ...
        _updateViewInternal() {
          ...
          i.forEach((t, i) => {
            ...
            let l, d;
            t.forEach((t) => {
              const i = null !== t.start ? t.start : (0, s.ensureNotNull)(e.points().range().value()).firstIndex,
                o = t.stop;
              if (o < n || a < i) return;
    ...
    21335: (t, e, i) => {
        ...
        hitTest(t, e) {
          ...
          for (const s of i.histograms) {
            ...
            for (const o of s.bars) {
              ...
              if (l.location === a.HHistLocation.Absolute && (s.xRange.min >= t.x || t.x >= s.xRange.max)) continue;
              null === r &&
                ((r = 0),
                s.bars.forEach((t) => {
              ...
              for (let e = 0; e < o.subBarValues.length; e++) {
                ...
                if (((_ = l), ((t.x >= a && t.x <= l) || (t.x >= l && t.x <= a)) && t.y >= i && t.y <= s))
      ...
      class y {
        ...
        renderer() {
          ...
          for (const e of this._textData) t.append(new l.TextRenderer(e, new n.HitTestResult(n.HitTarget.Regular)));
          return t;
        }
        _resetRenderersData() {
        ...
        _prepareStyles() {
          ...
          for (const t of s) {
            ...
            if (o)
              ...
              const i = (0, x.generateColor)(e.colors[0].value(), e.transparencies[0].value()),
                r = e.colors[1] ? (0, x.generateColor)(e.colors[1].value(), e.transparencies[1].value()) : i;
          ...
          if (this._histBoxBgStyle) {
            ...
            this._rendererData.histBoxBgColor = (0, x.generateColor)(t.color.value(), t.transparency.value());
          }
        }
        _updateViewInternal() {
        ...
        _updateDataForRenderers(t, e, i) {
          ...
          t.forEach((t) => {
            ...
            u.push({ height: n.max - n.min, y: n.min, subBarValues: i, displayedValues: s, styleId: r });
          }),
            u.sort((t, e) => t.y - e.y),
      ...
      class o {
        constructor(t, e, i, s = !1) {
          (this._data = []),
            ...
            (this._hitTestResult =
              void 0 !== i ? new r.HitTestResult(r.HitTarget.Custom, i) : new r.HitTestResult(r.HitTarget.Regular));
        }
        update() {
          this._invalidated = !0;
        }
      ...
      class d {
        constructor(t, e, i) {
          (this._data = []),
            ...
            (this._model = e),
            (this._hitTestResult =
              void 0 !== i ? new n.HitTestResult(n.HitTarget.Custom, i) : new n.HitTestResult(n.HitTarget.Regular));
        }
        update() {
          this._invalidated = !0;
        }
