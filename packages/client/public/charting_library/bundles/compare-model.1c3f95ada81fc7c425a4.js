(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [7271],
  {
    ...
    56217: (e, t, s) => {
      ...
      new Set(
        r.enabled('widget')
          ? ['pro_name', 'short_name', 'description', 'exchange', 'type', 'country_code', 'provider_id', 'typespecs']
          : [
              'pro_name',
              'short_name',
              'description',
        ...
        constructor(e) {
          ...
          Promise.all(d).then((e) => {
            ...
            e.forEach((e, r) => {
              const n = o[r],
                i = n.id();
              this._addStudyIdToCheckedSymbols(e, i), this._idToStudyMap.set(i, n), t.has(e) ? s.add(e) : c.add(e);
            });
              ...
              (e = []),
                this._chartWidget.compareSymbols() &&
                  this._chartWidget.compareSymbols().forEach((t) => {
                    e.push((0, h.qualifyProName)(t.symbol)), this._defaultSymbolsDescriptions.set(t.symbol, t.title);
                  });
              const t = [...n, ...e];
              r.push(...t);
            } else r.push(...n);
