(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [2878],
  {
    ...
    76068: (e, t, o) => {
      ...
      function l(e) {
        ...
        return (0, i.isCircleLogoWithUrlProps)(e)
          ...
          : n.createElement(
              'span',
              { className: l, title: e.title, 'aria-label': e['aria-label'], 'aria-hidden': e['aria-hidden'] },
              e.placeholderLetter,
            );
      }
    },
      ...
      function h(e) {
        ...
        return n.createElement(
          K,
          {
            ...
            'aria-selected': h,
            'aria-checked': m,
            className: i(v, W.item, C && W.withIcon, { [W.isActive]: _, [W.isDisabled]: E || x, [W.hovered]: w }),
            title: b,
            href: k,
            target: A,
            rel: y,
          ...
          (void 0 !== f || T) &&
            n.createElement('span', { className: W.shortcut }, (J = f) && J.split('+').join(' + ')),
          void 0 !== M &&
            n.createElement(
              'span',
              { onClick: R ? d : void 0, className: i(W.toolbox, { [W.showOnHover]: L, [W.showOnFocus]: S }) },
              M,
            ),
        );
        var J;
    ...
    23091: (e) => {
      e.exports = { 'tablet-small-breakpoint': 'screen and (max-width: 430px)', stickerRow: 'stickerRow-KUOIljqV' };
    },
    62270: (e) => {
    ...
    12165: (e, t, o) => {
      ...
      function u(e) {
        ...
        return s.PLATFORM_ACCESSIBILITY_ENABLED
          ? n.createElement(
              'button',
              { ref: u, tabIndex: d, onClick: o, className: l()(c.button, i.isActive && c.active), type: 'button' },
    ...
    14186: (e, t, o) => {
      ...
      class S extends n.PureComponent {
        ...
        render() {
          const {
            ...
            { heightContent: r, heightWrap: c, isVisibleBotButton: u, isVisibleTopButton: d } = this.state;
          return n.createElement(F.Measure, { onResize: this._handleResizeWrap }, (h) =>
            n.createElement(
              'div',
              ...
              n.createElement(
                ...
                n.createElement(F.Measure, { onResize: this._handleResizeContent }, (t) =>
                  n.createElement('div', { className: k.content, ref: t }, e),
                ),
              ),
              o && n.createElement('div', { className: s()(k.fadeTop, { [k.isVisible]: d && r > c }) }),
              o && n.createElement('div', { className: s()(k.fadeBot, { [k.isVisible]: u && r > c }) }),
              i &&
                n.createElement(
                  'div',
                  { className: s()(k.scrollTop, { [k.isVisible]: d && r > c }), onClick: this._handleScrollTop },
                  n.createElement(
                    'div',
              ...
              i &&
                n.createElement(
                  'div',
                  { className: s()(k.scrollBot, { [k.isVisible]: u && r > c }), onClick: this._handleScrollBot },
                  n.createElement(
                    'div',
                    { className: k.iconWrap },
                    n.createElement(E.Icon, { icon: L, className: k.icon }),
      ...
      const re = [
        ...
        ue = [
          { title: O.Emojis, content: n.createElement(Z, { text: f.t(null, void 0, o(19570)) }) },
          { title: O.Stickers, content: n.createElement(Z, { text: f.t(null, void 0, o(84121)) }) },
          {
            title: O.Icons,
      ...
      const Te = o(22878),
        Ce = (0, n.forwardRef)((e, t) => {
          const {
            ...
            F = (0, pe.mergeThemes)(me.DEFAULT_MENU_THEME, { menuBox: g.menuBox }),
          ...
          return (
            ...
            n.createElement(
              ...
              {
                ...x,
                className: a(g.dropdown, { [g.isGrayed]: m, [g.isActive]: h, [g.isOpened]: L }),
                onClick: m ? v : void 0,
                onKeyDown: function (e) {
                  var t;
                  ...
                  e.preventDefault(),
                    z(!1),
                    A && (null === (t = null == H ? void 0 : H.current) || void 0 === t || t.focus());
                },
                ref: D,
              },
              n.createElement(
                ...
                !m &&
                  ...
                  n.createElement(
                    k,
                    {
                      ...
                      onKeyDown: function (e) {
                        if (e.defaultPrevented || !(e.target instanceof Node) || !I.PLATFORM_ACCESSIBILITY_ENABLED)
                          return;
                    ...
                    n.createElement(E.Icon, { className: g.arrowIcon, icon: fe }),
                  ),
              ),
              !m &&
                (p
                  ? L && n.createElement(be.Drawer, { className: g.drawer, onClose: U, position: 'Bottom' }, d)
                  : n.createElement(
                      he.PopupMenu,
                      {
                        theme: F,
          ...
          function Y() {
            O.current &&
              ...
              (O.current = 0),
              L ? z(!1) : b || L || r.mobiletouch || (!h && !C) ? !W.current && f && f() : z(!0));
          }
        });
      var _e = o(38297),
        Ee = o(85034),
      ...
      class Fe extends we.CommonJsonStoreService {
        ...
        _removeUnavailableRecents(e, t) {
          return (
            Array.isArray(e) ? e.length > this._maxRecentCount && (t = e.slice(0, this._maxRecentCount)) : (t = []), t
          );
        }
        _promote(e) {
          let t = [...this.get()];
          const o = t.indexOf(e);
          -1 !== o && t.splice(o, 1), (t = [e, ...t.slice(0, this._maxRecentCount - 1)]), this.set(t);
        }
      }
      const ke = new Fe(
      ...
      function Se(e) {
        ...
        return n.createElement(n.Suspense, { fallback: null != t ? t : null }, n.createElement(Ae, { ...o }));
      }
      const Ae = n.lazy(async () => {
        ...
        return {
          default: (t) => {
            ...
            return n.createElement(E.Icon, { icon: l, className: Le.iconContainer });
          },
        };
      });
      var ye = o(20274);
      var Me = o(173);
      const Ie = new Fe('RECENT_EMOJIS_CHANGED', 'linetoolemoji.recents', Me.removeUnavailableEmoji, 'emojiTool'),
        Be = [
          'elon',
          'doge',
          'dislike',
      ...
      const We = [
          ...
          { title: 'TradingView', emojis: Be, content: n.createElement(z.IconItem, { icon: Ne }) },
        ],
        Oe = new Fe(
      ...
      const Ue = {
        [O.Icons]: {
          ...
          ItemComponent: function (e) {
            ...
            return n.createElement('div', { className: s()(ye.item, o) }, n.createElement(Se, { charCode: Number(t) }));
          },
          icons: re,
          onEmojiSelect: (e) => {
        ...
        [O.Stickers]: {
          ...
          ItemComponent: function (e) {
            const { emoji: t } = e,
              { size: i } = (0, Pe.useEnsuredContext)(Ve.EmojiListContentContext),
              [l, a] = (0, n.useState)();
            return (
              (0, n.useEffect)(() => {
                o.e(5598)
          ...
          RowComponent: function (e) {
            return n.createElement(je.EmojisRow, { ...e, className: ze.stickerRow });
          },
          icons: We,
          onEmojiSelect: (e) => {
      ...
      var Je = o(10888),
        Ye = o(37531);
      const qe = { icon: f.t(null, void 0, o(26579)), dropdownTooltip: f.t(null, void 0, o(92464)) },
        $e = (0, pe.mergeThemes)(Te, { menuBox: Ye.menuBox, drawer: Ye.drawer }),
      ...
      function Xe(e) {
        ...
        return n.createElement(
          Ce,
          {
            ...
            onClickWhenGrayed: () =>
              (0, h.emit)('onGrayedObjectClicked', { type: 'drawing', name: p.lineToolsInfo[r].localizedName }),
      ...
      function et(e) {
        ...
        e.target === t &&
          ...
          setTimeout(() => {
            ...
            const [e] = (0, I.queryTabbableElements)(t).sort(I.navigationOrderComparator);
            e && e.focus();
          }));
      }
      var tt = o(46100);
      ...
      class it extends n.PureComponent {
        ...
        render() {
          return this.state.isVisible
            ? n.createElement(N, { action: this._handleClick, isTransparent: !0, toolName: 'zoom-out' })
      ...
      class ut extends n.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._handleGrayedClick = (e) => {
              (0, h.emit)('onGrayedObjectClicked', { type: 'drawing', name: p.lineToolsInfo[e].localizedName });
            }),
        ...
        componentDidMount() {
          d.tool.subscribe(this._onChangeDrawingState),
            lt.LinetoolsFavoritesStore.favoriteAdded.subscribe(null, this._onAddFavorite),
            lt.LinetoolsFavoritesStore.favoriteRemoved.subscribe(null, this._onRemoveFavorite),
            lt.LinetoolsFavoritesStore.favoritesSynced.subscribe(null, this._onSyncFavorites);
        }
        componentWillUnmount() {
          d.tool.unsubscribe(this._onChangeDrawingState),
            lt.LinetoolsFavoritesStore.favoriteAdded.unsubscribe(null, this._onAddFavorite),
            lt.LinetoolsFavoritesStore.favoriteRemoved.unsubscribe(null, this._onRemoveFavorite),
            lt.LinetoolsFavoritesStore.favoritesSynced.unsubscribe(null, this._onSyncFavorites);
        }
        componentDidUpdate(e, t) {
          e.lineTools !== this.props.lineTools && this.setState({ favState: this._composeFavState() });
        }
        render() {
          const { favoriting: e, grayedTools: t, lineTools: o, dropdownTooltip: i, isSmallTablet: l } = this.props,
      ...
      class gt extends n.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._handleRemoveDrawings = () => {
              ft('remove drawing'), this.props.chartWidgetCollection.activeChartWidget.value().removeAllDrawingTools();
            }),
            (this._handleRemoveStudies = () => {
              ft('remove indicator'), this.props.chartWidgetCollection.activeChartWidget.value().removeAllStudies();
            }),
            ...
            (this._getActualState = () => {
              ...
              const e = this._activeChartWidget.model().dataSources(),
                t = e.filter(ct.isLineTool).filter((e) => e.isActualSymbol() && e.isUserDeletable()),
                o = e.filter(bt.isStudy).filter((e) => e.removeByRemoveAllStudies());
        ...
        componentWillUnmount() {
          this._activeChartWidget && this._unsubscribeToModelChanges(this._activeChartWidget),
            this.props.chartWidgetCollection.activeChartWidget.unsubscribe(this._handleActiveChartWidgetChanged);
        }
        render() {
          const e = this.props.isSmallTablet ? vt : void 0,
            { numOfDrawings: t, numOfIndicators: i } = this.state,
            l = f.t(null, { plural: '{amount} drawings', count: t, replace: { amount: t.toString() } }, o(93030)),
            a = f.t(null, { plural: '{amount} indicators', count: i, replace: { amount: i.toString() } }, o(80437)),
        ...
        _subscribeToModelChanges(e) {
          e.withModel(this, () => {
            this._handleCollectionChanged(),
              e.model().model().dataSourceCollectionChanged().subscribe(this, this._handleCollectionChanged);
          });
        }
        _unsubscribeToModelChanges(e) {
          e.hasModel() &&
            e.model().model().dataSourceCollectionChanged().unsubscribe(this, this._handleCollectionChanged),
      ...
      const xt = {
        ...
        all: { active: G.drawingToolsIcons.hideAllDrawingsActive, inactive: G.drawingToolsIcons.hideAllDrawings },
      };
      function Ft(e) {
        ...
        return n.createElement(
          ...
          n.createElement(
            ...
            Array.from((0, Ct.getHideOptions)()).map(([e, o]) =>
              n.createElement(wt, { key: e, hideMode: e, option: o, isSmallTablet: t, onClick: m }),
            ),
          ),
        );
        function m(e, t) {
      ...
      function kt(e, t) {
        (0, dt.trackEvent)('GUI', 'Chart Left Toolbar', `${e} ${t ? 'on' : 'off'}`);
      }
      function Lt(e) {
        0;
      }
      ...
      class Mt extends n.PureComponent {
        ...
        componentDidMount() {
          const e = (this._promise = (0, l.ensureNotNull)((0, St.getFavoriteDrawingToolbarPromise)()));
          e.then((t) => {
            this._promise === e &&
              ((this._instance = t),
      ...
      function Wt(e) {
        const { isSmallTablet: t } = e,
          o = (0, It.useWatchedValueReadonly)({ watchedValue: (0, Dt.magnetEnabled)() }),
          i = (0, It.useWatchedValueReadonly)({ watchedValue: (0, Dt.magnetMode)() });
        return n.createElement(
          'div',
          ...
          n.createElement(
            ...
            Object.values(Rt).map(({ id: e, name: a, localizedName: s, icon: r }) =>
              n.createElement(st.AccessibleMenuItem, {
                key: e,
        ...
        function l(e) {
          void 0 !== e &&
            ((0, dt.trackEvent)('GUI', 'Magnet mode', e === Bt.MagnetMode.WeakMagnet ? 'Weak' : 'Strong'),
      ...
      const Yt = (0, pe.mergeThemes)(Zt, Jt),
        qt = { hide: f.t(null, void 0, o(96411)), show: f.t(null, void 0, o(63354)) };
      class $t extends n.PureComponent {
        ...
        render() {
          ...
          return n.createElement(
            ...
            n.createElement(Kt, { direction: e ? 'left' : 'right', theme: e ? void 0 : Yt }),
          );
        }
      }
      var Qt = o(37558),
      ...
      class uo extends n.PureComponent {
        constructor(e) {
          ...
          super(e),
            ...
            (this._handleObjectsTreeClick = () => {
              this._activeChartWidget().showObjectsTreeDialog(), ho('object tree');
            }),
            (this._handleMouseOver = (e) => {
              (0, Pt.hoverMouseEventFilter)(e) && this.setState({ isHovered: !0 });
            }),
            (this._handleMouseOut = (e) => {
              (0, Pt.hoverMouseEventFilter)(e) && this.setState({ isHovered: !1 });
            }),
            ...
            (this._filteredLineTools = C.map((e) => ({
              id: e.id,
              title: e.title,
              items: e.items.filter((e) => this._toolsFilter.isToolEnabled(p.lineToolsInfo[e.name].localizedName)),
              trackLabel: e.trackLabel,
            })).filter((e) => 0 !== e.items.length)),
            this._filteredLineTools.forEach((e) =>
              e.items.forEach((e) => {
                this._grayedTools[e.name] = this._toolsFilter.isToolGrayed(p.lineToolsInfo[e.name].localizedName);
              }),
            ),
            (this.state = {
              isHovered: !1,
        ...
        render() {
          ...
          let c;
          c = n.createElement($t, { toolbarVisible: l, 'data-name': 'toolbar-drawing-toggle-button' });
          const h = () => !!this._features.tools && !(!u.enabled('show_object_tree') || (lo && !io));
          return n.createElement(
            oo.RegistryProvider,
            ...
            n.createElement(
              ...
              n.createElement(
                Qt.DrawerManager,
                null,
                n.createElement(eo.MatchMedia, { rule: Xt.DialogBreakpoints.TabletSmall }, (e) =>
                  n.createElement(
                    zt.Toolbar,
                    {
                      id: 'drawing-toolbar',
                      ...
                      n.createElement(
                            ...
                            this._filteredLineTools.map((o, i) =>
                              n.createElement(ut, {
                                ...
                                favoriting:
                                  ...
                                  !('linetool-group-cursors' === o.id && (0, b.isOnMobileAppPage)('any')),
                        ...
                        !o &&
                          n.createElement(
                            'div',
                            { className: no.group, style: s },
                            n.createElement(nt, { toolName: 'measure', onClick: this._handleMeasureClick }),
                            n.createElement(nt, { toolName: 'zoom', onClick: this._handleZoomInClick }),
                        ...
                        !o &&
                          n.createElement(
                            ...
                            this._features.tools && n.createElement(Ft, { isSmallTablet: e }),
                            !1,
                          ),
                        !o &&
                          this._features.tools &&
                        ...
                        n.createElement('div', { className: no.fill, style: s }),
                        !o &&
                          (this._features.tools || !1) &&
                          n.createElement(
                            'div',
                            { className: a(no.group, no.lastGroup), style: s },
                            !1,
                            this._features.tools &&
                              this._features.favoriting &&
                              n.createElement(Mt, { id: Ot.FavoriteDrawings }),
                            h() &&
                              n.createElement(N, {
                                id: Ot.ObjectTree,
      ...
      class mo {
        constructor(e, t) {
          (this._component = null),
            ...
            (this._container = e),
            i.render(n.createElement(uo, { ...t, ref: this._handleRef }), this._container);
        }
        destroy() {
    ...
    5962: (e, t, o) => {
      'use strict';
      o.d(t, { RegistryProvider: () => r, registryContextType: () => c, validateRegistry: () => s });
      var n = o(50959),
        i = o(19036),
        l = o.n(i);
