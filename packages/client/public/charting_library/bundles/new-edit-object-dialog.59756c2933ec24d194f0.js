  ...
  [6265],
  {
    ...
    63374: (e, t, l) => {
          ...
          super(e),
            (this._handleClose = (e) => {
              ((null == e ? void 0 : e.target) &&
                (e.target.closest('[data-dialog-name="gopro"]') || e.target.closest('[data-name=support-dialog]'))) ||
                this.props.onClose();
            }),
            (this._renderFooterLeft = (e) => {
              const { source: t, model: l } = this.props;
              if ((0, w.isLineTool)(t)) return r.createElement(f.FooterMenu, { sources: [t], chartUndoModel: l });
              if ((0, g.isStudy)(t))
                return r.createElement(h.StudyDefaultsManager, { model: l, source: t, mode: e ? 'compact' : 'normal' });
      ...
      class k extends r.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._inputs = new T.MetaInfoHelper(this.props.source.metaInfo()).getUserEditableInputs());
        }
        render() {
      ...
      var _ = l(22064),
        ...
        D = l(4781),
        V = l(17948);
      const R = new s.TranslatedString('change visibility', i.t(null, void 0, l(21511)));
            ...
            !i &&
              r.createElement(
                ...
                r.createElement(
                  ...
                  a ? r.createElement('div', null, h) : r.createElement(M, { id: m, title: h, visible: s.visible }),
                ),
              ),
            ie(m, l, n, s, v, p),
      ...
      class me extends r.PureComponent {
        ...
        render() {
          const {
            ...
            isRGB: l,
            isFundamental: n,
            property: { color: o, plottype: i, linewidth: s, transparency: a, trackPrice: c, display: p },
          } = this.props;
          return r.createElement(
            B.InputRow,
      ...
      class ye extends r.PureComponent {
        render() {
          ...
          return r.createElement(
            B.InputRow,
            { label: c ? r.createElement(M, { id: e, title: l, visible: n, disabled: u }) : l, offset: p, grouped: d },
            t
              ? null
              : r.createElement(ee.ColorWithThicknessSelect, {
      ...
      const ke = {
          ...
          [Te.MarkLocation.Top]: { value: Te.MarkLocation.Top, content: i.t(null, void 0, l(65994)), order: 2 },
          [Te.MarkLocation.Bottom]: { value: Te.MarkLocation.Bottom, content: i.t(null, void 0, l(91757)), order: 3 },
      ...
      class De extends r.PureComponent {
        ...
        render() {
          ...
          return r.createElement(
            ...
            !a &&
              !i &&
              r.createElement(ee.ColorWithThicknessSelect, { disabled: 0 === h.value(), color: c, transparency: p }),
      ...
      class Ne extends r.PureComponent {
        render() {
          const { id: e, shapeStyleId: t, className: l, shapeStyleChange: n, disabled: o } = this.props;
          return r.createElement(A.IconDropdown, {
            id: e,
            disabled: o,
            className: l,
      ...
      class ze extends r.PureComponent {
        ...
        render() {
          ...
          return r.createElement(
            ...
            !n &&
              !l &&
              r.createElement(ee.ColorWithThicknessSelect, { disabled: 0 === p.value(), color: i, transparency: s }),
            r.createElement(Ne, {
        ...
        render() {
          ...
          if ('line' === u || 'bar_colorer' === u || 'bg_colorer' === u)
            return h && h.palette && h.paletteProps
              ? r.createElement(ce, {
                  title:
                    null !== (t = null === (e = null == p ? void 0 : p[a]) || void 0 === e ? void 0 : e.title) &&
                    void 0 !== t
                      ? t
                      : a,
                  plot: n,
          ...
          if ('arrows' === u) {
            ...
            return t || l
              ...
              : r.createElement(be, { id: a, property: d, isRGB: m, plot: n, palettes: i, styleProp: d });
          }
          if ('chars' === u || 'shapes' === u) {
            ...
            return r.createElement(
              ...
              'chars' === u
                ...
                : r.createElement(ze, { id: a, title: t, property: d, hasPalette: Boolean(h && h.palette), isRGB: m }),
              h &&
                h.palette &&
                h.paletteProps &&
                r.createElement(ce, {
      ...
      var qe = l(47510),
        Ke = l(53598);
      const $e = new s.TranslatedString('change line style', i.t(null, void 0, l(28691)));
      class Xe extends r.PureComponent {
        constructor() {
          super(...arguments),
      ...
      class Je extends r.PureComponent {
        ...
        render() {
          const {
            id: e,
            name: t,
            property: { color: l, linestyle: n, linewidth: o, transparency: i, value: s, visible: a },
          } = this.props;
          return r.createElement(
            B.InputRow,
          ...
          return r.createElement(
            ...
            r.createElement(
              ...
              r.createElement(
                oe.PropertyTable.Cell,
                { placement: 'first', colSpan: 2 },
                r.createElement(M, { id: 'chart-orders-switch', title: i.t(null, void 0, l(77409)), visible: e }),
              ),
            ),
            r.createElement(
              oe.PropertyTable.Row,
            ...
            r.createElement(
              ...
              r.createElement(
                oe.PropertyTable.Cell,
                { placement: 'first', colSpan: 2 },
                r.createElement(M, { id: 'chart-orders-qty-switch', title: i.t(null, void 0, l(66596)), visible: n }),
              ),
            ),
          );
        }
      ...
      class dt extends r.PureComponent {
        ...
        render() {
          const { hHistInfo: e, property: t } = this.props,
            { percentWidth: l, direction: n, showValues: o, valuesColor: i, visible: s } = t.childs(),
            { title: a } = e;
          return r.createElement(
            r.Fragment,
            null,
            ...
            r.createElement(
              B.InputRow,
              { label: r.createElement('div', { className: te.childRowContainer }, st), grouped: !0 },
            ...
            r.createElement(
              B.InputRow,
              { label: r.createElement('div', { className: te.childRowContainer }, at), grouped: !0 },
            ...
            r.createElement(
              B.InputRow,
              { label: r.createElement('div', { className: te.childRowContainer }, pt), grouped: !0 },
        ...
        _renderColors() {
          ...
          return l.childNames().map((e) =>
            r.createElement(
              B.InputRow,
              { key: e, grouped: !0, label: r.createElement('div', { className: te.childRowContainer }, i[+e]) },
              r.createElement(ee.ColorWithThicknessSelect, {
                disabled: !o.value(),
                color: l[+e],
                transparency: n[+e],
      ...
      class vt extends r.PureComponent {
        render() {
          ...
          return Object.keys(s).map((t, n) => {
            var s, a, c, p;
            const d = (0, o.ensureDefined)(null === (s = i[e]) || void 0 === s ? void 0 : s.childs()[t]);
            ...
            r.createElement(
              ...
              r.createElement(
                ...
                r.createElement(
                  ...
                  r.createElement(wt, { id: 'pivot-points-standard-font-size-select', fontSize: e }),
                ),
              ),
            ),
            r.createElement(
      ...
      class Mt extends r.PureComponent {
        ...
        render() {
          ...
          const { metaInfo: p } = this.props,
            { graphics: d, styles: u, showLabelsOnPriceScale: h, showLegendValues: m } = this.props.property.childs(),
          ...
          return r.createElement(
            ...
            r.createElement(
              ...
              r.createElement(
                oe.PropertyTable.Cell,
                { placement: 'last' },
                r.createElement(ee.ColorWithThicknessSelect, { disabled: !C.value() || !P[0].value(), color: T }),
              ),
            ),
            r.createElement(
              oe.PropertyTable.Row,
            ...
            g &&
              r.createElement(
                B.InputRow,
                { label: r.createElement('div', null, (G && i.t(G.name, { context: 'input' }, l(88601))) || '') },
                r.createElement(ee.ColorWithThicknessSelect, {
              ...
              r.createElement(
                ...
                h &&
                  r.createElement(
                    oe.PropertyTable.Cell,
                    { placement: 'first', colSpan: 2 },
                    r.createElement(M, { id: 'showLabelsOnPriceScale', title: Rt, visible: h }),
                  ),
                m &&
                  r.createElement(
                    oe.PropertyTable.Cell,
                    { placement: 'first', colSpan: 2 },
                    r.createElement(M, { id: 'showLegendValues', title: Vt, visible: m }),
                  ),
              ),
          );
        }
      ...
      var zt = l(43886);
      const Ht = new s.TranslatedString('change precision', i.t(null, void 0, l(164))),
      ...
      for (let e = 0; e < qt.length; e++) {
        const t = qt[e];
        Kt.push({ value: t.priceScale + ',' + t.minMove + ',' + t.frac, content: t.minMove + '/' + t.priceScale });
      }
      ...
      class Jt extends r.PureComponent {
        render() {
          ...
          return r.createElement(
            B.InputRow,
            { label: c ? r.createElement(M, { id: e, title: l, visible: n }) : l, offset: p, grouped: d },
            t
              ? null
              : r.createElement(
                  r.Fragment,
      ...
      class rl extends r.PureComponent {
          ...
          super(...arguments),
            (this._findPlotPalettes = (e) => {
              ...
              return (0, x.isBarColorerPlot)(e) || (0, x.isBgColorerPlot)(e)
                ? { main: { palette: n[e.palette], paletteProps: t.properties().palettes[e.palette] } }
        ...
        render() {
          ...
          const l = e.properties(),
            { precision: n, strategy: o, minTick: i, showLabelsOnPriceScale: s, showLegendValues: a } = l,
            c = t.plots.length > 0,
          ...
          return r.createElement(
            ...
            u && r.createElement($t, { id: (0, _.createDomId)(t.id, 'min-tick-select'), minTick: i }),
            ...
            (d || p) &&
              r.createElement(
                ...
                d && r.createElement(Ot, { id: (0, _.createDomId)(t.id, 'precision-select'), precision: n }),
                p &&
                  r.createElement(
                    r.Fragment,
                    null,
        ...
        _bandsElement() {
          ...
          return (
            ...
            l &&
            t.map((e, t) => {
              if (!e.isHidden) return r.createElement(Je, { key: t, id: e.name, name: e.name, property: l[t] });
            })
          );
        }
        ...
        _graphicsElement() {
          ...
          return t && Object.keys(t).map((t, l) => r.createElement(vt, { key: t, graphicType: t, study: e }));
        }
        _findPalettesByTargetId(e) {
          ...
          for (const l of n) {
            if (((0, x.isPaletteColorerPlot)(l) || (0, x.isOhlcColorerPlot)(l)) && l.target === e) {
              if (i.main) {
                i.secondary = { palette: r[l.palette], paletteProps: t.properties().palettes[l.palette] };
                continue;
              }
            ...
            (0, x.isUpColorerPlot)(l) &&
              ...
              (0, x.isDownColorerPlot)(l) &&
                l.target === e &&
                (i.down = { palette: r[l.palette], paletteProps: t.properties().palettes[l.palette] }),
              (0, x.isCandleWickColorerPlot)(l) &&
                l.target === e &&
                (i.wick = { palette: r[l.palette], paletteProps: t.properties().palettes[l.palette] }),
              (0, x.isCandleBorderColorerPlot)(l) &&
                l.target === e &&
                (i.border = { palette: r[l.palette], paletteProps: t.properties().palettes[l.palette] });
          }
          return i;
        }
      }
      ...
      class dl extends al.DialogRenderer {
        ...
        show(e = {}) {
          ...
          if (
            ((0, w.isLineTool)(this._source) && (0, u.trackEvent)('GUI', 'Drawing Properties', this._source.name()),
            (0, g.isStudy)(this._source))
          ) {
            const e = !this._source.isPine() || this._source.isStandardPine() ? o.description : 'Custom Pine';
            (0, u.trackEvent)('GUI', 'Study Properties', e);
          }
          let s = [];
          const h = new T.MetaInfoHelper(o);
          h.hasUserEditableInputs() && s.push({ id: 'inputs', label: i.t(null, void 0, l(66304)), Component: k }),
            h.hasUserEditableProperties(),
            h.hasUserEditableStyles() && s.push({ id: 'style', label: i.t(null, void 0, l(32733)), Component: il }),
            this._propertyPages ||
              s.push({
                id: 'visibilities',
        ...
        _createVisibilitiesPropertyPage() {
          ...
          return (0, sl.createPropertyPage)(
            (0, cl.getIntervalsVisibilitiesPropertiesDefinitions)(
              this._model,
              e,
              new s.TranslatedString(this._source.name(!0), this._source.title(pl.TitleDisplayTarget.StatusLine, !0)),
            ),
            'visibility',
    ...
    50945: (e, t, l) => {
      ...
      class h extends n.PureComponent {
        ...
        _getPlaceHolderItem(e) {
          return e ? n.createElement(i.Icon, { className: d.defaultsButtonIcon, icon: p }) : u.defaults;
        }
      }
    },
    48531: (e, t, l) => {
      ...
      function y(e) {
        ...
        return n.createElement(
          ...
          n.createElement(u.PopupMenuItem, {
            ...
            label: t,
            onClick: s,
            toolbox: l && n.createElement(h.RemoveButton, { hidden: !v.mobiletouch && !o, onClick: c }),
          }),
        );
      }
      function g(e) {
          ...
          n.createElement(
            ...
            t &&
              n.createElement(
                s.PropertyTable,
                { reference: l, key: c },
                t.definitions.value().map((e) => n.createElement(a.Section, { key: e.id, definition: e })),
              ),
          ),
        );
      }
    ...
    69297: (e, t, l) => {
      ...
      function c(e) {
        ...
        return r(l, a().switcher, a()[`size-${s}`], a()[`intent-${o}`], !c && a()['disable-active-state-styles']);
      }
      function p(e) {
        var t;
        const {
    ...
    97456: (e, t, l) => {
      ...
      var n = l(44352),
        ...
        c = l(68806),
        p = l(62513);
      const d = new r.TranslatedString('change {title} visibility on ticks', n.t(null, void 0, l(30810))),
        ...
        L =
          (new r.TranslatedString('change {title} visibility on ranges', n.t(null, void 0, l(29091))),
        ...
        const W = (0, i.createRangePropertyDefinition)(
            {
              ...
              to: (0, i.convertToDefinitionProperty)(e, t.weeksTo, k.format({ title: l })),
            },
            {
          ...
          A = (0, i.createRangePropertyDefinition)(
            {
              checked: (0, i.convertToDefinitionProperty)(e, t.months, _.format({ title: l })),
    ...
    62513: (e, t, l) => {
      ...
      var n = l(50151),
        ...
        i = l(59452),
        s = l.n(i);
      const a = new o.TranslatedString('change {propertyName} property', r.t(null, void 0, l(18567)));
      class c extends s() {
        constructor(e, t, l) {
          super(),
            (this._isProcess = !1),
        ...
        subscribe(e, t) {
          ...
          this._listenersMappers.push({ obj: e, method: t, callback: l }), this._baseProperty.subscribe(e, l);
        }
        unsubscribe(e, t) {
          var l;
          const r = (0, n.ensureDefined)(
            null === (l = this._listenersMappers.find((l) => l.obj === e && l.method === t)) || void 0 === l
              ? void 0
              : l.callback,
          );
