  ...
  [6631],
  {
              ...
              n.createElement(
                ...
                n.createElement(
                  ...
                  n.createElement(
                    ...
                    n.createElement(
                      o.Button,
                      { className: b, disabled: d, name: 'submit', onClick: m, 'data-name': 'submit-button' },
          ...
          n.createElement(
            ...
            s &&
              ...
              n.createElement(
                ...
                n.createElement(g.Icon, { className: S.icon, icon: f, 'data-name': 'close', 'data-role': 'button' }),
              ),
          ),
        );
      }
      ...
      class T extends n.PureComponent {
        constructor() {
          super(...arguments),
            ...
            (this._calculatePositionWithOffsets = (e, t) => {
              const a = (0, i.ensureDefined)(this.props.fullScreenViewOffsets).value();
              return {
                top: a.top,
        ...
        componentDidMount() {
          ...
          this.props.ignoreClosePopupsAndDialog ||
            v.subscribe(b.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._handleClose, null),
            this._handleOpen(),
            void 0 !== this.props.onOpen &&
        ...
        componentWillUnmount() {
          var e, t;
          this.props.ignoreClosePopupsAndDialog ||
            v.unsubscribe(b.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._handleClose, null),
        ...
        render() {
          ...
          return n.createElement(h.MatchMedia, { rule: m.DialogBreakpoints.SmallHeight }, (b) =>
            n.createElement(h.MatchMedia, { rule: m.DialogBreakpoints.TabletSmall }, (m) =>
              n.createElement(
                d.PopupDialog,
                {
                  rounded: !(m || I) && L,
                  ...
                  containerAriaLabel: K,
                  containerTabIndex: G,
                  calculateDialogPosition: I && q ? this._calculatePositionWithOffsets : void 0,
                  shadowed: U,
                  ...Y,
                },
                n.createElement(
                  'div',
                  { className: o()(N.wrapper, t), 'data-name': r, 'data-dialog-name': Q },
                  void 0 !== s &&
                    n.createElement(y, {
                      draggable: D && !(m || I),
                  ...
                  n.createElement(p.PopupContext.Consumer, null, (e) => this._renderChildren(e, m || I)),
                ),
              ),
            ),
          );
    ...
    13932: (e, t, a) => {
      ...
      class v extends s.PureComponent {
        ...
        _renderDialogBody() {
          return () => s.createElement(m.SlotContext.Consumer, null, (e) => ((this._manager = e), this.props.children));
        }
      }
      var g = a(33547),
        _ = a(85508),
        ...
        return (
          ...
          s.createElement(
            ...
            s.createElement(
              ...
              s.createElement(
                ...
                s.createElement(r.Checkbox, {
                  label: s.createElement(
                    ...
                    w,
                    s.createElement(d.Icon, { icon: _, className: l(x), title: a }),
                  ),
                  onChange: function () {
              ...
              s.createElement(
                ...
                s.createElement(r.Checkbox, {
                  label: s.createElement(
                    ...
                    { className: f.hintLabel },
                    N,
                    s.createElement(d.Icon, { icon: _, className: l(x), title: i }),
                  ),
                  onChange: function () {
              ...
              s.createElement('div', { className: l(f.indicators, D && f.withSuggestions) }, o),
            ),
          )
        );
      }
      ...
      class D {
        constructor(e) {
          (this._container = document.createElement('div')),
            ...
            (this.unmount = () => {
              T.unsubscribe(E.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this.unmount, null),
      ...
      class j {
        ...
        _showTemplateSaveRenameDialog(e, t, a) {
          ...
          (this._dialog = new D({
            ...
            saveIntervalHintText: z.format({ interval: (0, L.translatedIntervalString)(a) }),
