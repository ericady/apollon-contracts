    ...
    99054: (e, t, n) => {
      ...
      function u(e) {
        ...
        if (e && 1 == ++l) {
          ...
          i(n, 'right', '0px');
          let e = 0;
          0, t.scrollHeight <= t.clientHeight && (e -= s()), (t.style.paddingRight = (e < 0 ? 0 : e) + 'px'), (a = !1);
        }
      }
    },
    90692: (e, t, n) => {
    ...
    27317: (e, t, n) => {
      ...
      class v extends s.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._handleMeasure = ({ callback: e, forceRecalcPosition: t } = {}) => {
              ...
              const w = g.height > b;
              if (w) {
                ((0, o.ensureNotNull)(this._scrollWrapRef).style.overflowY = 'scroll'), (g = v.getBoundingClientRect());
              }
              const { width: M, height: S } = g,
                W = 'function' == typeof _ ? _(M, S, x, y) : _,
                R =
                  null !==
                    (i = null === (s = null == W ? void 0 : W.indentFromWindow) || void 0 === s ? void 0 : s.left) &&
                  void 0 !== i
                    ? i
                    : 0,
                E =
                  ...
                  (null !==
                    (u = null === (a = null == W ? void 0 : W.indentFromWindow) || void 0 === a ? void 0 : a.right) &&
                  void 0 !== u
                    ? u
                    : 0),
                ...
                N =
                  (null !==
                    (d = null === (c = null == W ? void 0 : W.indentFromWindow) || void 0 === c ? void 0 : c.top) &&
                  void 0 !== d
                    ? d
                    : 0) + C,
                D =
                  ...
                  (null !==
                    (m = null === (p = null == W ? void 0 : W.indentFromWindow) || void 0 === p ? void 0 : p.bottom) &&
                  void 0 !== m
                    ? m
                    : 0);
              ...
              if (
                ...
                t && void 0 !== this.props.closeOnScrollOutsideOffset && W.y <= this.props.closeOnScrollOutsideOffset)
              )
        ...
        componentDidMount() {
          ...
          const { customCloseDelegate: e = c.globalCloseDelegate, customRemeasureDelegate: t } = this.props;
        ...
        render() {
          const {
            ...
            { appearingMenuHeight: W, appearingMenuWidth: R, appearingPosition: E, isMeasureValid: O } = this.state,
            N = {
            ...
            onMouseOver: function (e) {
              if (
                !(
                  ...
                  ((s = e.target), null === (i = n.current) || void 0 === i ? void 0 : i.contains(s))
                )
              )
                return;
              var s, i;
