  ...
  [8537],
  {
    86778: (e, t, i) => {
      ...
      var n = i(44352),
        ...
        l = i(46141),
        s = i(94474);
      const a = new o.TranslatedString('change {title} price label visibility', n.t(null, void 0, i(45936))),
      ...
      function y(e, t) {
        ...
        if ('linesWidths' in e || 'linestyle' in e || 'linesColors' in e) {
          const p = (0, s.createLinePropertyDefinition)(
            {
              width: e.linesWidths
                ? new r.CollectiblePropertyUndoWrapper(new o.LineToolCollectedProperty(e.linesWidths), a, t)
                : void 0,
              style: e.linestyle
                ? new r.CollectiblePropertyUndoWrapper(new o.LineToolCollectedProperty(e.linestyle), c, t)
                : void 0,
              color: e.linesColors
                ? new r.CollectiblePropertyUndoWrapper(new o.LineToolCollectedProperty(e.linesColors), d, t)
                : void 0,
            },
          ...
          const a = (0, s.createColorPropertyDefinition)(
            {
              checked: e.fillBackground
                ? new r.CollectiblePropertyUndoWrapper(new o.LineToolCollectedProperty(e.fillBackground), u, t)
                : void 0,
    ...
    75611: (e, t, i) => {
      ...
      var n = i(44352),
        ...
        a = i(9155),
        c = i(94474);
      const d = new o.TranslatedString('change {title} middle point visibility', n.t(null, void 0, i(89996))),
      ...
      function W(e, t, i, n) {
        ...
        const N = (0, l.createCheckablePropertyDefinition)(
          { checked: (0, l.convertToDefinitionProperty)(e, t.showPriceLabels, p.format({ title: i })) },
          { id: `${o}ShowPriceLabels`, title: (n && n.showPriceLabelsTitle) || S },
        );
        a.push(N);
        const R = [],
          G = (0, l.createCheckablePropertyDefinition)(
            { checked: (0, l.convertToDefinitionProperty)(e, t.showPriceRange, u.format({ title: i })) },
            { id: `${o}PriceRange`, title: (n && n.priceRange) || b },
          );
        R.push(G);
        const E = (0, l.createCheckablePropertyDefinition)(
          { checked: (0, l.convertToDefinitionProperty)(e, t.showPercentPriceRange, h.format({ title: i })) },
          { id: `${o}PercentChange`, title: (n && n.percentChange) || C },
        );
        R.push(E);
        const O = (0, l.createCheckablePropertyDefinition)(
          { checked: (0, l.convertToDefinitionProperty)(e, t.showPipsPriceRange, y.format({ title: i })) },
        ...
        if ((R.push(U), 'showDateTimeRange' in t)) {
          const r = (0, l.createCheckablePropertyDefinition)(
            { checked: (0, l.convertToDefinitionProperty)(e, t.showDateTimeRange, v.format({ title: i })) },
        ...
        if ('showDistance' in t) {
          const r = (0, l.createCheckablePropertyDefinition)(
            { checked: (0, l.convertToDefinitionProperty)(e, t.showDistance, g.format({ title: i })) },
        ...
        const F = (0, l.createCheckablePropertyDefinition)(
          { checked: (0, l.convertToDefinitionProperty)(e, t.alwaysShowStats, D.format({ title: i })) },
        ...
        const I = (0, l.createOptionsPropertyDefinition)(
          ...
          { id: `${o}StatsPosition`, title: (n && n.statsPosition) || m, options: new s.WatchedValue(_) },
        );
        return (
          R.push(I), a.push((0, l.createPropertyDefinitionsGeneralGroup)(R, `${o}StatsGroup`, M)), { definitions: a }
        );
      }
    },
    2908: (e, t, i) => {
      ...
      var n = i(44352),
        ...
        r = i(46141),
        l = i(94474);
      const s = new o.TranslatedString('change {toolName} line visibility', n.t(null, void 0, i(24272))),
      ...
      function T(e, t, i, n, o) {
        ...
        return (
          void 0 !== t.showLine &&
            (T.checked = (0, r.convertToDefinitionProperty)(e, t.showLine, s.format({ toolName: i }))),
          void 0 !== t.lineWidth &&
            (T.width = (0, r.convertToDefinitionProperty)(e, t.lineWidth, a.format({ toolName: i }))),
          void 0 !== t.lineStyle &&
            (T.style = (0, r.convertToDefinitionProperty)(e, t.lineStyle, c.format({ toolName: i }))),
          void 0 !== t.lineColor &&
            (T.color = (0, r.getColorDefinitionProperty)(e, t.lineColor, null, d.format({ toolName: i }))),
          void 0 !== t.extendLeft &&
            ((T.extendLeft = (0, r.convertToDefinitionProperty)(e, t.extendLeft, p.format({ toolName: i }))),
            (D.extendLeftTitle = (o && o.extendLeftTitle) || v)),
          void 0 !== t.leftEnd &&
            (T.leftEnd = (0, r.convertToDefinitionProperty)(e, t.leftEnd, u.format({ toolName: i }))),
          void 0 !== t.extendRight &&
            ((T.extendRight = (0, r.convertToDefinitionProperty)(e, t.extendRight, h.format({ toolName: i }))),
            (D.extendRightTitle = (o && o.extendRightTitle) || g)),
          void 0 !== t.rightEnd &&
            (T.rightEnd = (0, r.convertToDefinitionProperty)(e, t.rightEnd, y.format({ toolName: i }))),
    ...
    50653: (e, t, i) => {
      ...
      var n = i(44352),
        ...
        r = i(46141),
        l = i(94474);
      const s = new o.TranslatedString('change {toolName} text visibility', n.t(null, void 0, i(69871))),
      ...
      function b(e, t, i, n) {
        ...
        if (
          (void 0 !== t.showText &&
            (o.checked = (0, r.convertToDefinitionProperty)(e, t.showText, s.format({ toolName: i }))),
          void 0 !== t.textColor &&
          ...
          void 0 !== t.bold && (o.bold = (0, r.convertToDefinitionProperty)(e, t.bold, d.format({ toolName: i }))),
          void 0 !== t.italic &&
          ...
          void 0 !== t.textOrientation &&
            (o.orientation = (0, r.convertToDefinitionProperty)(e, t.textOrientation, f.format({ toolName: i }))),
          ...
          void 0 !== t.backgroundTransparency && (n = t.backgroundTransparency),
            (o.backgroundColor = (0, r.getColorDefinitionProperty)(e, t.backgroundColor, n, g.format({ toolName: i })));
        }
        return (
          ...
          void 0 !== t.borderVisible &&
            (o.borderVisible = (0, r.convertToDefinitionProperty)(e, t.borderVisible, T.format({ toolName: i }))),
          void 0 !== t.borderWidth &&
            (o.borderWidth = (0, r.convertToDefinitionProperty)(e, t.borderWidth, D.format({ toolName: i }))),
          void 0 !== t.borderColor &&
            (o.borderColor = (0, r.getColorDefinitionProperty)(e, t.borderColor, null, w.format({ toolName: i }))),
          ...
          return {
            definitions: [
              ...
              (0, l.createOptionsPropertyDefinition)(
                {
                  option: (0, l.convertToDefinitionProperty)(this._propertyApplier, e.mode, u.format({ title: i }), [
                    c.convertToInt,
                  ]),
                },
              ...
              (0, l.createCheckablePropertyDefinition)(
                {
                  checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, e.flipped, y.format({ title: i })),
                },
    ...
    26430: (e, t, i) => {
      ...
      var n = i(44352),
        ...
        s = i(46141),
        a = i(94474);
      const c = new o.TranslatedString('change {title} background visibility', n.t(null, void 0, i(64548))),
          ...
          return {
            definitions: [
              ...
              (0, s.createOptionsPropertyDefinition)(
                { option: (0, s.convertToDefinitionProperty)(this._propertyApplier, e.degree, p.format({ title: i })) },
                { id: `${t}Degree`, title: y, options: new a.WatchedValue(this._source.availableDegreesValues()) },
              ),
            ],
          };
        }
    ...
    7044: (e, t, i) => {
      ...
      var n = i(50151),
        ...
        c = i(94474),
        d = i(69152);
      const p = new r.TranslatedString('change {title} level {index} line visibility', o.t(null, void 0, i(45463))),
      ...
      class b extends a.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          ...
          const A = (0, s.createCheckablePropertyDefinition)(
            {
              checked: (0, s.convertToDefinitionProperty)(this._propertyApplier, t.showCoeffs, u.format({ title: a })),
            },
            { id: `${o}Levels`, title: S },
          );
          e.push(A);
    ...
    56194: (e, t, i) => {
      ...
      var n = i(50151),
        ...
        p = i(94474),
        u = i(69152);
      const h = new r.TranslatedString('change {title} level {index} line visibility', o.t(null, void 0, i(45463))),
      ...
      class U extends a.LineDataSourceDefinitionsViewModel {
        ...
        _stylePropertyDefinitions() {
          ...
          const H = (0, l.createLineStyleDefinition)(this._propertyApplier, F, a, 'LevelsStyleLine', I);
          e.push(H);
          const j = [],
          ...
          if ('reverse' in K) {
            const t = (0, s.createCheckablePropertyDefinition)(
              { checked: (0, s.convertToDefinitionProperty)(this._propertyApplier, K.reverse, D.format({ title: a })) },
          ...
          const Z = (0, s.createOptionsPropertyDefinition)(
            {
              checked: (0, s.convertToDefinitionProperty)(this._propertyApplier, t.showCoeffs, S.format({ title: a })),
    ...
    4841: (e, t, i) => {
      ...
      var n = i(50151),
        ...
        a = i(94474),
        c = i(69152);
      const d = new r.TranslatedString('change {title} level {index} line visibility', o.t(null, void 0, i(45463))),
        ...
        _stylePropertyDefinitions() {
          ...
          const q = t.grid.childs(),
            J = (0, l.createLinePropertyDefinition)(
              {
                checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, q.visible, _.format({ title: s })),
                color: (0, l.getColorDefinitionProperty)(this._propertyApplier, q.color, null, P.format({ title: s })),
                width: (0, l.convertToDefinitionProperty)(this._propertyApplier, q.linewidth, S.format({ title: s })),
          ...
          const K = (0, l.createCheckablePropertyDefinition)(
            { checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, t.reverse, w.format({ title: s })) },
              ...
              (0, r.createLinePropertyDefinition)(
                {
                  ...
                  width: (0, r.convertToDefinitionProperty)(this._propertyApplier, e.linewidth, c.format({ title: n })),
                  style: (0, r.convertToDefinitionProperty)(this._propertyApplier, e.linestyle, d.format({ title: n })),
                },
                { id: `${i}Line`, title: u },
              ),
      ...
      class C extends s.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          ...
          const k = (0, l.createTwoOptionsPropertyDefinition)(
            {
              checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, t.showLabels, D.format({ title: s })),
            ...
            { id: `${o}Labels`, title: S, optionsItems1: new a.WatchedValue(b), optionsItems2: new a.WatchedValue(m) },
          );
          return e.push(k), { definitions: e };
        }
      }
    ...
    85951: (e, t, i) => {
      i.r(t), i.d(t, { GannComplexAndFixedDefinitionsViewModel: () => N, isGannComplexLineTool: () => z });
      var n = i(50151),
        o = i(44352),
        r = i(36298),
        l = i(50653),
        ...
        u = i(94474),
        h = i(69152);
      const y = new r.TranslatedString('change {title} level {index} line visibility', o.t(null, void 0, i(45463))),
      ...
      class N extends a.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          ...
          const O = (0, s.createPropertyDefinitionsLeveledLinesGroup)(G, `${o}FanLeveledLinesGroup`);
          ...
          const I = (0, s.createPropertyDefinitionsLeveledLinesGroup)(U, `${o}ArcsLeveledLinesGroup`);
      ...
      class _ extends s.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          ...
          const m = (0, l.createCheckablePropertyDefinition)(
            {
              checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, t.showLabels, g.format({ title: s })),
            },
            { id: `${o}Labels`, title: w },
          );
        ...
        _stylePropertyDefinitions() {
          ...
          const X = t.fans.childs(),
            q = (0, l.createColorPropertyDefinition)(
              {
                checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, X.visible, _.format({ title: s })),
                color: (0, l.getColorDefinitionProperty)(this._propertyApplier, X.color, null, P.format({ title: s })),
              },
              { id: `${o}FansLines`, title: V },
            );
          e.push(q);
          const J = (0, l.createCheckablePropertyDefinition)(
            { checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, t.reverse, v.format({ title: s })) },
            { id: `${o}Reverse`, title: $ },
          );
    ...
    83115: (e, t, i) => {
      ...
      var n = i(44352),
        ...
        a = i(46141),
        c = i(94474);
      const d = new o.TranslatedString('change {title} background visibility', n.t(null, void 0, i(64548))),
    ...
    20061: (e, t, i) => {
      i.r(t), i.d(t, { GeneralFiguresDefinitionsViewModel: () => y, GeneralFiguresDefinitionsViewModelBase: () => h });
      var n = i(44352),
        o = i(36298),
        r = i(2908),
        l = i(85766),
    ...
    52266: (e, t, i) => {
      ...
      var n = i(44352),
        ...
        s = i(97145),
        a = i(94474);
      const c = new o.TranslatedString('change {title} candle up color', n.t(null, void 0, i(42273))),
          ...
          return {
            definitions: [
              (0, l.createNumberPropertyDefinition)(
                {
                  value: (0, l.convertToDefinitionProperty)(this._propertyApplier, e.averageHL, g.format({ title: n })),
                },
                {
                  id: `${i}AvgHL`,
                  title: S,
              ...
              (0, l.createNumberPropertyDefinition)(
                {
                  value: (0, l.convertToDefinitionProperty)(this._propertyApplier, e.variance, T.format({ title: n })),
                },
                {
                  id: `${i}Variance`,
                  title: m,
    ...
    77420: (e, t, i) => {
      ...
      var n = i(44352),
        ...
        s = i(46141),
        a = i(94474);
      const c = new o.TranslatedString('change {title} background color', n.t(null, void 0, i(75312))),
    ...
    21905: (e, t, i) => {
      ...
      var n = i(44352),
        ...
        s = i(2908),
        a = i(94474);
      const c = new o.TranslatedString('change {title} extending left', n.t(null, void 0, i(3708))),
    ...
    54440: (e, t, i) => {
      ...
      var n = i(44352),
        ...
        s = i(46141),
        a = i(94474);
      const c = new o.TranslatedString('change {title} source text color', n.t(null, void 0, i(42286))),
          ...
          return {
            definitions: [
              (0, r.createTextStyleDefinition)(
                ...
                n,
                { isEditable: !1, isMultiLine: !1, customTitles: { text: d, borderTitle: h, backgroundTitle: y } },
              ),
              l,
            ],
          };
    ...
    12501: (e, t, i) => {
      ...
      var n = i(44352),
        ...
        s = i(46141),
        a = i(94474);
      const c = new o.TranslatedString('change {title} background color 1', n.t(null, void 0, i(39651))),
    ...
    3664: (e, t, i) => {
      ...
      var n = i(44352),
        ...
        l = i(20061),
        s = i(50653);
      const a = new o.TranslatedString('change {title} extending left', n.t(null, void 0, i(3708))),
      ...
      class y extends l.GeneralFiguresDefinitionsViewModelBase {
        _stylePropertyDefinitions() {
          ...
          const s = (0, r.createCheckablePropertyDefinition)(
            {
              checked: (0, r.convertToDefinitionProperty)(this._propertyApplier, e.extendLeft, a.format({ title: i })),
            },
          ...
          return {
            definitions: [
              (0, s.createTextStyleDefinition)(
                ...
                new o.TranslatedString(this._source.name(), this._source.translatedType()),
                { isEditable: !0, isMultiLine: !0, alignmentVerticalItems: h, customTitles: { text: d } },
              ),
            ],
          };
        }
        ...
        _stylePropertyDefinitions() {
          ...
          return {
            definitions: [
              ...
              (0, a.createCheckablePropertyDefinition)(
                {
                  checked: (0, a.convertToDefinitionProperty)(this._propertyApplier, e.compact, f.format({ title: n })),
                },
        ...
        _inputsPropertyDefinitions() {
          const e = this._source.properties().childs(),
            ...
            l = (0, a.createNumberPropertyDefinition)(
              {
                value: (0, a.convertToDefinitionProperty)(this._propertyApplier, e.accountSize, g.format({ title: n })),
              },
              {
                id: `${i}AccountSize`,
                title: z,
            ...
            s = (0, a.createNumberPropertyDefinition)(
              { value: (0, a.convertToDefinitionProperty)(this._propertyApplier, e.lotSize, T.format({ title: n })) },
              {
                id: `${i}LotSize`,
                title: N,
                type: 1,
            ...
            c = (0, a.createNumberPropertyDefinition)(
              {
                value: (0, a.convertToDefinitionProperty)(this._propertyApplier, e.risk, D.format({ title: n }), [
                  (e) => parseFloat(e),
                ]),
            ...
            u = (0, a.createNumberPropertyDefinition)(
              {
                value: (0, a.convertToDefinitionProperty)(this._propertyApplier, e.entryPrice, _.format({ title: n })),
              },
            ...
            y = (0, a.createNumberPropertyDefinition)(
              {
                value: (0, a.convertToDefinitionProperty)(this._propertyApplier, e.profitLevel, P.format({ title: n })),
              },
              {
            ...
            C = (0, a.createNumberPropertyDefinition)(
              { value: (0, a.convertToDefinitionProperty)(this._propertyApplier, e.stopLevel, m.format({ title: n })) },
              {
                id: `${i}StopLevelTicks`,
                title: V,
                type: 0,
            ...
            L = (0, a.createNumberPropertyDefinition)(
              {
                value: (0, a.convertToDefinitionProperty)(this._propertyApplier, e.stopPrice, b.format({ title: n }), [
                  (e) => e,
                  (e) => this._source.prepareStopPrice(e),
                ]),
              },
              { id: `${i}StopLevelPrice`, title: $, type: 1, step: r },
            );
          return { definitions: [h, v, (0, a.createPropertyDefinitionsGeneralGroup)([C, L], `${i}StopLevel`, B)] };
        }
    ...
    18613: (e, t, i) => {
      ...
      var n = i(44352),
        ...
        c = i(41339),
        d = i(85766);
      const p = new o.TranslatedString('change vertical position Y coordinate', n.t(null, void 0, i(11049))),
              ...
              (0, s.createEmojiPropertyDefinition)(
                {
                  ...
                  emoji: (0, s.convertToDefinitionProperty)(this._propertyApplier, e.emoji, y.format({ title: i })),
                },
        ...
        _stylePropertyDefinitions() {
          const e = [],
            ...
            k = (0, l.createLineStyleDefinition)(
              this._propertyApplier,
              { showLine: x.visible, lineColor: x.color, lineStyle: x.linestyle, lineWidth: x.linewidth },
              L,
              'TrendLine',
              { line: S },
            );
          ...
          const M = (0, s.createTwoOptionsPropertyDefinition)(
            {
              checked: (0, s.convertToDefinitionProperty)(this._propertyApplier, i.showCoeffs, _.format({ title: L })),
              option1: (0, s.convertToDefinitionProperty)(
                this._propertyApplier,
                i.horzLabelsAlign,
                P.format({ title: L }),
    ...
    59973: (e, t, i) => {
      ...
      var n = i(44352),
        ...
        s = i(94474),
        a = i(99970);
      const c = new o.TranslatedString('change {title} VWAP line color', n.t(null, void 0, i(98057))),
        ...
        return (0, r.createLinePropertyDefinition)(
          {
            ...
            color: (0, r.getColorDefinitionProperty)(e, t.color, t.transparency, n.format({ title: d })),
              ...
              (0, r.createLinePropertyDefinition)(
                {
                  ...
                  width: (0, r.convertToDefinitionProperty)(this._propertyApplier, j.linewidth, d.format({ title: H })),
                },
                { id: `${I}VWAPLine`, title: $ },
              ),
            ],
    ...
    69152: (e, t, i) => {
      i.d(t, { CollectibleColorPropertyDirectWrapper: () => a, CollectibleColorPropertyUndoWrapper: () => s });
      var n = i(50151),
        o = i(59452),
        r = i.n(o);
      class l extends r() {
