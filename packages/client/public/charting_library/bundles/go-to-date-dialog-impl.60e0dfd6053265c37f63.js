(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [1859],
  {
    ...
    90744: (e, t, a) => {
      ...
      function p(e) {
        const { startIcon: t, endIcon: a, showCaret: s, iconOnly: l, ellipsis: u = !0, textWrap: d, children: m } = e;
            ...
            r.createElement(
              ...
              d || u
                ? r.createElement(
                    ...
                    r.createElement('span', { className: h()['visually-hidden'], 'aria-hidden': !0 }, m),
                  )
                : r.createElement(
                    r.Fragment,
                    null,
      ...
      function y(e) {
        ...
        return r.createElement(
          ...
          r.createElement(p, { showCaret: d, startIcon: i, endIcon: y, iconOnly: u, ellipsis: c, textWrap: S }, s),
        );
      }
      a(21593);
    },
        ...
        return r.createElement(
          ...
          r.createElement(
            ...
            r.createElement(
              ...
              r.createElement('div', { className: s()(a ? b.textWrap : b.ellipsis) }, t),
              n && r.createElement('div', { className: s()(b.ellipsis, b.subtitle) }, n),
            ),
            c,
            o &&
              !_ &&
              r.createElement(
                ...
                r.createElement(f.Icon, { className: b.icon, icon: g, 'data-name': 'close', 'data-role': 'button' }),
              ),
          ),
        );
      }
      ...
      class z extends r.PureComponent {
          ...
          super(...arguments),
            ...
            (this._handleKeyDown = (e) => {
              if (!e.defaultPrevented) {
                if ((this.props.onKeyDown && this.props.onKeyDown(e), 27 === (0, i.hashFromEvent)(e))) {
                ...
                (function (e) {
                  ...
                  ((a = e), [9, i.Modifiers.Shift + 9].includes((0, i.hashFromEvent)(a)) && a.stopPropagation());
              }
            }),
            (this._requestResize = () => {
            ...
            (this._calculatePositionWithOffsets = (e, t) => {
              const a = (0, n.ensureDefined)(this.props.fullScreenViewOffsets).value();
              return {
                top: a.top,
        ...
        componentDidMount() {
          ...
          this.props.ignoreClosePopupsAndDialog ||
            _.subscribe(y.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._handleClose, null),
            this._handleOpen(),
            void 0 !== this.props.onOpen &&
        ...
        componentWillUnmount() {
          var e, t;
          this.props.ignoreClosePopupsAndDialog ||
            _.unsubscribe(y.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._handleClose, null),
        ...
        render() {
          ...
          return r.createElement(m.MatchMedia, { rule: h.DialogBreakpoints.SmallHeight }, (y) =>
            r.createElement(m.MatchMedia, { rule: h.DialogBreakpoints.TabletSmall }, (h) =>
              r.createElement(
                c.PopupDialog,
                {
                  ...
                  containerAriaLabel: j,
                  containerTabIndex: U,
                  calculateDialogPosition: E && K ? this._calculatePositionWithOffsets : void 0,
                  shadowed: J,
                  ...Z,
                },
                r.createElement(
                  'div',
                  { className: s()(M.wrapper, t), 'data-name': l, 'data-dialog-name': V },
                  void 0 !== o &&
                    r.createElement(S, {
                      draggable: C && !(h || E),
                  ...
                  z && r.createElement(d.Separator, { className: M.separator }),
                  r.createElement(p.PopupContext.Consumer, null, (e) => this._renderChildren(e, h || E)),
                ),
              ),
            ),
          );
    ...
    76068: (e, t, a) => {
      ...
      function o(e) {
        ...
        return (0, n.isCircleLogoWithUrlProps)(e)
          ...
          : r.createElement(
              'span',
              { className: o, title: e.title, 'aria-label': e['aria-label'], 'aria-hidden': e['aria-hidden'] },
              e.placeholderLetter,
            );
      }
    },
    ...
    1109: (e, t, a) => {
      ...
      var r = a(50959),
        ...
        o = a(45719);
      function s(e) {
        return r.createElement('div', { className: n(o.separator, e.className) });
      }
    },
    30586: (e) => {
    ...
    91952: (e, t, a) => {
      ...
      function p(e) {
        const { initialRanges: t, children: a } = e,
          ...
          u = (0, r.useMemo)(() => ({ dateFrom: n, dateTo: s, setDateFrom: o, setDateTo: i, isValid: l }), [n, s, l]);
      ...
      function T(e) {
        const { children: t } = e;
        return r.createElement('div', { className: f()(M.row, R && M.mobileRow) }, t);
      }
      var N = a(85528),
        z = a(76056);
      ...
      function P(e) {
        ...
        return r.createElement(I.Calendar, { ...a, className: f()(O.calendar, t), popupStyle: !1 });
      }
      function A(e, t) {
        const a = new Date(t);
              ...
              !n &&
                r.createElement(L, {
                  ...
                  onPick: function (e) {
                    ...
                    const o = W(n, s);
                    i(o), R || null === (t = l.current) || void 0 === t || t.focus({ preventScroll: !0 });
                  },
                }),
            ),
            !R &&
      ...
      function F(e) {
        const { dateOnly: t, onCalendarMonthSwitch: a, onDateInputFocus: n } = e,
          { dateFrom: s, dateTo: i, setDateFrom: l, setDateTo: u } = (0, o.ensureNotNull)((0, r.useContext)(m)),
              ...
              r.createElement(P, {
                ...
                onSelect: function (e) {
                  ...
                  ({
                    from: () => {
                      var e;
                      l(t), null === (e = y.current) || void 0 === e || e.focus({ preventScroll: !0 });
                    },
                    to: () => {
                      var e;
                      u(t), null === (e = h.current) || void 0 === e || e.focus({ preventScroll: !0 });
                    },
                  })[c]();
                },
                onMonthSwitch: a,
        ...
        function f(e, t, a) {
          ...
          a(W(s, t)), R || null === (r = h.current) || void 0 === r || r.focus({ preventScroll: !0 });
        }
      }
      var j = a(64378),
        H = a(90692),
      ...
      const R = U.mobiletouch,
        J = () => !0,
        K = [
          { label: y.t(null, void 0, a(76912)), id: 'Date', dataId: 'tab-item-date' },
      ...
      function Q(e) {
        const { dateOnly: t, onClose: n, onGoToDate: s, onGoToRange: i } = e,
          ...
          { dateFrom: M, dateTo: T, isValid: N } = (0, o.ensureNotNull)((0, r.useContext)(m));
        return (
          (0, r.useEffect)(
            () => (
          ...
          r.createElement(H.MatchMedia, { rule: D.DialogBreakpoints.TabletSmall }, (e) =>
            ...
            r.createElement(
              ...
              r.createElement(
                ...
                r.createElement(
                  ...
                  r.createElement(G, { onCalendarMonthSwitch: L, onDateInputFocus: L, activeTab: u, dateOnly: t }),
                ),
              ),
            )
          );
      ...
      function G(e) {
        ...
        switch (t) {
          ...
          case 'CustomRange':
            return r.createElement(F, { dateOnly: a, onCalendarMonthSwitch: n, onDateInputFocus: o });
        }
      }
      function V(e) {
        const { dateOnly: t, onClose: a, onGoToDate: n, onGoToRange: o, initialGoToDate: s, initialRanges: i } = e;
        return r.createElement(
          h,
          { initialGoToDate: s },
          r.createElement(
      ...
      function ne(e) {
        const t = (function (e) {
          ...
          return { from: (0, o.ensureNotNull)(t.indexToUserTime(n)), to: (0, o.ensureNotNull)(t.indexToUserTime(s)) };
        })(e);
        return t
          ? { from: (0, i.subtractLocalTime)(t.from), to: (0, i.subtractLocalTime)(t.to) }
          : { from: (0, i.subtractLocalTime)(new Date()), to: (0, i.subtractLocalTime)(new Date()) };
      }
    },
    2948: (e) => {
      e.exports =
