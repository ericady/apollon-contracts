  ...
  [7260],
  {
    ...
    23829: (e, t, s) => {
      ...
      function p(e) {
        const {
          ...
          w = !!k.length;
        return a
          ? r.createElement('li', { className: n()(t, m.item, m.loading, m[z]) }, r.createElement(o.Loader, null))
          : r.createElement(
              'li',
              {
                className: n()(
              ...
              r.createElement('span', { className: n()(m.label) }, null != T ? T : x),
              !!M &&
                r.createElement(i.Icon, {
                  onClick: function () {
                    M && M.action();
              ...
              !w && S && r.createElement(c.Hint, { className: m.shortcut, text: S }),
    ...
    54079: (e, t, s) => {
      ...
      const h = (0, r.forwardRef)(function (e, t) {
        const { onKeyDown: s, orientation: h, blurOnEscKeydown: u = !0, blurOnClick: m = !0, ...p } = e,
          g = o.PLATFORM_ACCESSIBILITY_ENABLED ? { role: 'toolbar', 'aria-orientation': h } : {},
    ...
    33279: (e, t, s) => {
      ...
      var r = s(50959),
        ...
        y = s(57898),
        f = s(36274);
      const S = (e) => n.t(null, { plural: '{str} minutes', count: e, replace: { str: `${e}` } }, s(60144)),
        k = (e) => n.t(null, { plural: '{str} hours', count: e, replace: { str: `${e}` } }, s(17174)),
        x = (e) => n.t(null, { plural: '{str} months', count: e, replace: { str: `${e}` } }, s(28039)),
        C = {
          ...
          '1D': {
            resolution: '1D',
            text: ((T = 1), n.t(null, { plural: '{str} days', count: T, replace: { str: `${T}` } }, s(74262))),
          },
          '1W': {
            resolution: '1W',
            text: ((M = 1), n.t(null, { plural: '{str} weeks', count: M, replace: { str: `${M}` } }, s(14074))),
          },
          ...
          '12M': {
            resolution: '12M',
            text: ((E = 1), n.t(null, { plural: '{str} years', count: E, replace: { str: `${E}` } }, s(8222))),
          },
        };
      var E, M, T;
      function z(e) {
        const t = (function (e) {
            ...
            if (r.isMinutes()) {
              ...
              return e % 60 != 0
                ? ((i = e),
                  n.t(
                    null,
                    { plural: '{str} minutes', count: i, replace: { str: `${i}` }, context: 'timeframe_title' },
                    s(44795),
                  ))
                : ((a = e / 60),
                  n.t(
                    null,
                    { plural: '{str} hours', count: a, replace: { str: `${a}` }, context: 'timeframe_title' },
                    s(89020),
                  ));
            }
            var a;
            ...
            if (r.isWeeks())
              return ((e) =>
                n.t(
                  null,
                  { plural: '{str} weeks', count: e, replace: { str: `${e}` }, context: 'timeframe_title' },
                  s(67518),
                ))(r.multiplier());
            if (r.isMonths()) {
              const e = r.multiplier();
              return e % 12 != 0
                ? ((o = e),
                  n.t(
                    null,
                    { plural: '{str} months', count: o, replace: { str: `${o}` }, context: 'timeframe_title' },
                    s(3189),
                  ))
                : ((e) =>
                    n.t(
                      null,
                      { plural: '{str} years', count: e, replace: { str: `${e}` }, context: 'timeframe_title' },
                      s(6598),
                    ))(e / 12);
            }
            var o;
          ...
          r = (function (e) {
            ...
            if (r.isMinutes()) {
              ...
              return e % 60 != 0
                ...
                : ((a = e / 60),
                  n.t(
                    null,
                    { plural: '{str} hours intervals', count: a, replace: { str: `${a}` }, context: 'timeframe_title' },
                    s(54028),
                  ));
            }
            var a;
            ...
            if (r.isDays())
              return ((e) =>
                n.t(
                  null,
                  { plural: '{str} days intervals', count: e, replace: { str: `${e}` }, context: 'timeframe_title' },
                  s(81693),
                ))(r.multiplier());
            if (r.isWeeks())
              return ((e) =>
                n.t(
                  null,
                  { plural: '{str} weeks intervals', count: e, replace: { str: `${e}` }, context: 'timeframe_title' },
                  s(58667),
                ))(r.multiplier());
            if (r.isMonths()) {
              const e = r.multiplier();
        ...
        return n.t(null, { replace: { timePeriod: t, timeInterval: r }, context: 'timeframe_title' }, s(29505));
      }
      const A = (e) =>
        n.t(null, { plural: '{str} days', count: e, replace: { str: `${e}` }, context: 'timeframe_title' }, s(42908));
      class w {
        constructor(e) {
          (this._state = { ranges: [] }),
        ...
        return (
          ((t = class extends r.PureComponent {
            constructor(e, t) {
              ...
              const s = (this._binding = (0, v.ensureDefined)(W.get(t.chartWidget)));
              this.state = s.state();
            }
            componentDidMount() {
      ...
      const F = { title: n.t(null, void 0, s(60222)), goToDate: (0, B.appendEllipsis)(n.t(null, void 0, s(369))) },
            ...
            (this._renderChildren = (e) => {
              ...
              return e
                ? r.createElement(
                    r.Fragment,
                    null,
                    r.createElement(H, { ranges: t, activeRange: s, onSelectRange: this._handleRangeSelect }),
                ...
                : r.createElement(
                    ...
                    a && r.createElement(p.PopupMenuItem, { label: F.goToDate, onClick: this._handleGoToDateClick }),
                  );
            }),
      ...
      V(function (e) {
        return r.createElement('div', { className: J.slider, ref: e.reference });
      });
      var q = s(40173),
        Z = s(88066),
        $ = s(91348);
      ...
      function K(e) {
        const { reference: t, text: s, tooltip: a, isActive: n, className: i, onClick: l, theme: c = $, ...d } = e,
      ...
      var me = s(88270),
        ...
        ye = s(10643),
        fe = s(85616);
      const Se = (0, q.mergeThemes)(Z.DEFAULT_TOOLBAR_BUTTON_THEME, { isDisabled: fe.disabled, button: fe.button });
      ...
      class xe extends r.PureComponent {
        constructor(e, t) {
          super(e, t),
            ...
            (0, b.validateRegistry)(t, { chartWidget: i.any.isRequired, chartApiInstance: i.any.isRequired }),
            (this.state = { time: '' });
        }
        componentDidMount() {
          const { chartWidget: e } = this.context;
      ...
      var Ce = s(56812);
      function Ee(e) {
        return r.createElement('span', { className: o(Ce.separator, e.className) });
      }
      var Me = s(54079),
        Te = s(36298),
        ze = s(49483);
      class Ae {
        ...
        _setHighlight() {
          ...
          if (null !== r) {
            ...
            null !== a &&
              i.value().axis !== a &&
              (i.setValue({ owner: this._owner, axis: a }), e.lightUpdate(), (this._highlighted = !0));
          }
        }
        _removeHighlight() {
          if (!this._chartWidget.hasModel()) return;
      ...
      var Be = s(42142),
        ...
        He = s(11678),
        Ue = s(97086);
      const Fe = new Te.TranslatedString('change session', n.t(null, void 0, s(65303))),
      ...
      class Xe extends r.PureComponent {
        ...
        updateSessionButton() {
          ...
          const a = r.subsession_id,
            n =
              null !== (t = null === (e = r.subsessions) || void 0 === e ? void 0 : e.filter((e) => !e.private)) &&
              void 0 !== t
                ? t
                : [],
            i = n.find((e) => e.id === a);
          ...
          ((Qe = class extends r.PureComponent {
            constructor(e, t) {
              super(e, t),
                ...
                (this._priceAxisHighlighter = new Ae(this.context.chartWidget, () => this._priceScale, 'logarithm'));
            }
            componentDidMount() {
            ...
            ((t = class extends r.PureComponent {
              constructor(e, t) {
                super(e, t),
                  ...
                  (0, b.validateRegistry)(t, { chartWidget: i.any.isRequired }),
                  (this.state = { isActive: !1, series: null }),
                  (this._priceAxisHighlighter = new Ae(this.context.chartWidget, () => this._priceScale, 'auto'));
              }
              componentDidMount() {
                const e = this.context.chartWidget;
                e.withModel(null, () => {
                ...
                super(e, t),
                  ...
                  (this._handleSelect = () => {
                    const e = this.context.chartWidget.model(),
                      ...
                      s = t.priceScale(),
                      r = s.mode();
                    t.priceScale().isLockScale() || e.setPriceScaleMode({ percentage: !r.percentage }, s, je);
                  }),
                  (0, b.validateRegistry)(t, { chartWidget: i.any.isRequired }),
                  (this.state = { isActive: !1, series: null }),
                  (this._priceAxisHighlighter = new Ae(this.context.chartWidget, () => this._priceScale, 'percentage'));
              }
              componentDidMount() {
                const e = this.context.chartWidget;
                e.withModel(null, () => {
          ...
          return (
            ((t = class extends r.PureComponent {
              ...
              render() {
                ...
                return r.createElement(e, { className: t, isFullscreen: s, onClick: this._handleClick });
              }
      ...
      class ht extends r.PureComponent {
        constructor(e, t) {
          ...
          super(e, t),
              ...
              (e, t, a) => {
                if (r.isValidElement(e) && 'string' != typeof e.type) {
                  ...
                  if ('string' == typeof i.className) {
                    const l = { className: o(i.className, t === a.length - 1 && qe.last) },
                      c = s(),
            ...
            (this._updateButtonsVisibility = () => {
              ...
              const n = ((null == r ? void 0 : r.subsessions) || []).filter((e) => !e.private).length > 1;
              this._setStateWithResize({ intervalAllowsSessionButton: a, symbolAllowsSessionButton: n });
            }),
            (this._handleResize = () => {
              null === this._raf &&
        ...
        componentDidMount() {
          const { onContentBoxChanged: e, resizerDetacher: t, chartWidgetCollection: s, chartWidget: r } = this.context;
        ...
        componentWillUnmount() {
          var e;
          const { onContentBoxChanged: t, resizerDetacher: s, chartWidgetCollection: r, chartWidget: a } = this.context;
        ...
        render() {
          ...
          return r.createElement(
            Me.Toolbar,
            { className: qe.toolbar, onContextMenu: Re.preventDefault, ref: this._handleToolbarRef },
            t &&
              r.createElement(
                Be.FragmentMap,
                null,
                r.createElement(
                  ...
                  r.createElement(
                    ...
                    r.createElement(X, { goToDateButton: this.props.goToDateEnabled, className: qe.dateRange }),
                  ),
                ),
                r.createElement(
                  'div',
                  ...
                  r.createElement(
                    ...
                    r.createElement(re, { onSelectRange: this._trackRangeButtonClick, className: qe.dateRange }),
            ...
            r.createElement(
              ...
              s &&
                r.createElement(
                  'div',
                  { className: o(qe.inline, e.timeZones && qe.collapsed), ref: this._handleTimeZonesRef },
                  r.createElement(
                    'div',
                    { className: qe.inline, onClick: this._trackTimezonesButtonClick },
                    r.createElement(xe, {
                      className: qe.item,
              ...
              this.props.sessionIdButtonEnabled &&
                ...
                r.createElement(
                  'div',
                  { className: o(qe.inline, e.session && qe.collapsed), ref: this._handleSessionsRef },
                  r.createElement(
                    'div',
                    { className: qe.inline },
                    r.createElement(Xe, { className: qe.item, withMenu: this.props.sessionIdButtonEnabled }),
                  ),
                ),
              r.createElement(
                'div',
                { ref: this._handleSeparatorRef, className: o(qe.inline, e.separator && qe.collapsed) },
              ...
              r.createElement(
                ...
                !1,
                !1,
                a && !c.enabled('fundamental_widget') && r.createElement(tt, { className: qe.item }),
        ...
        _setStateWithResize(e) {
          Object.assign(this._layout, ct), this._applyResizing(), this.setState(e, () => this._handleResize());
        }
        _applyResizing() {
          const { dateRangeMode: e, ...t } = this._layout;
          this._rangeExpanded && this._rangeExpanded.classList.toggle(qe.collapsed, 'expanded' !== e),
            this._rangeCollapsed && this._rangeCollapsed.classList.toggle(qe.collapsed, 'collapsed' !== e);
          let s = !1,
            r = !1;
