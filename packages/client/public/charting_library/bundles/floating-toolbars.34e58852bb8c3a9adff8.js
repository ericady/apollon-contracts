(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [2306],
  {
    ...
    1369: (t) => {
      t.exports = { hue: 'hue-r4uo5Wn6', pointer: 'pointer-r4uo5Wn6', pointerContainer: 'pointerContainer-r4uo5Wn6' };
    },
    30099: (t) => {
      t.exports = {
    ...
    94720: (t, e, o) => {
      ...
      function d(t) {
        const { startIcon: e, icon: o, iconOnly: n, children: r, endIcon: a, primaryText: c, secondaryText: d } = t,
          h = null != e ? e : o,
          u = !(e || o || a || n) && !r && c && d;
            ...
            (function (t) {
              return (
                ...
                i.createElement(
                  ...
                  i.createElement('span', { className: l()['primary-text'] }, ' ', t.primaryText, ' '),
                  'string' == typeof t.secondaryText
                    ? i.createElement('span', { className: l()['secondary-text'] }, ' ', t.secondaryText, ' ')
                    : i.createElement(
                        'span',
      ...
      function p(t) {
        ...
        return { ...g, ...(0, u.filterDataProps)(t), ...(0, u.filterAriaProps)(t) };
      }
      function g(t) {
        const { reference: e, ...o } = t,
          { isGrouped: n, cellState: r, disablePositionAdjustment: s } = (0, i.useContext)(h.ControlGroupContext),
          a = c({ ...o, isGrouped: n, cellState: r, disablePositionAdjustment: s });
        return i.createElement('button', { ...p(o), className: a, ref: e }, i.createElement(d, { ...o }));
      }
      ...
      function f(t) {
        const { intent: e, size: o, appearance: i, useFullWidth: n, icon: r, ...s } = t;
        return { ...s, color: _(e), size: v(o), variant: m(i), stretch: n, startIcon: r };
      }
      function y(t) {
    ...
    56073: (t, e, o) => {
      ...
      function i(t, e = !1) {
        const o = getComputedStyle(t),
          i = [o.height];
        return (
          'border-box' !== o.boxSizing && i.push(o.paddingTop, o.paddingBottom, o.borderTopWidth, o.borderBottomWidth),
      ...
      function n(t, e = !1) {
        const o = getComputedStyle(t),
          i = [o.width];
        return (
          'border-box' !== o.boxSizing && i.push(o.paddingLeft, o.paddingRight, o.borderLeftWidth, o.borderRightWidth),
    ...
    70114: (t, e, o) => {
      ...
      var i = o(50959),
        ...
        _ = o(12005);
      function v(t) {
        const { property: e, icon: o, propertyApplier: n, title: v, undoText: f, isToolbarFixed: y, className: b } = t,
          w = (0, g.useProperty)(e),
          C = (0, i.useRef)(null),
        ...
        return i.createElement(
          a.ToolWidgetMenu,
          {
            ...
            content: i.createElement(
              ...
              null,
              w
                ? i.createElement('div', { className: v.multiWidth }, i.createElement(s.Icon, { icon: _ }))
                : i.createElement(
                    'div',
                    { className: v.buttonWrap },
                    !m && i.createElement(s.Icon, { icon: C }),
                    i.createElement('div', { className: n(!m && v.buttonLabel) }, `${b}px`),
                  ),
            ),
          },
    ...
    34381: (t, e, o) => {
        ...
        return (
          (0, i.useLayoutEffect)(() => {
            ...
            const t = (0, l.ensureNotNull)(e.current),
              o = () => {
                const o = (0, a.queryTabbableElements)(t).sort(a.navigationOrderComparator);
                if (0 === o.length || (o[0].parentElement && !m(o[0].parentElement, (0, l.ensureNotNull)(e.current)))) {
                  ...
                  if (null === i) return;
                  if (((0, d.becomeMainElement)(i), o.length > 0)) for (const t of o) (0, d.becomeSecondaryElement)(t);
                }
              };
            return (
            ...
            function (e) {
              ...
              if (t) {
                ...
                Array.from(l.querySelectorAll('button:not([disabled], [aria-disabled])')).filter(
                  (0, a.createScopedVisibleElementFilter)(l),
                )).sort(a.navigationOrderComparator)),
                  (s = r.indexOf(i));
              var l;
      ...
      const C = function (t, e, o) {
        ...
        if (!i || e < 1) return [];
        for (var n = 0, r = 0, s = Array(b(i / e)); n < i; ) s[r++] = (0, v.default)(t, n, (n += e));
        return s;
      };
      var T = o(24377),
        x = o(49483),
          ...
          _ &&
            i.createElement(
              S.PopupMenu,
              {
                ...
                onClose: v,
                position: function () {
                  const t = (0, l.ensureNotNull)(g.current).getBoundingClientRect();
      ...
      class V extends i.PureComponent {
        ...
        render() {
          ...
          return i.createElement(
            ...
            i.createElement('div', { className: F.pointer, style: { left: 100 * o + '%', top: 100 * (1 - n) + '%' } }),
          );
        }
      }
      var z = o(1369);
        ...
        render() {
          ...
          return i.createElement(
            ...
            i.createElement(
              ...
              i.createElement('div', { className: z.pointer, style: { top: 100 * e + '%' } }),
            ),
          );
        }
      }
      ...
      class Z extends i.PureComponent {
              ...
              const e =
                (function (t) {
                  ...
                  return (
                    '#' +
                    [255 * n, 255 * r, 255 * s]
                      .map((t) => ('0' + Math.round(t).toString(16)).replace(/.+?([a-f0-9]{2})$/i, '$1'))
                      .join('')
                  );
                })(t) || U;
              this.setState({ color: e, inputColor: e.replace(/^#/, ''), hsv: t }), this.props.onSelect(e);
            }),
            (this._handleInput = (t) => {
        ...
        componentDidMount() {
          ...
          a.PLATFORM_ACCESSIBILITY_ENABLED &&
            !x.CheckMobile.any() &&
            (null === (t = this._inputRef.current) || void 0 === t || t.focus());
        }
        render() {
          ...
          return i.createElement(
            ...
            i.createElement(
              'div',
              { className: H.form },
              i.createElement('div', { className: H.swatch, style: { backgroundColor: t } }),
              i.createElement(
                'div',
              ...
              i.createElement(
                ...
                i.createElement(A.Button, { size: 's', onClick: this._handleAddColor }, j),
              ),
            ),
            i.createElement(
              'div',
              { className: H.hueSaturationWrap },
              i.createElement(V, { className: H.saturation, hsv: e, onChange: this._handleHSV }),
              i.createElement(O, { className: H.hue, hsv: e, onChange: this._handleHSV }),
            ),
          );
        }
      }
          ...
          g
            ...
            : i.createElement(
                ...
                i.createElement(
                  'div',
                  { ref: v, onKeyDown: f },
                  i.createElement(N, { colors: W.basic, color: e, onSelect: y }),
                  i.createElement(N, { colors: W.extended, color: e, onSelect: y }),
      ...
      class d extends i.PureComponent {
        constructor(t) {
          super(t),
            ...
            (this._mouseUp = (t) => {
              this.setState({ isPointerDragged: !1 }), this._dragUnsubscribe(), this._handlePosition(t);
            }),
            (this._mouseMove = (t) => {
            ...
            (this._handleTouch = (t) => {
              this.setState({ isPointerDragged: !0 }), this._handlePosition(t.nativeEvent.touches[0]);
            }),
            ...
            (this._handleInput = (t) => {
              const e = t.currentTarget.value,
                o = Number(e) / 100;
              this.setState({ inputOpacity: e }), Number.isNaN(o) || o > 1 || this.props.onChange(o);
            }),
            (this._handleKeyDown = (t) => {
              ...
              37 === e && 0 !== o && this._changeOpacity(o - 1), 39 === e && 100 !== o && this._changeOpacity(o + 1);
            }),
            (this.state = { inputOpacity: Math.round(100 * t.opacity).toString(), isPointerDragged: !1 });
        }
        componentWillUnmount() {
          null !== this._raf && (cancelAnimationFrame(this._raf), (this._raf = null)), this._dragUnsubscribe();
        }
        render() {
          const { color: t, opacity: e, hideInput: o, disabled: r } = this.props,
        ...
        _changeOpacity(t) {
          this.setState({ inputOpacity: t.toString() }), this.props.onChange(t / 100);
        }
      }
    },
    6914: (t, e, o) => {
      ...
      class _ extends n.FloatingToolbar {
        ...
        showAndSaveSettingsValue() {
          this._canBeShownValue.value() &&
            (p.TVLocalStorage.setItem('ChartFavoriteDrawingToolbarWidget.visible', 'true'), this.show());
        }
        ...
        _createLinetoolWidget(t) {
          ...
          return (
            o.addEventListener('click', async (e) => {
              e.preventDefault(), await (0, m.initLineTool)(t), d.tool.value() !== t && d.tool.setValue(t);
            }),
        ...
        _loadVisibilityState() {
          ...
          void 0 !== i
            ? (u.remove('ChartFavoriteDrawingToolbarWidget.visible', { forceFlush: !0 }),
              (o = 'false' !== i),
              p.TVLocalStorage.setItem('ChartFavoriteDrawingToolbarWidget.visible', i))
            : (o = 'false' !== p.TVLocalStorage.getItem('ChartFavoriteDrawingToolbarWidget.visible')),
    ...
    3809: (t, e, o) => {
      'use strict';
      o.d(e, { FLOATING_TOOLBAR_REACT_WIDGETS_CLASS: () => b, FloatingToolbar: () => C });
      var i = o(59064),
        n = o(32563),
        r = o(61345),
        s = o(56840),
      ...
      class m {
        constructor(t) {
                ...
                (this._helper.raf = requestAnimationFrame(() => {
                  null !== this._helper &&
                    ...
                    null !== this._helper.nextLeft &&
                      ((n.style.left = this._helper.nextLeft + 'px'), (this._helper.nextLeft = null)),
          ...
          const n = (this._handle = null !== (e = t.handle ? i.querySelector(t.handle) : null) && void 0 !== e ? e : i);
        ...
        constructor(t) {
          (this._initial = null),
            (this._handlePointerDown = (t) => {
              ...
              if (((this._initial = t), !this._dispatchEvent(this._createEvent('pointer-drag-start', t))))
            ...
            (this._handlePointerMove = (t) => {
              null !== this._initial &&
                ...
                (t.preventDefault(), this._dispatchEvent(this._createEvent('pointer-drag-move', t)));
            }),
      ...
      class C {
        constructor(t) {
          (this._widget = document.createElement('div')),
            ...
            (this._reactWidgetsContainer = this._widget.getElementsByClassName(b).item(0)),
        ...
        _savePosition() {
          ...
          if ('device' === this._options.positionStorageType)
            try {
              h.TVLocalStorage.setItem(this._options.positionSettingsKey, JSON.stringify({ left: t.left, top: t.top }));
            } catch (t) {}
        ...
        _initSortable() {
          ...
          lazyJqueryUI(this._content).sortable({
            ...
            stop: (e, o) => {
              ...
              t !== i && ((0, f.trackEvent)('Floating Toolbar', 'User Sort'), this._reorderedDelegate.fire(t, i));
            },
            tolerance: 'pointer',
            distance: 5,
    ...
    89824: (t, e, o) => {
      ...
      class m extends g() {
        ...
        unsubscribe(t, e) {
          ...
          const i = (0, u.ensureDefined)(
            null === (o = this._listenersMappers.find((o) => o.obj === t && o.method === e)) || void 0 === o
              ? void 0
              : o.callback,
          );
      ...
      function D(t) {
        ...
        return i.createElement(L.ToolButton, { className: v(e, B.button), tooltipPosition: 'horizontal', ...o });
      }
      var k = o(65186),
        N = o(91244);
      function I(t) {
        ...
        const a = s[0].properties().frozen,
          l = (0, W.useProperty)(a),
          c = l ? { tooltip: r.t(null, void 0, o(15101)), icon: k } : { tooltip: r.t(null, void 0, o(42284)), icon: N };
      ...
      var R = o(9745),
        ...
        $ = o(84959);
      function G(t, e) {
        const i = [(0, H.createVisualOrderAction)(t, e), (0, H.createChangeIntervalsVisibilitiesAction)(t, e)],
          n = (function (t, e) {
            const i = [],
              n = U.isMacKeyboard ? ' +' : '',
            ...
            return (function (t, e) {
              return !!(null == t ? void 0 : t.isMultipleLayout().value()) && e.some((t) => t.isSynchronizable());
            })(t, e)
              ...
              n &&
                h().then((e) => {
                  window.matchMedia(w.DialogBreakpoints.TabletSmall).matches
                    ? O.ContextMenuManager.showMenu(K(e), t, { mode: 'drawer', 'data-name': 'more-menu' })
                    : l(K(e));
                });
            },
            [n, h],
      ...
      var X = o(95586),
        ...
        et = o(57740);
      function ot(t) {
        const { property: e, propertyApplier: n, title: s, undoText: a, isToolbarFixed: l, className: c } = t,
          d = (0, W.useProperty)(e),
          h = (0, i.useMemo)(
            () => [
              new Z.Action({
      ...
      function rt(t) {
        const { property: e, propertyApplier: o, title: n, undoText: r, isToolbarFixed: s, className: a } = t,
          l = (0, W.useProperty)(e),
          c = nt.map(
            (t) =>
              new Z.Action({
      ...
      class at extends b.FloatingToolbar {
        ...
        setGroupedWidgetState(t, e) {
          const o = this._ensuredGetWidgetDataForId(t);
          (0, u.assert)(-1 !== at._getStateIndexById(o.statedWidget, e), `Unknown stateId (${e})`),
        ...
        _updateWidgetPreview(t) {
          ...
          (0, u.assert)(-1 !== e, `Unknown state id: ${t.statedWidget.currentStateId}`);
      ...
      const pt = !1,
        ...
        _t =
          (new s.TranslatedString('apply drawing template', r.t(null, void 0, o(49037))), r.t(null, void 0, o(89517))),
      ...
      class wt {
        constructor(t) {
          (this._isDrawingFinished = new l.WatchedValue(!0)),
            ...
            (this._floatingToolbar = new at({
              defaultPosition: { top: lt.HEADER_TOOLBAR_HEIGHT_EXPANDED + 15, left: window.innerWidth / 2 },
            ...
            this._selectedSourcesSpawn.subscribe(() => this.onSourceChanged(this.selectedSources())),
        ...
        onSourceChanged(t) {
          ...
          if (
            ...
            const e = t[0];
            e.isAvailableInFloatingWidget() && this.activeChartWidget().model().model().dataSourceForId(e.id())
              ? (!e.userEditEnabled() ||
        ...
        _onToolChanged(t, e) {
          ...
          this._isDrawingToolExcludingCustomUrlEventTool(t)
            ...
            : o && o.length
            ? (o.length > 1 && this._isDrawingFinished.setValue(!0), this.onSourceChanged(this.selectedSources()))
            : this.hide();
        }
        ...
        _unmountFloatingToolbar() {
          null !== this._floatingContainer &&
            (n.unmountComponentAtNode(this._floatingContainer), (this._floatingToolbarRendered = !1));
        }
        ...
        _createSettingsButton() {
          const t = { component: E, props: { title: _t, activeChartWidget: this.activeChartWidget() } };
        ...
        _createProperty(t, e, o, i) {
          if (e) {
            ...
            return this._isWidthProperty(t[0])
              ? new m(new h.MultipleLineWidthsProperty(t), this._propertyApplierImpl(), i)
    ...
    26916: (t, e, o) => {
      ...
      class L extends n {
        ...
        _createWidthsButton(t, e) {
          if (
            (this._lineWidthsProperty && (this._lineWidthsProperty.destroy(), (this._lineWidthsProperty = null)),
            (this._lineWidthsProperty = this._createProperty(t, e, 'linesWidths', p)),
            !this._lineWidthsProperty)
          )
            return !0;
          var o = C;
          e && 1 !== this.selectedSources().filter((t) => t.properties().linesWidths).length && (o = T);
          return (
        ...
        _createTextColorsButton(t, e) {
          return (
            ...
            (this._textColorsProperty = this._createProperty(t, e, 'textsColors', u)),
        ...
        showPropertiesOf(t, e, o) {
          ...
          if ((this._clearProperties(), (this._propertiesVisible = !1), i.length)) {
            for (var n = {}, s = 0; s < i.length; s++) {
              for (var a = i[s], l = e, c = a.name.split('.'), d = 0; d < c.length; ++d) l = l && l[c[d]];
              var h = a.showIf;
        ...
        _defaultToolProperties() {
          return [
            ...
            { name: 'linesWidths', inputType: 'combobox', factory: L.prototype._createWidthsButton },
            { name: 'linestyle', title: b, inputType: 'combobox', factory: L.prototype._createLineStyleButton },
          ];
        }
        _regressionToolExceptionCases() {
          return [{ name: 'linesWidths', inputType: 'combobox', factory: L.prototype._createWidthsButton }];
        }
        _pathExceptionCases() {
          return [
            {
        ...
        _textPropertiesExceptionCases() {
          return [
            { name: 'color', title: _, inputType: 'colorPicker', iconSvgCode: c, dataName: 'text-color', undoText: u },
            {
              name: 'backgroundColor',
              title: f,
              inputType: 'colorPicker',
            ...
            { name: 'fontsize', title: w, inputType: 'combobox', factory: L.prototype._createFontSizeButton },
          ];
        }
    ...
    69152: (t, e, o) => {
      'use strict';
      o.d(e, { CollectibleColorPropertyDirectWrapper: () => l, CollectibleColorPropertyUndoWrapper: () => a });
      var i = o(50151),
        n = o(59452),
        r = o.n(n);
      class s extends r() {
