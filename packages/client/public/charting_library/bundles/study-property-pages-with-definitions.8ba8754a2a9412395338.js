  ...
  [607],
  {
    41109: (e, t, i) => {
      ...
      var n = i(44352),
        ...
        s = i(94474),
        o = i(99970);
      const d = new a.TranslatedString('change {title} base line visibility', n.t(null, void 0, i(16688))),
            ...
            T = (0, l.createLinePropertyDefinition)(
              {
                ...
                width: (0, l.convertToDefinitionProperty)(this._propertyApplier, r.linewidth, h.format({ title: n })),
                style: (0, l.convertToDefinitionProperty)(this._propertyApplier, r.linestyle, u.format({ title: n })),
              },
            ...
            N = (0, l.createLinePropertyDefinition)(
              {
                ...
                width: (0, l.convertToDefinitionProperty)(this._propertyApplier, L.linewidth, g.format({ title: n })),
                style: (0, l.convertToDefinitionProperty)(this._propertyApplier, L.linestyle, b.format({ title: n })),
              },
              { id: `${i}UpLine`, title: P },
            ),
            M = e.downLine.childs();
              ...
              (0, l.createLinePropertyDefinition)(
                {
                  ...
                  width: (0, l.convertToDefinitionProperty)(this._propertyApplier, M.linewidth, v.format({ title: n })),
                  style: (0, l.convertToDefinitionProperty)(this._propertyApplier, M.linestyle, f.format({ title: n })),
                },
    ...
    89204: (e, t, i) => {
      ...
      const w = n.t(null, void 0, i(32733)),
        ...
        P = ['1', '3', '5', '15', '30', '45', '60', '120', '180', '240', '1D', '1W', '1M'].map((e) => ({
          value: e,
      ...
      class O extends class {
        ...
        _createVisibilitiesPropertyPage() {
          ...
          return (0, o.createPropertyPage)(
            (0, v.getIntervalsVisibilitiesPropertiesDefinitions)(
              this._undoModel,
              e,
              new a.TranslatedString(this._source.name(!0), this._source.title(f.TitleDisplayTarget.StatusLine, !0)),
            ),
            'visibility',
            S,
          );
        ...
        _inputsPropertyDefinitions() {
          ...
          return (
            null !== this._sourceInput && (this._inputSourceItems = new c.WatchedValue(this._getInputSourceItems())),
            (function (e, t, l, o, d) {
              const h = [];
              for (const b of t) {
                if (!p(b, o)) continue;
                ...
                if ('resolution' === b.type)
                  f = (0, s.createOptionsPropertyDefinition)(
                    { option: (0, s.convertToDefinitionProperty)(e, l[b.id], u.format({ inputName: v })) },
                  ...
                  f = (0, s.createSessionPropertyDefinition)(
                    { session: (0, s.convertToDefinitionProperty)(e, l[b.id], u.format({ inputName: v })) },
                    { id: _, title: m },
                  );
                else if ('bool' === b.type)
                  f = (0, s.createCheckablePropertyDefinition)(
                    { checked: (0, s.convertToDefinitionProperty)(e, l[b.id], u.format({ inputName: v })) },
                    { id: _, title: m },
                  );
                  ...
                  void 0 !== b.min && (t.min = new c.WatchedValue(b.min)),
                    ...
                    void 0 !== b.step && isFinite(b.step) && b.step > 0 && (t.step = new c.WatchedValue(b.step)),
                    (f = (0, s.createNumberPropertyDefinition)(
                      { value: (0, s.convertToDefinitionProperty)(e, l[b.id], u.format({ inputName: v })) },
                      t,
                    ));
                } else
                  f = (0, s.createTextPropertyDefinition)(
                    { text: (0, s.convertToDefinitionProperty)(e, l[b.id], u.format({ inputName: v })) },
            ...
            this._source
              ...
              .style.subscribe(this, (e) => {
                ...
                null !== this._stylesPropertyPage &&
                  ...
                  this._stylesPropertyPage.definitions.setValue(this._stylePropertyDefinitions().definitions)),
                  null === (t = this._availableStylesWV) || void 0 === t || t.setValue(this._availableStyles());
              });
        }
        destroy() {
        ...
        _stylePropertyDefinitions() {
          void 0 === this._availableStylesWV &&
            ...
            this._source.symbolResolved().subscribe(this, () => {
              var e;
              null === (e = this._availableStylesWV) || void 0 === e || e.setValue(this._availableStyles());
            }));
          const e = this._source.properties().childs(),
            ...
            n = (0, s.createOptionsPropertyDefinition)(
              ...
              { id: 'StudyOverlayMinTick', title: V, options: new c.WatchedValue((0, b.seriesPrecisionValues)()) },
            ),
