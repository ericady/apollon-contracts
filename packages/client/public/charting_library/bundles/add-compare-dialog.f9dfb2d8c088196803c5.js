  ...
  [731],
  {
            ...
            if (a) {
              ...
              if (
                ...
                (n = [].concat(t(n), [m])),
                  ...
                  s || (document.addEventListener('touchmove', u, o ? { passive: !1 } : void 0), (s = !0));
              }
            } else {
              (p = r),
                setTimeout(function () {
            ...
            (e.clearAllBodyScrollLocks = function () {
              a
                ? (n.forEach(function (e) {
                  ...
                  s && (document.removeEventListener('touchmove', u, o ? { passive: !1 } : void 0), (s = !1)),
                  (n = []),
                  (i = -1))
                : (m(), (n = []));
            }),
            (e.enableBodyScroll = function (e) {
              if (a) {
                ...
                (e.ontouchstart = null),
                  ...
                  s &&
                    0 === n.length &&
                    (document.removeEventListener('touchmove', u, o ? { passive: !1 } : void 0), (s = !1));
              } else
    ...
    70673: (e, t, o) => {
      ...
      function d(e) {
        ...
        return r.createElement(
          ...
          r.createElement('span', { className: t }, r.createElement(s.Icon, { icon: i, className: c().icon })),
        );
      }
    },
    36383: (e, t, o) => {
    ...
    89035: (e, t, o) => {
      ...
      function T(e) {
        const { fullSymbolName: t, isSelected: n, className: s, isYield: l } = e,
          { isMobile: d, searchRef: u, setMode: m } = (0, k.useEnsuredContext)(g.SymbolSearchItemsDialogContext),
          {
            compareModel: h,
        ...
        return d
          ? r.createElement(
              ...
              r.createElement(
                ...
                r.createElement('div', { className: D.header }, a.t(null, void 0, o(79589))),
                r.createElement(w.PopupMenuItem, { className: D.item, onClick: A, onClickArg: E, label: N }),
          ...
          : r.createElement(
              'div',
              { className: c()(D.wrap, s), 'data-name': 'compare-buttons-group' },
              r.createElement(z, { onClick: A, value: E, isItemSelected: Boolean(n), isSelected: n && p === E }, N),
              r.createElement(
                z,
                {
                  onClick: A,
      ...
      function A(e) {
        const { isSelected: t, fullSymbolName: o, onExpandClick: a, actions: s, id: l, isOffset: c, isYield: d } = e,
          {
            isMobile: u,
            toggleExpand: m,
            searchSpreads: h,
      ...
      var B = o(15550),
        ...
        H = o(78724);
      function O(e) {
        const { handleListWidth: t } = (0, d.ensureNotNull)((0, r.useContext)(g.SymbolSearchItemsDialogContext)),
          { compareModel: n, selectedCompareIndex: s, selectedItemRef: i } = (0, d.ensureNotNull)((0, r.useContext)(S)),
          ...
          r.createElement(
            ...
            (e) =>
              r.createElement(
                ...
                (function () {
                  if (!l) return r.createElement('div', { className: H.spinnerWrap }, r.createElement(p.Spinner, null));
                  ...
                  return r.createElement(
                    ...
                    Boolean(x.length) &&
                      r.createElement(
                        r.Fragment,
                        null,
                        r.createElement('div', { className: H.heading }, a.t(null, void 0, o(46580))),
                        x.map((e, t) =>
                          r.createElement(y.SymbolSearchDialogContentItem, {
                            ...
                            actions: r.createElement(
                              ...
                              r.createElement(
                                N,
                                { className: H.checkbox, onClick: I.bind(null, e), isSelected: C(e) },
                    ...
                    Boolean(w.length) &&
                      r.createElement(
                        r.Fragment,
                        null,
                        r.createElement('div', { className: H.heading }, a.t(null, void 0, o(57570))),
                        w.map((e) =>
                          r.createElement(A, {
      ...
      class W extends r.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._toggleAllowExtendTimeScale = () => {
              ...
              R.setValue('showAddSymbolDialog.extendCheckboxState', e), this.setState({ allowExtendTimeScale: e });
            }),
            (this.state = {
        ...
        render() {
          ...
          return r.createElement(S.Provider, { value: this._getContextValue() }, e);
        }
      }
      var F = o(68335),
        U = o(35057),
            ...
            onKeyDown: function (e) {
              ...
              switch (l) {
                ...
                case 13: {
                  ...
                  a &&
                    N &&
                    (i([{ symbol: f ? a.toUpperCase() : a, resolved: !1, compareOption: x, allowExtendTimeScale: z }]),
                    N(o, d));
                  break;
                }
                case 27:
      ...
      var X = o(81319),
        ...
        $ = o(70613);
      function ee(e) {
        const { searchRef: t, setMode: o } = (0, k.useEnsuredContext)(g.SymbolSearchItemsDialogContext),
        ...
        function n() {
          ...
          t.current &&
            ...
            ('compare' !== a.current ||
            '' ===
              (null === (r = null === (e = null == t ? void 0 : t.current) || void 0 === e ? void 0 : e.value) ||
              void 0 === r
                ? void 0
                : r.trim())
              ? 'symbolSearch' === a.current &&
                '' ===
                  (null === (s = null === (n = null == t ? void 0 : t.current) || void 0 === n ? void 0 : n.value) ||
                  void 0 === s
                    ? void 0
                    : s.trim()) &&
                o('compare')
      ...
      var te = o(70673),
        ...
        re = o(44467);
      function ae(e) {
        const { allowExtendTimeScale: t, toggleAllowExtendTimeScale: n } = (0, d.ensureNotNull)((0, r.useContext)(S));
        return r.createElement(
    ...
    37558: (e, t, o) => {
      ...
      class n extends r.PureComponent {
        ...
        componentDidUpdate(e, t) {
          !t.stack.length && this.state.stack.length && ((0, a.setFixedBodyState)(!0), (this._isBodyFixed = !0)),
            t.stack.length &&
    ...
    41590: (e, t, o) => {
        ...
        return (
          ...
          r.createElement(
            ...
            r.createElement(
              ...
              f === v.currentDrawer && r.createElement('div', { className: u.backdrop, onClick: o }),
              r.createElement(
                h,
                { className: n(p.drawer, u[`position${t}`], m), ref: b, 'data-name': e['data-name'] },
                d,
              ),
            ),
          )
      ...
      const h = (0, r.forwardRef)((e, t) => {
        ...
        return r.createElement(d.TouchScrollContainer, { className: n(u.drawer, o), tabIndex: -1, ref: t, ...a });
      });
    },
    70412: (e, t, o) => {
      'use strict';
      ...
      function m(e) {
        ...
        return r.createElement(
          V,
          {
            ...
            'aria-selected': m,
            'aria-checked': h,
            className: a(p, P.item, S && P.withIcon, { [P.isActive]: _, [P.isDisabled]: k || w, [P.hovered]: x }),
            title: v,
            href: C,
            target: z,
            rel: M,
            ...
            onClick: function (t) {
              const { dontClosePopup: o, onClick: r, onClickArg: a, trackEventObject: i } = e;
              if (k) return;
          ...
          (void 0 !== g || y) &&
            r.createElement('span', { className: P.shortcut }, (Z = g) && Z.split('+').join(' + ')),
          void 0 !== D &&
            r.createElement(
              'span',
              { onClick: j ? u : void 0, className: a(P.toolbox, { [P.showOnHover]: E, [P.showOnFocus]: N }) },
              D,
            ),
        );
        var Z;
