  ...
  [2183],
  {
          ...
          for (let a = 0; a < n.length; ++a) {
            ...
            if (d.subtract(t).length() <= i + o)
              return new l.HitTestResult(Array.isArray(s) ? s[a] : s, {
                pointIndex: d.data,
                cursorType: null !== (e = null == r ? void 0 : r[a]) && void 0 !== e ? e : u.PaneCursorType.Default,
        ...
        _drawPoints(t, e, i, n, r) {
          ...
          for (let t = 0; t < e.length; ++t) {
            ...
            if (!((0, a.isInteger)(s.data) && c.linePointBeingEdited === s.data)) {
              if (
                (n(o, new h(Math.round(s.x * l) + y, Math.round(s.y * u) + y, s.data, s.square), f / 2, P),
                ...
                if (s.subtract(p).length() <= _ + m) {
                  ...
                  e % 2 != g % 2 && (e += 1);
                  r(o, new h(Math.round(s.x * l) + y, Math.round(s.y * u) + y, s.data, s.square), e / 2, t);
                }
              }
            }
          }
        ...
        _fillInformationAboutPointsAndCursors(t, e) {
          ...
          this._inputs.forEach((i, r) => {
            ...
            if (Array.isArray(i)) {
              ...
              null !== n &&
                null !== r &&
                ((o = this._convertTimeToCoordinate(n)), (l = this._convertPriceToCoordinate(r)), (u = !1));
            } else {
              const n = this._getInputValue(i.id);
              null !== n &&
                ('time' === i.type
                  ? ((o = this._convertTimeToCoordinate(n)), (l = t / 2), (s = a.PaneCursorType.HorizontalResize))
                  : ((o = e / 2), (l = this._convertPriceToCoordinate(n)), (s = a.PaneCursorType.VerticalResize)));
            }
            if (null !== o && null !== l) {
              const t = new n.Point(o, l);
              (t.activeItem = d), (t.square = u), (t.data = r), this._points.push(t), this._cursors.push(s);
            }
          });
        }
    ...
    8475: (t, e, i) => {
      ...
      var n = i(48891),
        ...
        l = i(71254),
        u = i(81824);
      const d = { color: n.colorsPalette['color-cold-gray-500'], linewidth: 1, linestyle: r.LINESTYLE_SOLID };
