(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [1583],
  {
      ...
      class _ extends u.LineSourcePaneView {
        constructor(e, t) {
          super(e, t),
            ...
            (this._polylineRenderer = new c.PolygonRenderer(new h.HitTestResult(h.HitTarget.MovePoint))),
        ...
        _updateImpl() {
          ...
          const g = i(a, 'X');
          l.y > a.y ? ((g.vertAlign = 'bottom'), (g.offsetY = 5)) : ((g.vertAlign = 'top'), (g.offsetY = 5)),
            this._textRendererXLabel.setData(g),
            t.append(this._textRendererXLabel);
          const f = i(l, 'A');
          if (
            (l.y < a.y ? ((f.vertAlign = 'bottom'), (f.offsetY = 5)) : ((f.vertAlign = 'top'), (f.offsetY = 5)),
      ...
      class p extends c.LineSourcePaneView {
        constructor() {
          super(...arguments),
            ...
            (this._polylineRenderer = new d.PolygonRenderer(new h.HitTestResult(h.HitTarget.MovePoint))),
        ...
        _updateImpl() {
          ...
          const p = i(o, 'A');
          a.y > o.y ? ((p.vertAlign = 'bottom'), (p.offsetY = 5)) : ((p.vertAlign = 'top'), (p.offsetY = 5)),
            this._textRendererALabel.setData(p),
            t.append(this._textRendererALabel);
          const _ = i(a, 'B');
          if (
            (a.y < o.y ? ((_.vertAlign = 'bottom'), (_.offsetY = 5)) : ((_.vertAlign = 'top'), (_.offsetY = 5)),
            this._textRendererBLabel.setData(_),
            t.append(this._textRendererBLabel),
            this._points.length > 2)
          ) {
            const e = i(d, 'C');
            d.y < a.y ? ((e.vertAlign = 'bottom'), (e.offsetY = 5)) : ((e.vertAlign = 'top'), (e.offsetY = 5)),
              this._textRendererCLabel.setData(e),
              t.append(this._textRendererCLabel);
          }
          if (this._points.length > 3) {
    ...
    37803: (e, t, i) => {
      ...
      class p extends c.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e) {
          ...
          if (l < 1)
            return (
              (l = (0, n.distanceToLine)(i, o, e).distance), l < t ? new h.HitTestResult(h.HitTarget.MovePoint) : null
            );
          ...
          if (
            ...
            return null;
          let w;
          w = e.y < 0 ? new r.Point(0.5 * c, (c * Math.sqrt(3)) / 2) : new r.Point(0.5 * c, (-c * Math.sqrt(3)) / 2);
      ...
      class _ extends l.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          (L.data = 2), d.push(L);
          const S = [o.PaneCursorType.Default, o.PaneCursorType.Default, (0, l.thirdPointCursorType)(h, u)];
      ...
      class p extends c.MediaCoordinatesPaneRenderer {
        ...
        _measureInfo(e, t, i) {
          if (this._geomertryCacheInvalidated) {
            ...
            (this._geometryCache = { paddingLeft: s, innerWidth: a, innerHeight: l, textHorizontalPadding: d }),
    ...
    54364: (e, t, i) => {
      'use strict';
      i.d(t, { BezierQuadroRenderer: () => p, buildExtendedSegments: () => u, hitTestExtendedPoints: () => c });
      var n = i(4652),
        r = i(15187),
        s = i(73436),
        o = i(18807),
      ...
      function c(e, t, i) {
        for (const r of i)
          for (let i = 1; i < r.length; i++) {
            const s = r[i - 1],
              a = r[i];
            if ((0, n.distanceToSegment)(s, a, e).distance < t) return new o.HitTestResult(o.HitTarget.MovePoint);
          }
        return null;
      }
      function u(e, t) {
      ...
      class p extends r.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e, t) {
          if (null !== this._data && 3 === this._data.points.length) {
            ...
            if ((0, a.quadroBezierHitTest)(r, i, l, e, t) || (0, a.quadroBezierHitTest)(r, n, h, e, t))
              return new o.HitTestResult(o.HitTarget.MovePoint);
    ...
    70326: (e, t, i) => {
      ...
      class p extends c.MediaCoordinatesPaneRenderer {
        constructor() {
          super(), (this._data = null), (this._textSizeCache = { totalHeight: NaN, totalWidth: NaN });
        }
        setData(e) {
          this._data = e;
        }
        ...
        _drawImpl(e) {
          ...
          t.x > c + o ? (p = 20) : t.x > c && (p = 10),
            ...
            10 === p
              ? _
                ? (n.lineTo(i.x - 8, 0), n.lineTo(t.x, t.y), n.lineTo(i.x + 8, 0), n.lineTo(o - 8, 0))
                : (n.lineTo(t.x, t.y), n.lineTo(o - 8, 0))
              : n.lineTo(o - 8, 0),
            20 === p ? (n.lineTo(t.x, t.y), n.lineTo(o, 8)) : n.arcTo(o, 0, o, 8, 8),
            21 === p
              ? g
                ? (n.lineTo(o, i.y - 8), n.lineTo(t.x, t.y), n.lineTo(o, i.y + 8), n.lineTo(o, a - 8))
            ...
            (c = 10 + f);
          for (const e of this._data.textData.lines) n.fillText(e, c, u), (u += this._data.textData.fontSize);
        }
      }
      var _ = i(79191),
        g = i(80657);
      ...
      class v extends _.LineSourcePaneView {
        constructor(e, t) {
          super(e, t), (this._calloutRenderer = new p()), (this._renderer = new o.CompositeRenderer());
        }
        renderer(e, t) {
          return this._invalidated && this._updateImpl(), this._renderer;
        }
                    ...
                    Math.max(
                      ...
                      (function (e, t) {
                        if (null === f) {
                          ...
                          (e.width = 0), (e.height = 0), (f = (0, r.ensureNotNull)(e.getContext('2d')));
                        }
          ...
          if ((super._updateImpl(), (this._renderer = null), !(this._source.points().length < 2))) {
            ...
            if (this._source.priceScale() && !this._source.priceScale().isEmpty() && !e.isEmpty()) {
              ...
              if (((this._lines = []), 0 !== r)) {
                ...
                if (r > 0)
                  for (var h = t.index; h <= o.lastBar(); h += r) this._lines.push({ x: e.indexToCoordinate(h) });
                else for (h = t.index; h >= o.firstBar(); h += r) this._lines.push({ x: e.indexToCoordinate(h) });
    ...
    79104: (e, t, i) => {
      ...
      class h {
        ...
        draw(e, t) {
          if (null === this._data) return;
          const { center: i, radius: n, lineWidth: r, color: s, fillBackground: o, backColor: a } = this._data;
          e.save();
          ...
          o &&
            g > 0 &&
            ((e.fillStyle = a), e.beginPath(), e.moveTo(c + g, u), e.arc(c, u, g, 0, 2 * Math.PI, !1), e.fill());
        ...
        hitTest(e, t) {
          ...
          const s =
            n > r && (0, l.pointInCircle)(e, i, n - r) ? a.HitTarget.MovePointBackground : a.HitTarget.MovePoint;
      ...
      class c extends o.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          this._circleRenderer.setData({
            ...
            this.addAnchors(this._renderer, { hittestResult: [a.HitTarget.MovePoint, a.HitTarget.ChangePoint] });
        }
        _updateTextRenderer() {
        ...
        _updateImpl() {
          ...
          this._horizLineRenderer.setData(t),
            this._horizLineRenderer.setHitTest(
              new a.HitTestResult(a.HitTarget.MovePoint, { snappingPrice: this._source.points()[0].price }),
            ),
            this._vertLineRenderer.setData(t),
            this._vertLineRenderer.setHitTest(
              new a.HitTestResult(a.HitTarget.MovePoint, { snappingIndex: this._source.points()[0].index }),
            );
      ...
      class b extends x.DateAndPriceRangeBasePaneView {
        ...
        _updateImpl(e, t) {
          ...
          V &&
            ...
            ((this._pipFormatter = new g.PipFormatter(V.pricescale, V.minmov, V.type, V.minmove2, V.typespecs)),
            (this._lastSymbolInfo = V));
          const W = (0, n.ensureNotNull)(this._source.ownerSource()).formatter(),
            F =
              (null !== (s = null === (i = W.formatChange) || void 0 === i ? void 0 : i.call(W, I, M)) && void 0 !== s
                ? s
                : W.format(A)) +
              ' (' +
    ...
    11756: (e, t, i) => {
      ...
      class f extends _.MediaCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          (v = (0, c.transformPoint)(x, v)),
            ...
            s.stroke(),
            this._data.fillBackground &&
              ((s.fillStyle = (0, u.generateColor)(this._data.backcolor, this._data.transparency)), s.fill());
        }
      }
      class v extends h.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          s.append(this.createLineAnchor({ points: [v, x, m, w], pointsCursorType: y }, 0)), (this._renderer = s);
        }
        _updateTextRenderer(e, t, i, n) {
          if (t.subtract(e).length() < 1e-5 || n.subtract(i).length() < 1e-5) return !1;
          const a = (0, s.intersectLines)((0, r.lineThroughPoints)(e, t), (0, r.lineThroughPoints)(i, n));
          if (!a) return !1;
      ...
      class u extends d.LineToolPaneViewFibWithLabels {
        ...
        _updateImpl(e, t) {
          ...
          for (let i = 1; i < f; i++) {
            ...
            let P;
            null !== b &&
              (u.append(b), (P = null !== (r = (0, h.getTextBoundaries)(b, t, e)) && void 0 !== r ? r : void 0));
            const L = {
                points: [x, m, R, y],
                color: s.color.value(),
                linewidth: p.levelsStyle.childs().linewidth.value(),
          ...
          if (null !== x) {
            ...
            if (i.visible.value()) {
              ...
              let m;
              null !== f &&
                (u.append(f), (m = null !== (a = (0, h.getTextBoundaries)(f, t, e)) && void 0 !== a ? a : void 0));
              const w = {
                points: [r, o],
                color: i.color.value(),
                linewidth: p.levelsStyle.childs().linewidth.value(),
          ...
          for (let e = 0; e < g.length; e++) {
            ...
            }
            {
              const i = {
                ...
                n = new c.TrendLineRenderer();
              n.setData(i),
                n.setHitTest(new o.HitTestResult(o.HitTarget.MovePoint, void 0, { type: 'h', index: g[e].index })),
                R.append(n);
            }
          }
          for (let e = 0; e < x.length; e++) {
            ...
            }
            {
              const i = {
                ...
                n = new c.TrendLineRenderer();
              n.setData(i),
                n.setHitTest(new o.HitTestResult(o.HitTarget.MovePoint, void 0, { type: 'v', index: x[e].index })),
                R.append(n);
            }
          }
        ...
        _updateImpl(e, t) {
          ...
          2 === this._source.points().length
            ...
            : this._points.length > 0 &&
              this._renderer.append(
                this.createLineAnchor(
                  { points: [new n.Point(this._points[0].x, e / 2)], hittestResult: l.HitTarget.MovePoint },
                  0,
                ),
              );
        }
      ...
      t.FibWedgePaneView = class extends n {
        ...
        _updateRenderer() {
          if (!((x = this._points).length < 2)) {
            ...
            if ((this._baseTrendRenderer.setData(r), e.append(this._baseTrendRenderer), x.length < 3))
    ...
    13227: (e, t, i) => {
      ...
      class h extends d.MediaCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          if (null === this._data) return;
          const t = e.context;
          t.translate(Math.round(this._data.point.x) - 0.5, Math.round(this._data.point.y - 22) - 0.5),
            (t.fillStyle = '#434651'),
        ...
        _updateImpl() {
          ...
          for (let e = 0; e < h.length; e++) {
              ...
              }
            {
              ...
              s.setData(n), s.setHitTest(new r.HitTestResult(r.HitTarget.MovePoint, void 0, h[e].index)), g.append(s);
            }
      ...
      class h extends r.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          const l = s[0],
            ...
            p = d,
            _ = this._getModel(),
            g = { barsCoordsRange: h, priceCoordsRange: c, startPoint: u, endPoint: p, p1: l, p2: d };
      ...
      class g extends u.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          if (this._points.length >= 2) {
            ...
            r.y < i.y ? ((e.vertAlign = 'bottom'), (e.offsetY = 5)) : ((e.vertAlign = 'top'), (e.offsetY = 5)),
              this._leftShoulderLabelRenderer.setData(e),
              f.append(this._leftShoulderLabelRenderer);
          }
          if (this._points.length >= 4) {
            const e = v(a, _.head);
            a.y < o.y ? ((e.vertAlign = 'bottom'), (e.offsetY = 5)) : ((e.vertAlign = 'top'), (e.offsetY = 5)),
              this._headLabelRenderer.setData(e),
              f.append(this._headLabelRenderer);
          }
          if (this._points.length >= 6) {
            const e = v(c, _.rightShoulder);
            c.y < l.y ? ((e.vertAlign = 'bottom'), (e.offsetY = 5)) : ((e.vertAlign = 'top'), (e.offsetY = 5)),
        ...
        _updateImpl(e, t) {
          ...
          if (s.showLabel.value() && 1 === this._points.length && s.text.value().length > 0) {
            ...
            this._labelRenderer.setData(_),
              ...
              this._needLabelExclusionPath(this._labelRenderer) &&
                (h = null !== (i = (0, o.getTextBoundaries)(this._labelRenderer, t, e)) && void 0 !== i ? i : void 0),
          ...
          this._lineRenderer.setData(p),
            this._lineRenderer.setHitTest(
              new r.HitTestResult(r.HitTarget.MovePoint, { snappingPrice: this._source.points()[0].price }),
            );
          ...
          if (((u = u && (p.y < -_ || p.y > e + _)), a.append(this._lineRenderer), !u)) {
            if (1 === this._points.length) {
              ...
              (e.data = 0), (e.square = !0), a.append(this.createLineAnchor({ points: [e], pointsCursorType: c }, 0));
            }
            if (1 === this._points.length) {
      ...
      class _ extends u.BitmapCoordinatesPaneRenderer {
        ...
        hitTest(e) {
          ...
          return Math.abs(e.y - this._data.points[0].y) <= t
            ? new a.HitTestResult(this._data.hitTestResult, { snappingPrice: this._data.snappingPrice })
            : null;
        }
        _drawImpl(e) {
          if (null === this._data || 0 === this._data.points.length) return;
          ...
          (t.lineCap =
            void 0 === this._data.linestyle || this._data.linestyle === p.LINESTYLE_SOLID ? 'round' : 'butt'),
            (t.strokeStyle = this._data.color),
        ...
        _updateImpl(e, t) {
          ...
          if (l.showLabel.value() && 1 === this._points.length) {
            ...
            if ('right' === a) {
              ...
              c.x + e + 3 >= t ? (c = c.add((0, n.point)(e + 3, 0))) : ((c = (0, n.point)(t, c.y)), (p = 3));
            } else 'center' === a && (c = (0, n.point)((c.x + this._model.timeScale().width()) / 2, c.y));
            const m = {
              points: [c],
              text: _,
            ...
            this._labelRenderer.setData(m),
              ...
              this._needLabelExclusionPath(this._labelRenderer) &&
                (h = null !== (i = (0, s.getTextBoundaries)(this._labelRenderer, t, e)) && void 0 !== i ? i : void 0);
          }
          const u = {
            points: this._points,
            color: l.linecolor.value(),
        ...
        addAnchors(e, t) {
          ...
          const n = i.map((e, t) => {
            const i = this._source.points()[t],
              n = e;
            return (
              (n.snappingPrice = null == i ? void 0 : i.price), (n.snappingIndex = null == i ? void 0 : i.index), n
            );
          });
    ...
    134: (e, t, i) => {
      ...
      class d extends r.LineSourcePaneView {
        ...
        _updateLabelForLevel({
          ...
          if (w) {
            C +=
              null !== (f = null === (g = m.coeffsAsPercents) || void 0 === g ? void 0 : g.value()) && void 0 !== f && f
    ...
    34658: (e, t, i) => {
      ...
      class v {
        ...
        _createSource(e, t, i) {
          (this._sourceCanvas = (0, u.createDisconnectedCanvas)(
            ...
            this._translate.x % 1 == 0 && (this._translate = new g.Point(this._translate.x + 0.5, this._translate.y));
      ...
      class x {
        ...
        draw(e, t) {
          var i;
          if (null === this._data) return;
          (null !== this._source && (0, p.areEqualPaneRenderParams)(this._source.renderParams(), t)) ||
        ...
        _drawTooltipOn(e, t) {
          ...
          f < 10 ? (f = a.y + 13) : (x = 'bottom'),
            g < 10 ? (g += Math.abs(g - 10)) : g + p + 10 > i.vpWidth && (g -= g + p + 10 - i.vpWidth),
          ...
          e.moveTo(w, R),
            ...
            e.lineTo(w + p, R),
            e.lineTo(w + p, R + _),
            v || 'bottom' !== x || (e.lineTo(m + y, R + _), e.lineTo(m, R + _ + y), e.lineTo(m - y, R + _)),
            e.lineTo(w, R + _),
            e.closePath(),
            e.fill(),
            e.stroke(),
          ...
          (0, u.drawScaled)(e, t.pixelRatio, t.pixelRatio, () => {
            for (let t = 0; t < o.length; t++) e.fillText(o[t].replace(/^\s+/, ''), b, P), (P += i.fontSize + l);
          }),
            e.restore();
        }
      }
      ...
      class f extends d.MediaCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          0 !== n &&
            ...
            (h = !0)),
            0 !== r && (this._drawQuantity(t, o + n, d, h), this._drawQuantityText(t, o + n, d), (h = !0)),
        ...
        _drawCancelButton(e, t, i, r) {
          ...
          e.fillRect(t + 0.5, i + 0.5, s - 1, o - 1),
            this._adapter.getBlocked() &&
              ((e.fillStyle = 'rgba(140, 140, 140, 0.75)'), e.fillRect(t + 0.5, i + 0.5, s - 1, o - 1)),
            e.save(),
    ...
    26013: (e, t, i) => {
      ...
      class d extends a.AlertableLineSourcePaneView {
        constructor() {
          super(...arguments), (this._channelRenderer = new o.ParallelChannelRenderer()), (this._renderer = null);
        }
        renderer(e, t) {
          return this._invalidated && this._updateImpl(), this._renderer;
        }
          ...
          for (let t = 0; t <= 8; t++) {
            ...
            if (s.childs().visible.value()) {
              ...
              h = s.childs().coeff.value();
              {
                ...
                l.setData(r), l.setHitTest(new n.HitTestResult(n.HitTarget.MovePoint, void 0, t)), e.append(l);
              }
              {
                const i = {
                ...
                r.setData(i), r.setHitTest(new n.HitTestResult(n.HitTarget.MovePoint, void 0, t)), e.append(r);
              }
            }
          }
          this.addAnchors(e), (this._renderer = e);
        ...
        _updateRenderer() {
          ...
          for (let t = 0; t <= 8; t++) {
            ...
            if (o.childs().visible.value()) {
              ...
              x.setData(v), x.setHitTest(new r.HitTestResult(r.HitTarget.MovePoint, void 0, t)), i.append(x);
              const m = {
                  points: [g, f],
                  color: o.childs().color.value(),
                  linewidth: o.childs().linewidth.value(),
              ...
              w.setData(m), w.setHitTest(new r.HitTestResult(r.HitTarget.MovePoint, void 0, t)), i.append(w);
            }
          }
            ...
            for (let c = 0; c <= 8; c++) {
              ...
              if (p.childs().visible.value()) {
                ...
                const v = {
                  ...
                  x = new l.TrendLineRenderer();
                x.setData(v), x.setHitTest(new r.HitTestResult(r.HitTarget.MovePoint, void 0, c)), t.append(x);
                const m = {
                    points: [g, f],
                    color: p.childs().color.value(),
                    linewidth: p.childs().linewidth.value(),
                  ...
                  w = new l.TrendLineRenderer();
                w.setData(m), w.setHitTest(new r.HitTestResult(r.HitTarget.MovePoint, void 0, c)), t.append(w);
              }
            }
          }
          this.addAnchors(t), (this._renderer = t);
            ...
            for (let i = 0; i <= 8; i++) {
              ...
              if (p.visible.value()) {
                ...
                const v = {
                  ...
                  x = new l.TrendLineRenderer();
                x.setData(v), x.setHitTest(new r.HitTestResult(r.HitTarget.MovePoint, void 0, i)), e.append(x);
                const m = {
                    points: [g, f],
                    color: p.color.value(),
                    linewidth: p.linewidth.value(),
                  ...
                  w = new l.TrendLineRenderer();
                w.setData(m), w.setHitTest(new r.HitTestResult(r.HitTarget.MovePoint, void 0, i)), e.append(w);
              }
            }
          }
          this.addAnchors(e), (this._renderer = e);
    ...
    46258: (e, t, i) => {
      ...
      class f extends h {
        ...
        _height() {
          return Math.max(
            20,
            1 + Math.max(r.fontHeight(this._adapter.getBodyFont()), r.fontHeight(this._adapter.getQuantityFont())),
          );
        }
        _bodyWidth(e) {
          if (0 === this._adapter.getText().length) return 0;
        ...
        _drawImpl(e) {
          ...
          (this._cache.bodyRight = a + n),
            ...
            0 !== r &&
              (this._drawQuantity(t, this._cache.bodyRight, h), this._drawQuantityText(t, this._cache.bodyRight, h)),
            0 !== s && this._drawReverseButton(t, this._cache.quantityRight, h),
            0 !== this._closeButtonWidth() && this._drawCloseButton(t, this._cache.reverseButtonRight, h);
        }
        hitTest(e) {
      ...
      t.PositionPaneView = class extends n {
        constructor(e, t) {
          super(e, t), (this._rendererCache = {}), (this._renderer = new f(this._rendererCache, e._adapter));
        }
        renderer(e, t) {
          return (
            this._invalidated && this._updateImpl(),
      ...
      class C extends T {
        ...
        drawTargetLabel(e) {
          ...
          (e.fillStyle = v.generateColor(this._data.targetBackColor, this._data.transparency)),
            e.fill(),
            (e.lineWidth = 2),
            (e.strokeStyle = v.generateColor(this._data.targetStrokeColor, this._data.transparency)),
            e.stroke();
          e.beginPath(),
            ...
            (e.fillStyle = B),
              'up' === this._data.direction
                ? (R(e, b.x - 1, b.y - H - 2, this._targetWidth + 2, H, 5),
                  ...
                  E && e.drawImage(E, b.x + V - E.width - 4, b.y - H - 2 + Math.abs(H - E.height) / 2))
                : (R(e, b.x - 1, b.y + this._targetHeight + 2, this._targetWidth + 2, H, 5),
                  e.fill(),
                  (e.fillStyle = z),
                  e.fillText(D, b.x + V + W, b.y + this._targetHeight + 5),
                  E &&
                    e.drawImage(E, b.x + V - E.width - 4, b.y + this._targetHeight + 10 - Math.abs(H - E.height) / 2)),
              e.restore();
          } else e.restore();
        }
        drawStartLabel(e) {
          ...
          (e.fillStyle = v.generateColor(this._data.sourceBackColor, this._data.transparency)),
            e.fill(),
            (e.lineWidth = 2),
            (e.strokeStyle = v.generateColor(this._data.sourceStrokeColor, this._data.transparency)),
            e.stroke(),
        ...
        _updateImpl() {
          if (
            ...
            if (d && a) {
              ...
              this._targetLine2 = i(44352).t(null, { context: 'dates' }, i(91481)) + ' ' + L(new f().format(m));
            }
      ...
      class v extends g {
        ...
        _drawImpl(e) {
          if (null !== this._data && null !== this._points && 0 !== this._points.length) {
            ...
            var d = p(t, i.width);
            this._measureCache &&
              Object.assign(this._measureCache, { innerWidth: s, innerHeight: o, tailLeft: -9, tailHeight: 15 }),
      ...
      class x {
        constructor() {
          (this._data = null),
            (this._priceLabelRenderer = new a.TextRenderer(
              void 0,
              new _.HitTestResult(_.HitTarget.MovePoint, { areaName: _.AreaName.Style, activeItem: 1 }),
            )),
            (this._hittest = new _.HitTestResult(_.HitTarget.MovePoint, { areaName: _.AreaName.Style }));
        }
        setData(e) {
          this._data = e;
          const t = e.points[0],
        ...
        draw(e, t) {
          ...
          (0, g.createCircle)(e, r, s, l),
            e.fill(),
            void 0 !== i.excludeBoundaries && (e.save(), (0, c.addExclusionArea)(e, t, i.excludeBoundaries)),
      ...
      class m extends l.LineSourcePaneView {
        ...
        _updateImpl(e, t) {
          ...
          if (h.showLabel && h.showLabel.value()) {
            ...
            let g;
            g = 'left' === p ? o.clone() : 'right' === p ? d.clone() : new r.Point((n.x + s.x) / 2, (n.y + s.y) / 2);
            ...
            this._customLabelRenderer.setData(v),
              ...
              'middle' === c &&
                (_.excludeBoundaries =
                  null !== (i = (0, a.getTextBoundaries)(this._customLabelRenderer, t, e)) && void 0 !== i
                    ? i
                    : void 0);
          }
      ...
      class v extends g.DateAndPriceRangeBasePaneView {
        ...
        _updateImpl(e, t) {
          ...
          k &&
            ...
            ((this._pipFormatter = new p.PipFormatter(k.pricescale, k.minmov, k.type, k.minmove2, k.typespecs)),
            (this._lastSymbolInfo = k));
          const N = (0, n.ensureNotNull)(this._source.ownerSource()).formatter(),
            D =
              null !== (a = null === (i = N.formatChange) || void 0 === i ? void 0 : i.call(N, M, C)) && void 0 !== a
                ? a
                : N.format(I),
            B = (0, s.forceLTRStr)(
    ...
    31320: (e, t, i) => {
      ...
      class h extends l.LineSourcePaneView {
        ...
        _addAnchors(e, t, i) {
          ...
          i.append(this.createLineAnchor({ points: [e, t, r, s, o, a, l, h], pointsCursorType: _ }, 0));
        }
      }
    },
    5374: (e, t, i) => {
    ...
    56457: (e, t, i) => {
      ...
      class A extends o.LineSourcePaneView {
        ...
        _updateImpl(e, t) {
          ...
          if (
            ...
            f !== this._lastSymbolInfo &&
              ((this._pipFormatter = new _.PipFormatter(f.pricescale, f.minmov, f.type, f.minmove2, f.typespecs)),
              (this._lastSymbolInfo = f)),
            (N = [this._profitLabelRenderer, this._stopLabelRenderer, this._middleLabelRenderer].reduce(
        ...
        _createStopLabel(e, t) {
          ...
          const v = u.formatter(),
            m =
              null !==
                (s =
                  null === (i = v.formatChange) || void 0 === i ? void 0 : i.call(v, Math.max(o, a), Math.min(o, a))) &&
              void 0 !== s
                ? s
                : v.format(p),
        ...
        _createTargetLabel(e, t) {
          var i, s;
          const { profitPrice: o, entryPrice: a, stopPrice: l, left: d, edge: h, profitLevel: c } = e,
            u = this._source.properties().childs(),
          ...
          const m = p.formatter(),
            w =
              null !==
                (s =
                  null === (i = m.formatChange) || void 0 === i ? void 0 : i.call(m, Math.max(o, a), Math.min(o, a))) &&
              void 0 !== s
                ? s
                : m.format(_),
      ...
      t.RotatedRectanglePaneView = class extends s {
        ...
        _updateImpl() {
          if (
            ...
            l.append(this.createLineAnchor({ points: R, pointsCursorType: y }, 0)), (this._renderer = l);
          }
        }
        renderer(e, t) {
          return this._invalidated && this._updateImpl(), this._renderer;
        ...
        hitTest(e, t) {
          ...
          const [i, r, s] = (function (e, t) {
            ...
            if (!o && void 0 !== s) {
              ...
              a = s.circleRadius > 0 && (0, u.pointInCircle)(t, new n.Point(r, o), s.circleRadius + i);
            }
            ...
            void 0 !== this._data.plate &&
              (function (e, t, i, n, r) {
                const s = r.pixelRatio,
                  { circleRadius: o, poleTailHeight: a, circleBorderColor: l, circleBackgroundColor: d } = i;
                ...
                const h = (0, f.fillScaledRadius)(o, s),
                  ...
                  u = t.inverseAnchorPosition
                    ...
                    : Math.round(t.anchorY * s) + Math.round((t.labelHeight + a + o) * s) * t.direction,
                ...
                if (
                  ...
                  t.svgRenderer.render(e, { targetViewBox: { x: _ - i / 2, y: g - i / 2, width: i, height: i } });
                }
      ...
      class L extends l.LineSourcePaneView {
        ...
        _updateImpl(e, t) {
          ...
          (s.data = r.data),
            (s.square = !0),
            this._renderer.append(
              this.createLineAnchor({ points: [s], pointsCursorType: [o.PaneCursorType.VerticalResize] }, 0),
            );
        }
        _itemAnchorY() {
    ...
    50761: (e, t, i) => {
      ...
      class _ extends c.MediaCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          if (null === this._data) return;
          const { size: t, svg: i, point: n, angle: r, color: s, background: o, selected: a } = this._data,
            l = e.context;
          l.translate(n.x, n.y);
          const d = r - Math.PI / 2;
          l.rotate(d);
          ...
          a &&
            ...
            i &&
              ...
              i.render(l, { targetViewBox: { x: 0, y: 0, width: t, height: t }, doNotApplyColors: null !== s }));
        }
      }
      class g extends d.LineSourcePaneView {
        constructor(e, t, i) {
          super(e, t), (this._iconRenderer = new _()), (this._renderer = new a.CompositeRenderer()), (this._svg = i);
        }
        renderer(e, t) {
          return this._invalidated && this._updateImpl(e, t), this._renderer;
        }
        _updateImpl(e, t) {
          ...
          this._renderer.append(this.createLineAnchor({ points: [_, g, f, v], pointsCursorType: m }, 0));
        }
      ...
      class _ extends u.LineSourcePaneView {
        ...
        _updateImpl(e, t) {
          ...
          if (
            ...
            a.fillBackground && a.fillBackground.value() && (_.backgroundColor = a.backgroundColor.value()),
            ...
            i.isPriceDencityLog() &&
              ...
              !i.isPriceDencityLog() &&
                o.isLog() &&
                (t = o.height() / ((0, h.fromLog)(e.maxValue(), r) - (0, h.fromLog)(e.minValue(), r)));
          ...
          if (g && !this._noSelection) {
            ...
            if (_.wordWrapWidth) {
              ...
              (i.data = 1), e.append(this.createLineAnchor({ points: [i], pointsCursorType: p }, 1));
            }
      ...
      class u extends h.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          if ((this._polyLineRenderer.setData(h), s.append(this._polyLineRenderer), !isNaN(e))) {
            ...
            const i = o(this._points[1].add(this._points[3]).scaled(0.5), this._numericFormatter.format(e));
          ...
          if (!isNaN(t)) {
            ...
            const i = o(this._points[5].add(this._points[3]).scaled(0.5), this._numericFormatter.format(t));
      ...
      class h extends d.MediaCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          (t.strokeStyle = this._data.color),
            ...
            t.stroke(),
            this._data.fillBackground &&
              ((t.fillStyle = (0, o.generateColor)(this._data.backcolor, this._data.transparency)), t.fill());
        }
      }
    ...
    67998: (e, t, i) => {
      ...
      class m extends x.TrendToolWithStatsPaneView {
        ...
        _updateImpl(e, t) {
          ...
          const b = (this.isHoveredSource() || this.isSelectedSource()) && m.showMiddlePoint.value();
          this._middlePoint &&
            this._renderer.append(
          ...
          for (let i = 0; i < this._levels.length; i++) {
            ...
            null !== u &&
              ...
              'middle' === p.vertLabelsAlign.value() &&
                (c = null !== (a = (0, h.getTextBoundaries)(u, e, t)) && void 0 !== a ? a : void 0));
            const _ = {
              points: [r, d],
              color: this._levels[i].color,
              linewidth: this._levels[i].linewidth,
    ...
    96310: (e, t, i) => {
      ...
      class g extends _.TrendToolWithStatsPaneView {
        ...
        _updateImpl(e, t) {
          ...
          if (f.index < _.firstBar() && v.index < _.firstBar() && !x.extendLeft.value() && !x.extendRight.value())
            return;
          ...
          if (x.showLabel && x.showLabel.value() && x.text.value().length > 0) {
            ...
            let d;
            d = 'left' === a ? n.clone() : 'right' === a ? s.clone() : new r.Point((m.x + w.x) / 2, (m.y + w.y) / 2);
            ...
            this._labelRenderer.setData(c),
              this._renderer.append(this._labelRenderer),
              this._needLabelExclusionPath(this._labelRenderer) &&
                (R = null !== (i = (0, l.getTextBoundaries)(this._labelRenderer, t, e)) && void 0 !== i ? i : void 0);
          }
          ...
          if (
            (((this.isHoveredSource() || this.isSelectedSource()) && this.isEditMode()) || x.alwaysShowStats.value()) &&
            !P &&
            2 === this._points.length
          ) {
          ...
          const L = (this.isHoveredSource() || this.isSelectedSource()) && x.showMiddlePoint.value();
          this._middlePoint &&
            this._renderer.append(
              new h.SelectionRenderer({
                points: [this._middlePoint],
    ...
    48063: (e, t, i) => {
      ...
      class C {
        constructor(e, t, i) {
          (this._fontSize = 0),
            ...
            (this._lineSpacing =
              (0, w.isNumber)(this._data.lineSpacing) && this._data.lineSpacing ? this._data.lineSpacing : 0),
            (e.lines = this._lines = null === e.text ? [] : (0, v.wordWrap)(e.text, this.fontStyle(), e.wordWrapWidth)),
        ...
        hitTest(e) {
          return 0 === this._data.points.length
            ? null
            : (this._preRender(), this._boundingBox && (0, g.pointInBox)(e, this._boundingBox) ? this._hittest : null);
        }
        _preRender() {
          if (this._preRendered) return;
          const e = (function () {
              if (null !== b) return b;
              const e = (0, R.createDisconnectedCanvas)(document, (0, _.size)({ width: 0, height: 0 }));
          ...
          u.w % 2 != 0 && u.w++,
            (u.x += 0.5),
            (u.y += 0.5),
            (this._boundingBox = (0, r.box)(new r.Point(u.x, u.y), new r.Point(u.x + u.w, u.y + u.h))),
            (this._rect = u),
            (this._padding = c),
      ...
      class V extends A.AlertableLineSourcePaneView {
        ...
        getCacheRects(e, t) {
          ...
          return {
            cacheRect: d,
            targetRect: { left: Math.floor(c), top: Math.floor(u), width: d.width, height: d.height },
          };
        }
        renderer(e, t) {
          return this._invalidated && this._updateImpl(e, t), this._renderer;
        ...
        _createCacheIfRequired(e) {
          return (
            (null !== this._cache &&
              ...
              (this._cache = new H(e)),
              (this._statCache = this._cache.updateSource(this._source, () => this._statLabelData())),
        ...
        _priceRange() {
          ...
          if (this._source.priceScale() && (o || a || l)) {
            ...
            if (o || a) {
              ...
              if (o) {
                const n = d.formatter(),
                  o =
                    null !==
                      (t = null === (e = n.formatChange) || void 0 === e ? void 0 : e.call(n, r.price, i.price)) &&
                    void 0 !== t
                      ? t
                      : n.format(s);
                h.push(o);
            ...
            c &&
              ...
              ((this._pipFormatter = new u.PipFormatter(c.pricescale, c.minmov, c.type, c.minmove2, c.typespecs)),
        ...
        _statLabelData() {
          ...
          if (g || f || v) {
            if (
              ...
              g &&
                ((h = t.index - e.index),
                (l += o.t(null, void 0, i(33355)).format({ count: (0, a.forceLTRStr)(String(h)) }))),
              f)
            ) {
            ...
            v &&
              ...
              (l += o
                ...
                .format({ number: (0, a.forceLTRStr)(this._numericFormatter.format(Math.round(Number(p)))) }))),
              l && s.push('barsRange');
          }
          if (x) {
            let e;
            void 0 !== p && p > 0 && void 0 !== u && ((u = u.normalized()), (e = Math.acos(u.x)), u.y > 0 && (e = -e)),
              'number' != typeof e || isNaN(e) || ((d = Math.round((180 * e) / Math.PI) + 'º'), s.push('angle'));
          }
        ...
        _updateImpl() {
          ...
          if (
            ...
            4 === this._points.length &&
              (this._trendLineRendererPoints23.setData(f(i, a)), _.append(this._trendLineRendererPoints23), l))
          ) {
            const e = {
      ...
      class u extends h.AlertableLineSourcePaneView {
        ...
        _updateImpl(e, t) {
          ...
          if (
            ...
            this._lineRenderer.setData(p),
            this._lineRenderer.setHitTest(
              new d.HitTestResult(d.HitTarget.MovePoint, { snappingIndex: this._source.points()[0].index }),
            ),
      ...
      class o extends s.MediaCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          if (
            ...
            (t.lineWidth = this._data.linewidth),
            t.beginPath(),
            t.arc(this._data.center.x, this._data.center.y, this._data.radius, this._data.edge1, this._data.edge2, !0),
            t.stroke(),
            this._data.fillBackground)
          ) {
            if (
    ...
    2436: (e, t, i) => {
      'use strict';
      i.d(t, { cubicBezierHitTest: () => s, extendQuadroBezier: () => o, quadroBezierHitTest: () => r });
      var n = i(4652);
    ...
    14146: (e, t, i) => {
      ...
      class u extends c.MediaCoordinatesPaneRenderer {
        ...
        _visiblePolygon(e) {
          ...
          if (
            (0, s.equalPoints)(i, n) ||
            (0, s.equalPoints)(o, l) ||
            ((0, a.distanceToLine)(i, n, o).distance < 1e-6 && (0, a.distanceToLine)(i, n, l).distance < 1e-6)
          )
            return null;
      ...
      function p(e, t, i, n) {
        ...
        return null !== e && null !== r
          ? (0, l.intersectPolygonAndHalfplane)(e, (0, s.halfplaneThroughPoint)((0, s.lineThroughPoints)(t, i), r))
          : null;
      }
    },
    23966: (e, t, i) => {
      ...
      class _ {
        ...
        setData(e) {
          ...
          if (
            (0, s.equalPoints)(t, i) ||
            (0, s.equalPoints)(n, r) ||
            ((0, a.distanceToLine)(t, i, n).distance < 1e-6 && (0, a.distanceToLine)(t, i, r).distance < 1e-6)
          )
            this._selectedRenderer = null;
          else {
            null !== (0, l.intersectLines)((0, s.lineThroughPoints)(t, i), (0, s.lineThroughPoints)(n, r))
      ...
      class g extends p.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e, t) {
          if (null === this._data || !this._data.hittestOnBackground) return null;
          for (const i of this._visiblePolygons((0, n.size)({ width: t.cssWidth, height: t.cssHeight })))
            if ((0, o.pointInPolygon)(e, i)) return new h.HitTestResult(h.HitTarget.MovePointBackground);
          return null;
        }
        _drawImpl(e) {
        ...
        _visiblePolygons(e) {
          ...
          const d = (0, l.intersectLines)((0, s.lineThroughPoints)(i, n), (0, s.lineThroughPoints)(o, a));
          if (null === d) return [];
          const h = [
              new s.Point(0, 0),
              new s.Point(e.width, 0),
            ...
            c = [];
          {
            ...
            (e = f(e, d, r, [s, s])), (e = x(e, t)), (e = f(e, s, d, [r, r])), null !== e && c.push(e);
          }
          {
            let e = h;
        ...
        _drawImpl(e) {
          ...
          t.save(),
            ...
            this._data.fillBackground &&
              ...
              (t.fillStyle = (0, o.generateColor)(this._data.backcolor, this._data.transparency, !0)),
              t.fill());
        }
      }
    },
          ...
          for (let a = 0; a < n.length; ++a) {
            ...
            if (h.subtract(e).length() <= i + o)
              return new l.HitTestResult(Array.isArray(s) ? s[a] : s, {
                pointIndex: h.data,
                cursorType: null !== (t = null == r ? void 0 : r[a]) && void 0 !== t ? t : d.PaneCursorType.Default,
        ...
        _drawPoints(e, t, i, n, r) {
          ...
          for (let e = 0; e < t.length; ++e) {
            ...
            if (!((0, a.isInteger)(s.data) && c.linePointBeingEdited === s.data)) {
              if (
                (n(o, new u(Math.round(s.x * l) + x, Math.round(s.y * d) + x, s.data, s.square), v / 2, g),
                ...
                if (s.subtract(p).length() <= _ + m) {
                  ...
                  t % 2 != f % 2 && (t += 1);
                  r(o, new u(Math.round(s.x * l) + x, Math.round(s.y * d) + x, s.data, s.square), t / 2, e);
                }
              }
            }
          }
    ...
    28621: (e, t, i) => {
      ...
      class p extends c.MediaCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          if (this._data.points.some((e) => !isFinite(e.y))) this._extendAndDrawLineSegment(t, i, n, e.mediaSize);
          else if (
            ...
            if (
              (this._data.skipLines || this._data.skipTopLine || this._extendAndDrawLineSegment(t, r, s, e.mediaSize),
      ...
      function _(e, t, i, n) {
        return null !== e
          ? (0, a.intersectPolygonAndHalfplane)(e, (0, s.halfplaneThroughPoint)((0, s.lineThroughPoints)(t, i), n))
          : null;
      }
    },
    79797: (e, t, i) => {
      ...
      class p extends d.MediaCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          if (
            (this._data.filled &&
              this._data.fillBackground &&
              ((n.fillStyle = (0, l.generateColor)(this._data.backcolor, this._data.transparency)), n.fill()),
            ...
            if (this._data.rightend === o.LineEnd.Arrow) {
              const e = this._correctArrowPoints(this._points[r - 2], this._points[r - 1], n.lineWidth, d);
              (0, s.drawArrow)(e[0], e[1], n, n.lineWidth, 1);
            }
          }
        ...
        _drawPoint(e, t, i, n) {
          0 !== i &&
            (e.beginPath(), (e.fillStyle = n), e.arc(t.x, t.y, i, 0, 2 * Math.PI, !0), e.fill(), e.closePath());
        }
    ...
    10695: (e, t, i) => {
      ...
      class c extends s.MediaCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          const i = e.context,
            n =
              (null !== (t = this._data.linestyle) && void 0 !== t ? t : h.LINESTYLE_SOLID) === h.LINESTYLE_SOLID
                ? 'round'
                : 'butt';
          (i.lineCap = n),
            (i.lineJoin = 'round'),
          ...
          i.beginPath(),
            ...
            i.lineTo(r.x, r.y),
            this._data.fillBackground &&
              ((i.fillStyle = (0, a.generateColor)(this._data.backcolor, this._data.transparency)), i.fill()),
            i.stroke();
        }
      }
    },
