...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [2616],
  {
    50765: (t, e, i) => {
      ...
      function a(t) {
        var e;
        const i = null === (e = t.getAttribute('transform')) || void 0 === e ? void 0 : e.toLowerCase();
        ...
        do {
          if (((r = l.exec(i)), null !== r)) {
            ...
            switch (t) {
              case 'matrix':
                const i = o(e, 6);
                null !== i && s.push({ type: t, a: i[0], b: i[1], c: i[2], d: i[3], e: i[4], f: i[5] });
                break;
              case 'rotate':
                const r = o(e, 1);
      ...
      class f {
        ...
        apply(t, e) {
          ...
          'none' !== u &&
            (e.doNotApplyColors || (void 0 !== l && (t.globalAlpha = l), (t.fillStyle = null != u ? u : 'black')),
            this._fill(t));
      ...
      class y extends f {
        constructor(t, e, i) {
          ...
          (this._path = null !== r ? new Path2D(r) : null),
            (this._fillRule = null !== (s = t.getAttribute('fill-rule')) && void 0 !== s ? s : void 0);
        }
        _fill(t) {
      ...
      function m(t) {
        ...
        if ('objectBoundingBox' === e) return void b.logWarn(`Unsupported linearGradient gradientUnits: ${e}`);
        const i = [],
          ...
          a.length > 0 &&
            (l = (function (t) {
              ...
              for (let t = 0; t < i.length; ++t) {
                const s = i[t],
                  r = s.getAttribute('id');
                r && ('linearGradient' === s.tagName ? (e[r] = m(s)) : w.logWarn(`Unsupported defs tag: ${s.tagName}`));
              }
              const s = new WeakMap();
              return {
                getStyle: (t, i) => {
