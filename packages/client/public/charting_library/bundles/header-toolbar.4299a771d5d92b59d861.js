  ...
  [3005],
  {
    ...
    54079: (e, t, s) => {
      ...
      const d = (0, n.forwardRef)(function (e, t) {
        const { onKeyDown: s, orientation: d, blurOnEscKeydown: h = !0, blurOnClick: m = !0, ...v } = e,
    ...
    46618: (e, t, s) => {
      ...
      function y(e) {
        ...
        return n.createElement(
          n.Fragment,
          null,
          !c && n.createElement('div', { className: S.separatorWrap }, n.createElement(g, { className: S.separator })),
          n.createElement(
            'div',
            {
              className: a(s, S.group, { [S.noMinimalWidth]: o, [S.noLeftDecoration]: r, [S.noRightDecoration]: i }),
              onClick: l,
            },
            t,
          ),
      ...
      function W(e) {
        return n.createElement('div', { className: a(F.fadeLeft, e.className, { [F.isVisible]: e.isVisible }) });
      }
      function N(e) {
        return n.createElement('div', { className: a(F.fadeRight, e.className, { [F.isVisible]: e.isVisible }) });
      }
      function T(e) {
      ...
      function B(e) {
        return n.createElement(
          ...
          n.createElement('div', { className: F.iconWrap }, n.createElement(b.Icon, { icon: L, className: F.icon })),
        );
      }
      const D = (function (e = T, t = A, s = W, r = N) {
        ...
        return (
          ((o = class extends n.PureComponent {
            constructor(e) {
              super(e),
                ...
                (this._handleResizeContent = ([e]) => {
                  ...
                  const { shouldDecreaseWidthContent: s, buttonsWidthIfDecreasedWidthContent: n } = this.props;
                  s && n ? this.setState({ widthContent: t.width + 2 * n }) : this.setState({ widthContent: t.width });
                }),
                (this._handleScroll = () => {
            ...
            isAtLeft() {
              return (
                !this._isOverflowed() || this.currentPosition() <= (0, i.ensureDefined)(this.props.hideButtonsFrom)
              );
            }
            isAtRight() {
              return (
            ...
            render() {
              const {
                ...
                y = d && h;
              return n.createElement(_.Measure, { onResize: u ? this._handleResizeWrap : null }, (d) =>
                n.createElement(
                  'div',
                  ...
                  n.createElement(
                    ...
                    n.createElement(
                      ...
                      n.createElement(_.Measure, { onResize: u ? this._handleResizeContent : null }, i),
                    ),
                    l &&
                      n.createElement(s, {
                        isVisible: S,
          ...
          return n.createElement(
            ...
            n.createElement(
              ...
              (c) =>
                n.createElement(
                  'div',
                  { className: X.content, ref: c, role: G.PLATFORM_ACCESSIBILITY_ENABLED ? 'none' : void 0 },
                      ...
                      n.createElement(
                        ...
                        !o &&
                          n.Children.toArray([
                            ...
                            e.DateRange && n.createElement(y, { key: 'range' }, n.createElement(e.DateRange, null)),
                            e.Intervals &&
                              n.createElement(
                                y,
                                { key: 'intervals' },
                            ...
                            e.AlertReferral &&
                              n.createElement(
                                y,
                                { key: 'alert-referral' },
                                n.createElement(e.AlertReferral, { className: X.button, displayMode: s }),
                              ),
                            e.ScalePercentage &&
                              n.createElement(y, { key: 'percentage' }, n.createElement(e.ScalePercentage, null)),
                            e.ScaleLogarithm &&
                              n.createElement(y, { key: 'logarithm' }, n.createElement(e.ScaleLogarithm, null)),
                            ...f,
                          ]),
                        (function (e) {
                          const t = e.findIndex(
                            (e) => n.isValidElement(e) && !!e.key && -1 !== e.key.toString().indexOf('view-only-badge'),
                          );
                          return (
                            [t]
                              .filter((e) => e >= 0)
                          ...
                          n.Children.toArray([
                            ...
                            !o &&
                              ...
                              n.createElement(
                                y,
                                { key: 'undo-redo' },
                                n.createElement(e.UndoRedo, { id: h ? void 0 : x.UndoRedo }),
                              ),
                            n.createElement(y, {
                              removeSeparator: !0,
                              key: 'gap-1',
                            ...
                            e.SaveLoadReferral &&
                              n.createElement(
                                ...
                                n.createElement(e.SaveLoadReferral, { isReadOnly: o, displayMode: s }),
                              ),
                            !1,
                                ...
                                n.createElement(
                                  ...
                                  !o &&
                                    ...
                                    n.createElement(
                                      ...
                                      n.createElement(e.Fullscreen, { id: h ? void 0 : x.Fullscreen }),
                                    ),
                                  !U &&
                                    e.Screenshot &&
                            ...
                            U &&
                              ...
                              n.createElement(
                                y,
                                { key: 'fullscreen', onClick: this._trackFullscreenButtonClick, removeSeparator: !0 },
                                n.createElement(e.Fullscreen, { id: h ? void 0 : x.Fullscreen }),
                              ),
                            U &&
                              e.Screenshot &&
                            ...
                            !o &&
                              ...
                              n.createElement(
                                y,
                                { key: 'publish', className: X.mobilePublish, removeSeparator: !0 },
                                n.createElement(e.Publish, { id: h ? void 0 : x.PublishMobile }),
                              ),
                            ...g,
                          ]),
                        ),
            ...
            e.Publish && !o && !h && n.createElement(e.Publish, { id: x.PublishDesktop, className: X.desktopPublish }),
          );
        }
      ...
      function fe(e) {
        return (0, de.isPineIdString)(e) ? { type: 'pine', pineId: e } : { type: 'java', studyId: e };
      }
      var ge = s(36274);
      const Se = {
      ...
      class Ve extends n.PureComponent {
        ...
        render() {
          const { resizerBridge: e, allowedModes: t, ...s } = this.props,
            { displayMode: r, isVisible: o, leftCustomElements: l, rightCustomElements: c } = this.state,
            u = {
        ...
        _negotiateResizer() {
          this.props.resizerBridge.negotiateHeight(
            this.state.isVisible ? ce.HEADER_TOOLBAR_HEIGHT_EXPANDED : ce.HEADER_TOOLBAR_HEIGHT_COLLAPSED,
          );
        }
        _setDisplayMode() {
        ...
        _addCustomHTMLButton(e, t = 'left') {
          const s = new Q.WatchedValue(0),
            ...
            r = { type: 'Button', id: e, params: { key: Number(new Date()), element: n, width: s } };
    ...
    5962: (e, t, s) => {
      'use strict';
      s.d(t, { RegistryProvider: () => l, registryContextType: () => c, validateRegistry: () => o });
      var n = s(50959),
        r = s(19036),
        i = s.n(r);
