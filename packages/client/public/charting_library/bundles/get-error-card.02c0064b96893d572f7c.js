(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [139],
  {
    ...
    81200: (e, t, r) => {
      'use strict';
      r.r(t), r.d(t, { ErrorCard: () => p, ErrorCardRenderer: () => y, ResizableErrorCard: () => m });
      var n = r(50959),
        o = r(962),
        u = r(43370),
        i = r(97754),
      ...
      const p = n.forwardRef((e, t) => {
        const { icon: r, message: o, size: u = 1, rawHtml: i = !1, doNotLimitWidth: c, solutionId: l } = e,
          f = n.useMemo(
            () =>
              r &&
              (function (e, t) {
        ...
        return n.createElement(
          'div',
          { ref: t, className: a()(d.errorCard, 2 === u && d.errorCard_size_big, !c && d.errorCard_limitWidth) },
          f && n.createElement(s.Icon, { icon: f, className: d.errorCard__icon }),
          i
            ? n.createElement('div', { className: d.errorCard__message, dangerouslySetInnerHTML: { __html: o } })
      ...
      function m(e) {
        ...
        return (
          ...
          n.createElement(p, { ref: f, message: r, icon: t, size: d, rawHtml: o, doNotLimitWidth: i, solutionId: l })
        );
        function m() {
          const e = f.current;
          if (!e) return;
            ...
            b(i)
              ...
              : null != i &&
                (k(i) &&
                  ...
                  })(i, o + (!i.key || (s && s.key === i.key) ? '' : ('' + i.key).replace(x, '$&/') + '/') + e)),
                t.push(i)),
            1
          );
        if (((s = 0), (u = '' === u ? '.' : u + ':'), b(e)))
          ...
          for (e = l.call(e), c = 0; !(a = e.next()).done; ) s += $((a = a.value), t, o, (l = u + H(a, c++)), i);
        else if ('object' === a)
          throw (
            ((t = String(e)),
            Error(
      ...
      (t.Children = {
        ...
        (t.cloneElement = function (e, t, n) {
          ...
          if (null != t) {
            ...
            for (c in t) w.call(t, c) && !E.hasOwnProperty(c) && (o[c] = void 0 === t[c] && void 0 !== s ? s[c] : t[c]);
          }
