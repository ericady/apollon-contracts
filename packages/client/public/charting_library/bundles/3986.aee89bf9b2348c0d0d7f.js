  ...
  [3986],
  {
    32766: (e, i, t) => {
      ...
      var n = t(44352),
        ...
        c = t(20345),
        d = t(94474);
      const u = new o.TranslatedString('change color bars based on previous close', n.t(null, void 0, t(29353))),
        ...
        x =
          ...
          new o.TranslatedString('change {candleType} body visibility', n.t(null, void 0, t(47202)))),
        ...
        z =
          ...
          new o.TranslatedString('change {chartType} projection bar up color', n.t(null, void 0, t(50453))),
          new o.TranslatedString('change {chartType} projection bar down color', n.t(null, void 0, t(18465))),
          new o.TranslatedString('change {chartType} border bar up color', n.t(null, void 0, t(11107))),
          new o.TranslatedString('change {chartType} border bar down color', n.t(null, void 0, t(79088))),
          new o.TranslatedString('change {chartType} projection border bar up color', n.t(null, void 0, t(61250))),
          new o.TranslatedString('change {chartType} projection border bar up color', n.t(null, void 0, t(61250))),
      ...
      function we(e, i, t, n) {
        ...
        return [
          (0, r.createTwoColorsPropertyDefinition)(
            {
              checked: (0, r.convertToDefinitionProperty)(e, i.drawBody, x.format({ candleType: t })),
              color1: (0, r.getColorDefinitionProperty)(e, i.upColor, null, F.format({ candleType: t })),
              color2: (0, r.getColorDefinitionProperty)(e, i.downColor, null, N.format({ candleType: t })),
            },
            { id: `${n}Symbol${o}CandlesColor`, title: ee },
          ),
          (0, r.createTwoColorsPropertyDefinition)(
            {
              checked: (0, r.convertToDefinitionProperty)(e, i.drawBorder, E.format({ candleType: t })),
              color1: (0, r.getColorDefinitionProperty)(e, i.borderUpColor, null, H.format({ candleType: t })),
              color2: (0, r.getColorDefinitionProperty)(e, i.borderDownColor, null, R.format({ candleType: t })),
            },
            { id: `${n}Symbol${o}BordersColor`, title: ie },
          ),
          (0, r.createTwoColorsPropertyDefinition)(
            {
              checked: (0, r.convertToDefinitionProperty)(e, i.drawWick, j.format({ candleType: t })),
              color1: (0, r.getColorDefinitionProperty)(e, i.wickUpColor, null, U.format({ candleType: t })),
              color2: (0, r.getColorDefinitionProperty)(e, i.wickDownColor, null, G.format({ candleType: t })),
            },
          ...
          case 1:
            return (function (e, i, r) {
              return [
                ...
                ...we(e, i, new o.TranslatedString('candle', n.t(null, void 0, t(30792))), r),
              ];
    ...
    73986: (e, i, t) => {
      ...
      var n = t(50151),
        ...
        d = t(32766),
        u = t(20345);
      const h = new r.TranslatedString('change {inputName} property', o.t(null, void 0, t(21547)));
      function p(e) {
            ...
            if ('options' in l) {
              ...
              f.push(
                (0, s.createOptionsPropertyDefinition)(
                  { option: (0, s.convertToDefinitionProperty)(e, w, h.format({ inputName: T })) },
                  { id: `${v}${l.name}`, title: P, options: new a.WatchedValue(p(i)) },
                ),
              );
              ...
              if ('float' === l.type) {
                ...
                return (
                  (t =
                    (function (e, i) {
                      return !(
                        ((i === (0, c.chartStyleStudyId)(4) || i === (0, c.chartStyleStudyId)(6)) && 'boxSize' === e) ||
                  ...
                  void f.push(
                    (0, s.createNumberPropertyDefinition)(
                      { value: (0, s.convertToDefinitionProperty)(e, w, h.format({ inputName: T })) },
                      {
                        id: `${v}${l.name}`,
                        title: P,
                        type: 1,
                ...
                ? 'bool' !== l.type ||
                  f.push(
                    (0, s.createCheckablePropertyDefinition)(
                      { checked: (0, s.convertToDefinitionProperty)(e, w, h.format({ inputName: T })) },
                      { id: `${v}${l.name}`, title: P },
                    ),
                  )
                : f.push(
                    (0, s.createTextPropertyDefinition)(
                      { text: (0, s.convertToDefinitionProperty)(e, w, h.format({ inputName: T })) },
                      { id: `${v}${l.name}`, title: P, isEditable: !0, isMultiLine: !1 },
                    ),
                  );
            } else
              f.push(
                (0, s.createNumberPropertyDefinition)(
                  { value: (0, s.convertToDefinitionProperty)(e, w, h.format({ inputName: T }), [u.floor]) },
                  {
                    id: `${v}${l.name}`,
                    title: P,
                    type: 0,
      ...
      const b = (0, g.getLogger)('Chart.Definitions.Series'),
        ...
        _ =
          ...
          new r.TranslatedString('use settlement as close on daily interval', o.t(null, void 0, t(98402))),
        ...
        V =
          (new r.TranslatedString('change previous close price line visibility', o.t(null, void 0, t(59883))),
          new r.TranslatedString('change previous close price line color', o.t(null, void 0, t(91183))),
          new r.TranslatedString('change previous close price line width', o.t(null, void 0, t(87631))),
          new r.TranslatedString('change pre/post market price lines visibility', o.t(null, void 0, t(50393))),
          ...
          new r.TranslatedString('change bid and ask lines visibility', o.t(null, void 0, t(32311))),
          ...
          new r.TranslatedString('change high and low price lines visibility', o.t(null, void 0, t(92556)))),
      ...
      function ie() {
        const e = [{ title: Q, value: 'default' }],
          i = (function (e = 15) {
            const i = [];
            for (let t = 0; t <= e; t++) i.push({ priceScale: Math.pow(10, t), minMove: 1, frac: !1 });
            return i;
          })();
      ...
      class te {
        ...
        destroy() {
          null !== this._propertyPages &&
            ...
            this._series.properties().childs().rangeStyle.childs().barStyle.listeners().unsubscribeAll(this),
        ...
        _updateSessionIdOptionsWV() {
          ...
          const i = (e.subsessions || [])
            .filter((e) => !e.private)
            .map((e) => ({ title: (0, w.translateSessionDescription)(e.description), value: e.id }));
          ...
          return new Promise((e) => {
            ...
            null !== t
              ? this._model
                  ...
                  .catch((i) => {
                    b.logWarn(`Find meta info for create series definitions with error - ${(0, v.errorToString)(i)}`),
                      e(null);
                  })
              : e(null);
          }).then((i) => {
            ...
            const r = (0, s.createOptionsPropertyDefinition)(
                ...
                { id: `${u}SymbolMinTick`, title: H, options: new a.WatchedValue(ie()) },
              ),
              h = (0, s.createOptionsPropertyDefinition)(
                { option: (0, s.convertToDefinitionProperty)(this._undoModel, this._timezonePropertyObj.property, D) },
                { id: `${u}SymbolTimezone`, title: R, options: new a.WatchedValue(this._timezonePropertyObj.values) },
              );
            return (
              (this._definitions = {
                definitions: [
          ...
          if (T) {
            const t = this._series.sessionIdProxyProperty(),
              n = (0, S.combineWithFilteredUpdate)(
                ...
                (0, f.createWVFromProperty)(this._series.isDWMProperty()).ownership(),
              ),
              o = (0, s.createOptionsPropertyDefinition)(
                {
                  option: (0, s.convertToDefinitionProperty)(this._undoModel, t, _),
            ...
            const a = l ? this._createOutOfSessionDefinition(e) : this._createPrePostMarketDefinition(e);
            i.push(a);
          }
          return i;
        }
