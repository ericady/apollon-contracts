(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [7078],
  {
    ...
    22265: (e, t, a) => {
      'use strict';
      a.d(t, { DialogSidebarContainer: () => m, DialogSidebarItem: () => h, DialogSidebarWrapper: () => d });
      var i = a(50959),
        n = a(97754),
        l = a.n(n),
        s = a(9745),
      ...
      function m(e) {
        ...
        return i.createElement('div', { ...n, className: m, 'data-role': 'dialog-sidebar' });
      }
      function d(e) {
      ...
      function h(e) {
        ...
        return i.createElement(
          h,
          { ...g, ref: u, className: l()(c.tab, b && c.isTablet, _ && c.isMobile, m && c.active, p), onClick: d },
    ...
    56080: (e, t, a) => {
      ...
      class W extends n.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._handleApplyDefaults = () => {
              ...
              (0, f.loadTheme)(t, { themeName: a, standardTheme: !0, applyOverrides: !0, onlyActiveChart: !0 });
            }),
            (this._handleSaveAs = () => {
              if (j) {
                ...
                window.runOrSignIn(
                  () =>
                    (async function (e, t, i) {
                      const [n, l] = await Promise.all([a.e(7648).then(a.bind(a, 57351)), (0, f.getThemeNames)()]);
            ...
            (this._handleListboxFocus = (e) => {
              e.target instanceof HTMLElement && (0, D.handleAccessibleMenuFocus)(e, this._reference);
            }),
        ...
        _getPlaceHolderItem(e) {
          return e ? n.createElement(g.Icon, { className: I.themesButtonIcon, icon: M }) : N;
        }
        _getThemeItems(e) {
          const { isApplyToAllVisible: t, chartWidgetCollection: a, applyToAllCallback: i } = this.props,
            { themes: l } = this.state;
          return n.createElement(
            n.Fragment,
            null,
      ...
      function J(e) {
        if (!G.PLATFORM_ACCESSIBILITY_ENABLED) return n.createElement(q.DialogSidebarContainer, { ...e });
        ...
        constructor(e) {
          ...
          super(e),
            (this._renderChildren = ({ requestResize: e, isSmallWidth: t }) => (
              ...
              n.createElement('div', { className: ie.content }, this._renderTabs(t), this._renderTabContent(t))
            )),
            ...
            (this._selectPage = (e, t) => {
              ...
              e !== a &&
                ...
                null !== e &&
                  (t || h().setValue(ne, e.id), e.definitions.subscribe(this._onChangeActivePageDefinitions)),
          ...
          return n.createElement(p.MatchMedia, { rule: R.DialogBreakpoints.TabletSmall }, (r) =>
            n.createElement(o.AdaptiveConfirmDialog, {
              ...
              additionalHeaderElement:
                null !== s && r ? n.createElement(ae, { onClick: this._handleBackClick }) : void 0,
              onSubmit: this._handleSubmit,
              onForceFocus: G.PLATFORM_ACCESSIBILITY_ENABLED ? this._handleForceFocus : void 0,
    ...
    74628: (e, t, a) => {
      ...
      function m(e) {
        ...
        return r.PLATFORM_ACCESSIBILITY_ENABLED
          ? i.createElement(
              'button',
              { ref: m, tabIndex: d, onClick: a, className: l()(c.button, n.isActive && c.active), type: 'button' },
