(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [4713],
  {
    ...
    15499: (e, t, n) => {
      ...
      function N(e, t) {
        switch (e) {
          ...
          case w.Year:
            return v.setDecades.format({ year_start: `${t.getFullYear()}`, year_end: '' + (t.getFullYear() + y - 1) });
          case w.Decades:
    ...
    28746: (e, t, n) => {
      ...
      function l(e) {
        ...
        return s.createElement(
          ...
          s.createElement(
            r.LightButton,
            { size: 'small', variant: 'ghost', 'aria-label': a, onClick: f, disabled: h, onKeyDown: w, reference: p },
            l,
          ),
          s.createElement(r.LightButton, {
            startIcon: o,
      ...
      class d extends s.PureComponent {
        constructor() {
          super(...arguments),
            ...
            (this._getVariant = () => {
              let e = 'ghost';
              return (
                this._withinSelectedRange() && (e = this.props.isDisabled ? 'secondary' : 'quiet-primary'),
        ...
        render() {
          const e = a(
              ...
              !this.props.isDisabled && (this.props.isSelected || this._isOnHighlightedEdge()) && i['accent-color'],
      ...
      function g({
        ...
        const [h, d] = (0, p.useRefsMap)(),
          ...
          f = (0, s.useCallback)(
            (n, s) => {
              if (!n) return null;
              const a = (0, c.getCloneDateWithOffset)({ dateFrom: n, offset: s, isDisabledDate: e, level: u });
              return g(t(a));
            },
            [t, g],
          ),
          ...
          D = (0, s.useCallback)(
            (t, n) => {
              if (!t) return;
              const s = (0, c.getCloneDateWithOffset)({ dateFrom: t, offset: n, isDisabledDate: e, level: u });
              s && (n > 0 ? r(s) : o(s));
            },
            [e, r, o],
          ),
          {
            ...
            return { currentlyFocused: i, setCurrentlyFocused: l, focusItem: c, bindings: { onKeyDown: h } };
          })({ refsMap: h, verticalOffset: l, getNextKeyToFocus: f, getFirstKey: v, getLastKey: w, onGridEnd: D });
        return (
        ...
        const {
          ...
          y = (0, s.useCallback)(
            (e) => {
              if (!e) return null;
              let t = null;
              return a.find(({ days: n }) => ((t = n.find((t) => (0, c.isSameDay)(t, e))), t)), t;
            },
            [a],
          ),
          ...
          _ = (0, s.useCallback)(
            (e) => D || (0, c.isDayDisabled)({ day: e, minDate: p, maxDate: h, disableWeekends: m }),
            [p, h, m, D],
          ),
          {
            itemsRefs: F,
      ...
      function v(e) {
        const {
          ...
          w = (0, s.useCallback)((e) => d || !(0, c.isInRange)(e, o, a, 'month'), [o, a, d]),
          D = (0, s.useCallback)(
            (e) => {
              if (!e) return null;
              let n = null;
      ...
      class D {
        ...
        destroyAll() {
          var e;
          (this._messagesQueue = []),
            clearTimeout(null === (e = this._renderedMessage) || void 0 === e ? void 0 : e.destroyTimer),
      ...
      const y = new (class {
        ...
        _setContainers(e) {
          ...
          return (
            ...
            (this._politeQueue.setContainers([n[0], n[1]]), this._assertiveQueue.setContainers([s[0], s[1]]), !0)
          );
        }
      })();
      function C({ viewType: e, decadesStartYear: t, viewDate: n, setPrev: a, setNext: r, switchViewType: o }) {
        const [i, l] = (0, s.useState)(null),
          c = (0, s.useCallback)(
            (e) => {
      ...
      function E(e) {
        ...
        const P = (0, s.useCallback)(
              ...
              I = (0, s.useMemo)(() => {
                switch (g) {
                  ...
                  case u.CalendarViewType.Year: {
                    ...
                    return e.setMonth(e.getMonth() + 1), !(0, c.isInRange)(e, a, r, 'month');
                  }
                  case u.CalendarViewType.Decades: {
                    const e = new Date(T[T.length - 1]);
                    return e.setFullYear(e.getFullYear() + 1), !(0, c.isInRange)(e, a, r, 'year');
                  }
                }
              }, [g, a, r, R, x, T]),
              P = (0, s.useMemo)(() => {
          ...
          te = (0, s.useMemo)(() => L[0], [L]),
          {
            ...
            onNextClick: se,
            onSwitchViewType: ae,
          } = C({ viewType: Y, decadesStartYear: te, viewDate: A, setPrev: $, setNext: K, switchViewType: W });
        return s.createElement(
          'div',
          { className: a(i.calendar, g && i.popupStyle, o), tabIndex: -1, onKeyDown: I },
          s.createElement(l, {
          ...
          super(e),
            ...
            (this._onShowPicker = (e) => {
              if (e && this._inputContainer) {
                ...
                (e.style.top = 'auto'), (e.style.bottom = a < t.height ? '0' : `${s + n.height}px`);
              }
            }),
            (this._onChange = () => {
            ...
            (this._handleDropdownKeydown = (e) => {
              ...
              27 === (0, v.hashFromEvent)(e) &&
                (null === (t = this._input) || void 0 === t || t.focus(), this.props.onHidePicker());
            }),
          ...
          return a.createElement(
            ...
            this.props.showPicker && !o
              ? a.createElement(
                  ...
                  a.createElement(g.OutsideEvent, { mouseDown: !0, handler: this.props.onHidePicker }, (t) =>
                    a.createElement(
                      'span',
              ...
              endSlot:
                s && s.length
                  ...
                  : a.createElement(
                      m.EndSlot,
                      null,
                      a.createElement(h.Icon, { icon: this.props.icon, className: r(w.icon, n && w.disabled) }),
                    ),
              className: e,
          ...
          super(e),
            ...
            (this._onPickerInputKeyDown = (e) => {
              ...
              if ([v.Modifiers.Shift + 9, 9].includes(t)) this._hideCalendar();
                ...
                if (40 === t)
                  return e.preventDefault(), this._showCalendar(), void this.setState({ autofocusCalendar: !0 });
            ...
            : a.createElement(
                ...
                a.createElement(
                  ...
                  a.createElement(c.Calendar, {
                    ...
                    endSlot: e && a.createElement(e, { onSelectDate: this._onSelect }),
    ...
    76056: (e, t, n) => {
      ...
      function m(e) {
        ...
        return s.createElement(
          ...
          t && s.createElement(h, { text: a.t(null, void 0, n(32457)), className: m.tooltip }),
        );
      }
    },
    23935: (e, t, n) => {
      ...
      function N({ dateFrom: e, offset: t, level: n = 'day', maxIterations: s = 6, isDisabledDate: a = () => !1 }) {
    ...
    70412: (e, t, n) => {
      'use strict';
      n.d(t, { hoverMouseEventFilter: () => r, useAccurateHover: () => o, useHover: () => a });
      var s = n(50959);
      function a() {
      ...
      function c(e) {
        ...
        return s.createElement(
          ...
          s.createElement(a.InputControl, {
            ...
            endSlot: s.createElement(s.Fragment, null, P.icon && s.createElement(o.EndSlot, { icon: !0 }, P.icon), m),
            'aria-required': N,
            'aria-invalid': R,
    ...
    36565: (e, t, n) => {
      ...
      function b(e, t, n) {
        ...
        for (; r < i && o < l; ) {
          ...
          l
            ? (i.match(l.pattern)
                ? (s.push(i),
                  l.recursive && (-1 === c ? (c = r) : r === d && r !== c && (r = c - 1), d === c && (r -= 1)),
                  (r += 1))
                : i === m
                ? (u--, (m = void 0))
                : l.optional
              ...
              (o += 1))
            : (t || s.push(n), i === n ? (h.push(o), (o += 1)) : ((m = n), h.push(o + u), u++), (r += 1));
        }
        const g = e.charAt(d);
        i !== l + 1 || D[g] || s.push(g);
        const f = s.join(''),
      ...
      function N(e) {
        ...
        return a.createElement(
          ...
          a.createElement(E, {
            disabled: e.disabled,
            name: e.name,
            endSlot: a.createElement(c.EndSlot, { icon: !0 }, a.createElement(m, null)),
            reference: s,
          ...
          a.createElement(
            F.PopupMenu,
            {
              ...
              position: function () {
                ...
                return { x: e.left, y: r, overrideWidth: e.width, overrideHeight: a };
              },
      ...
      function T(e) {
        const [t, n] = e.split(':'),
          [s, a] = [(0, w.clamp)(parseInt(t), 0, 23), (0, w.clamp)(parseInt(n), 0, 59)],
    ...
    95263: (e, t, n) => {
        ...
        ((v = class extends s.PureComponent {
          ...
          _calcProps(e) {
            if (e.target && e.attachment && e.targetAttachment) {
              ...
              if (null === t) return {};
              const { width: n, inheritWidthFromTarget: s = !0, inheritMaxWidthFromTarget: a = !1 } = this.props,
          ...
          _calcTargetProps(e, t, n) {
            ...
            return (
              ...
              'number' == typeof this.props.attachmentOffsetX && (l += this.props.attachmentOffsetX),
              { x: l, y: c, width: i }
            );
          }
      ...
      function D(e) {
        const { children: t, messageIdCallback: n, ...a } = e,
          o = s.useId();
        return r(o, n), s.createElement('span', { ...a, className: d['visually-hidden'], id: o }, t);
      }
      var b = n(9745),
        y = n(16658),
        C = n(40461);
      function E(e) {
        ...
        return s.createElement(b.Icon, { icon: y, className: a(C['error-icon'], C[`intent-${t}`]) });
      }
      var _,
        F,
        M = n(27345);
      ...
      function k(e) {
        const {
          ...
          { attachment: h, targetAttachment: d, attachmentOffsetY: p } = null != r ? r : S[a];
        return s.createElement(
          s.Fragment,
          null,
          s.createElement(
        ...
        const {
          ...
          j = O
            ? s.createElement(
                ...
                null == u ? void 0 : u.map((e, t) => s.createElement(P, { key: t, messageIdCallback: R }, e)),
              )
            : void 0,
          J = z
            ? s.createElement(
                ...
                null == h ? void 0 : h.map((e, t) => s.createElement(P, { key: t, messageIdCallback: R }, e)),
              )
            : void 0,
          q = V
            ? s.createElement(
                ...
                null == d ? void 0 : d.map((e, t) => s.createElement(P, { key: t, messageIdCallback: R }, e)),
              )
            : void 0,
          U =
            !O && !z && !V && w
          ...
          renderedErrors:
            null !==
              (c =
                null !==
                  (r =
                    null !== (n = null !== (t = null != K ? K : W) && void 0 !== t ? t : j) && void 0 !== n ? n : J) &&
                void 0 !== r
                  ? r
                  : q) && void 0 !== c
              ? c
      ...
      function P(e) {
        const { children: t, messageIdCallback: n, ...a } = e,
          o = s.useId();
        return r(o, n), s.createElement('span', { ...a, className: M.message, id: o }, t);
      }
    },
    16396: (e, t, n) => {
      'use strict';
      ...
      function d(e) {
        ...
        return s.createElement(
          J,
          {
            ...
            'aria-selected': d,
            'aria-checked': p,
            className: a(m, O.item, b && O.withIcon, { [O.isActive]: y, [O.isDisabled]: C || _, [O.hovered]: E }),
            title: g,
            href: M,
            target: N,
            rel: R,
            ...
            onClick: function (t) {
              const { dontClosePopup: n, onClick: s, onClickArg: a, trackEventObject: i } = e;
              if (C) return;
            ...
            onContextMenu: function (t) {
              ...
              n && s && (0, o.trackEvent)(n.category, n.event, `${n.label}_rightClick`);
            },
            onMouseUp: function (t) {
              const { trackEventObject: n, trackMouseWheelClick: s } = e;
              if (1 === t.button && M && n) {
                let e = n.label;
                s && (e += '_mouseWheelClick'), (0, o.trackEvent)(n.category, n.event, e);
              }
            },
            onMouseOver: P,
            onMouseOut: I,
          ...
          (void 0 !== w || D) &&
            s.createElement('span', { className: O.shortcut }, (q = w) && q.split('+').join(' + ')),
          void 0 !== x &&
            s.createElement(
              'span',
              { onClick: Y ? h : void 0, className: a(O.toolbox, { [O.showOnHover]: S, [O.showOnFocus]: k }) },
              x,
            ),
        );
        var q;
