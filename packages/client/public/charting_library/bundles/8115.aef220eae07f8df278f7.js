  ...
  [8115, 306],
  {
        ...
        w = function (t, e) {
          var n,
            ...
            a =
              ...
              f(c, { x: r, y: o, width: i, height: u, top: o, right: r + i, bottom: u + o, left: r }),
              c);
    ...
    95257: (t, e) => {
      ...
      function R(t, e, r) {
        ...
        return { $$typeof: n, type: t, key: u, ref: s, props: i, _owner: O.current };
      }
      function k(t) {
            ...
            g(u)
              ...
              : null != u &&
                (k(u) &&
                  ...
                  })(u, o + (!u.key || (c && c.key === u.key) ? '' : ('' + u.key).replace(M, '$&/') + '/') + t)),
                e.push(u)),
            1
          );
        if (((c = 0), (i = '' === i ? '.' : i + ':'), g(t)))
          ...
          for (t = f.call(t), a = 0; !(s = t.next()).done; ) c += C((s = s.value), e, o, (f = i + A(s, a++)), u);
        else if ('object' === s)
          throw (
            ((e = String(t)),
            Error(
      ...
      var $ = { current: null },
        T = { transition: null },
        D = { ReactCurrentDispatcher: $, ReactCurrentBatchConfig: T, ReactCurrentOwner: O };
      (e.Children = {
        map: x,
        ...
        (e.cloneElement = function (t, e, r) {
          ...
          return { $$typeof: n, type: t.type, key: i, ref: u, props: o, _owner: s };
        }),
        ...
        (e.isValidElement = k),
        (e.lazy = function (t) {
          return { $$typeof: h, _payload: { _status: -1, _result: t }, _init: j };
        }),
        (e.memo = function (t, e) {
