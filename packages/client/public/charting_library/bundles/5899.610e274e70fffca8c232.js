(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [5899],
  {
    ...
    51331: (e) => {
      e.exports = { loaderWrap: 'loaderWrap-jGEARQlM', big: 'big-jGEARQlM', loader: 'loader-jGEARQlM' };
    },
    22436: (e) => {
      e.exports = {
        item: 'item-GJX1EXhk',
    ...
    70673: (e, t, n) => {
      ...
      function u(e) {
        ...
        return r.createElement(
          ...
          r.createElement('span', { className: t }, r.createElement(a.Icon, { icon: i, className: c().icon })),
        );
      }
    },
    26996: (e, t, n) => {
          ...
          r.createElement(
            ...
            l &&
              r.createElement(
                v.Drawer,
                { onClose: c },
                r.createElement(y, { items: n.subItems, parentAction: t, closeNested: c }),
              ),
          )
        );
        function c(e) {
        ...
        render() {
          ...
          return e
            ? r.createElement(
                ...
                r.createElement(p.MatchMedia, { rule: 'screen and (max-width: 430px)' }, (t) =>
                  this._isDrawer(t)
                    ? r.createElement(
                        C.Provider,
                        { value: { type: 'drawer' } },
    ...
    23829: (e, t, n) => {
      ...
      function m(e) {
        const {
          ...
          O = !!C.length;
        return o
          ? r.createElement('li', { className: s()(t, d.item, d.loading, d[N]) }, r.createElement(i.Loader, null))
          : r.createElement(
              'li',
              {
                className: s()(
              ...
              r.createElement('span', { className: s()(d.label) }, null != I ? I : w),
              !!S &&
                r.createElement(a.Icon, {
                  onClick: function () {
                    S && S.action();
              ...
              !O && y && r.createElement(c.Hint, { className: d.shortcut, text: y }),
    ...
    95257: (e, t) => {
      ...
      function g(e, t, r) {
        var o,
          ...
          i = null;
        if (null != t)
          for (o in (void 0 !== t.ref && (i = t.ref), void 0 !== t.key && (a = '' + t.key), t))
        ...
        return { $$typeof: n, type: e, key: a, ref: i, props: s, _owner: w.current };
      }
      function S(e) {
            ...
            y(a)
              ...
              : null != a &&
                (S(a) &&
                  ...
                  })(a, o + (!a.key || (l && l.key === a.key) ? '' : ('' + a.key).replace(I, '$&/') + '/') + e)),
                t.push(a)),
            1
          );
        if (((l = 0), (s = '' === s ? '.' : s + ':'), y(e)))
          ...
          for (e = u.call(e), c = 0; !(i = e.next()).done; ) l += M((i = i.value), t, o, (u = s + N(i, c++)), a);
        else if ('object' === i)
          throw (
            ((t = String(e)),
            Error(
      ...
      var D = { current: null },
        L = { transition: null },
        G = { ReactCurrentDispatcher: D, ReactCurrentBatchConfig: L, ReactCurrentOwner: w };
      (t.Children = {
        map: O,
        ...
        (t.cloneElement = function (e, t, r) {
          ...
          if (null != t) {
            ...
            for (c in t) C.call(t, c) && !x.hasOwnProperty(c) && (o[c] = void 0 === t[c] && void 0 !== l ? l[c] : t[c]);
          }
          ...
          return { $$typeof: n, type: e.type, key: s, ref: a, props: o, _owner: i };
        }),
    ...
    58451: (e, t, n) => {
      ...
      function s(e) {
        return r.createElement(
          'tr',
          { className: o.row },
          r.createElement('td', null, r.createElement('div', { className: o.line })),
          r.createElement(
            'td',
            null,
            r.createElement('div', { className: o.line }),
            e.hint ? r.createElement('div', { className: o.hint }, e.hint) : null,
          ),
        );
      }
      var a = n(50151),
      ...
      class E extends r.PureComponent {
        ...
        render() {
          ...
          return r.createElement(
            ...
            r.createElement(
              ...
              r.createElement('td', { className: i(a.iconCell), 'data-icon-cell': !0 }, this._icon(a)),
              r.createElement(
                'td',
                ...
                r.createElement(
                  ...
                  r.createElement(
                    'span',
                    { className: i(a.label, this.props.checked && a.checked), 'data-label': !0 },
                    this.props.label,
                  ),
                  this._toolbox(a),
                  e &&
                  ...
                  !e &&
                    t &&
                    !u.CheckMobile.any() &&
                    r.createElement(m.Hint, { className: i(o && a.invisibleHotkey), text: t }),
                  !e && !t && n && r.createElement(m.Hint, { text: n }),
                ),
              ),
            ),
            r.createElement('tr', { className: a.subMenu }, r.createElement('td', null, this.props.children)),
          );
        }
        _icon(e) {
          if (this.props.checkable) {
            ...
            return this.props.icon
              ? r.createElement('span', { className: e.icon, dangerouslySetInnerHTML: { __html: this.props.icon } })
        ...
        _renderToolboxContent() {
          return this.props.toolbox && this.props.toolbox.type === f.ToolboxType.Delete
            ? r.createElement(p.RemoveButton, { onClick: this.props.toolbox.action })
            : null;
        }
      }
      var k = n(29332),
      ...
      class N extends r.PureComponent {
          ...
          super(e),
            ...
            (this._calcSubMenuPos = (e) =>
              (function (e, t, n = { x: 0, y: 10 }) {
                if (t) {
                  const { left: n, right: r, top: o } = t.getBoundingClientRect(),
        ...
        componentDidUpdate(e, t) {
          ...
          t.loading !== this.state.loading &&
            (null === (r = (n = this.props).onRequestUpdate) || void 0 === r || r.call(n)),
        ...
        render() {
          ...
          const o = null !== (e = this.state.jsxLabel) && void 0 !== e ? e : this.state.label,
            s = (null === (t = this.context) || void 0 === t ? void 0 : t.current)
