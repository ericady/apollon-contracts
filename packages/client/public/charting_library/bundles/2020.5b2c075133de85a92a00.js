  ...
  [2020],
  {
            ...
            if (n) {
              ...
              if (
                ...
                (a = [].concat(e(a), [L])),
                  ...
                  t || (document.addEventListener('touchmove', T, l ? { passive: !1 } : void 0), (t = !0));
              }
            } else {
              (m = i),
                setTimeout(function () {
            ...
            (o.clearAllBodyScrollLocks = function () {
              n
                ? (a.forEach(function (o) {
                  ...
                  t && (document.removeEventListener('touchmove', T, l ? { passive: !1 } : void 0), (t = !1)),
                  (a = []),
                  (s = -1))
                : (L(), (a = []));
            }),
            (o.enableBodyScroll = function (o) {
              if (n) {
                ...
                (o.ontouchstart = null),
                  ...
                  t &&
                    0 === a.length &&
                    (document.removeEventListener('touchmove', T, l ? { passive: !1 } : void 0), (t = !1));
              } else
    ...
    36189: (o, e, l) => {
      ...
      var i = l(44352),
        ...
        c = l(48010),
        r = l(14877);
      const d = { add: i.t(null, void 0, l(44629)), remove: i.t(null, void 0, l(72482)) };
      function T(o) {
    ...
    54819: (o, e, l) => {
      ...
      const r = (0, c.humanReadableModifiers)(c.Modifiers.Shift, !1),
        ...
        v = {
          ...
          LineToolABCD: { icon: a.lineToolsIcons.LineToolABCD, localizedName: s.lineToolsLocalizedNames.LineToolABCD },
          LineToolArc: { icon: a.lineToolsIcons.LineToolArc, localizedName: s.lineToolsLocalizedNames.LineToolArc },
          LineToolArrow: {
          ...
          LineToolGannSquare: {
            ...
            hotKey: (0, n.hotKeySerialize)({ keys: [r], text: i.t(null, void 0, l(10289)) }),
          },
          ...
          LineToolNote: { icon: a.lineToolsIcons.LineToolNote, localizedName: s.lineToolsLocalizedNames.LineToolNote },
          ...
          LineToolPath: { icon: a.lineToolsIcons.LineToolPath, localizedName: s.lineToolsLocalizedNames.LineToolPath },
          LineToolPrediction: {
          ...
          LineToolRay: { icon: a.lineToolsIcons.LineToolRay, localizedName: s.lineToolsLocalizedNames.LineToolRay },
          LineToolRectangle: {
            icon: a.lineToolsIcons.LineToolRectangle,
            localizedName: s.lineToolsLocalizedNames.LineToolRectangle,
            hotKey: (0, n.hotKeySerialize)({ keys: [r], text: i.t(null, void 0, l(81591)) }),
          },
          LineToolCircle: {
          ...
          LineToolText: { icon: a.lineToolsIcons.LineToolText, localizedName: s.lineToolsLocalizedNames.LineToolText },
          ...
          arrow: { icon: t.drawingToolsIcons.arrow, localizedName: i.t(null, void 0, l(96237)) },
          cursor: { icon: t.drawingToolsIcons.cursor, localizedName: i.t(null, void 0, l(29908)) },
          dot: { icon: t.drawingToolsIcons.dot, localizedName: i.t(null, void 0, l(60925)) },
          drawginmode: {
          ...
          eraser: { icon: t.drawingToolsIcons.eraser, localizedName: i.t(null, void 0, l(99289)) },
          group: { icon: t.drawingToolsIcons.group, localizedName: i.t(null, void 0, l(91977)) },
          hideAllDrawings: {
          ...
          measure: {
            ...
            hotKey: (0, n.hotKeySerialize)({ keys: [r], text: i.t(null, void 0, l(32868)) }),
          },
          removeAllDrawingTools: {
            icon: t.drawingToolsIcons.removeAllDrawingTools,
            localizedName: i.t(null, void 0, l(76091)),
          },
          showObjectsTree: { icon: t.drawingToolsIcons.showObjectTree, localizedName: i.t(null, void 0, l(51072)) },
          zoom: { icon: t.drawingToolsIcons.zoom, localizedName: i.t(null, void 0, l(38925)) },
          'zoom-out': { icon: t.drawingToolsIcons['zoom-out'], localizedName: i.t(null, void 0, l(49895)) },
        };
      v.LineToolGhostFeed = {
      ...
      !(function (o) {
        function e() {
          ...
          if (0 === r.length && c && 'undefined' != typeof window) {
            const o = JSON.parse(
              null !== (i = null === (e = window.urlParams) || void 0 === e ? void 0 : e.favorites) && void 0 !== i
                ? i
                : '{}',
            ).drawingTools;
        ...
        (function (o) {
          ...
          (o.favoriteAdded = new i.Delegate()),
            ...
            (o.removeFavorite = function (e, l) {
              ...
              return (
                null !== n && n > i && (t.tweetToolPosition = n - 1), t.saveFavorites(l), o.favoriteRemoved.fire(e), !0
              );
            }),
            (o.isFavorite = n),
            (o.moveFavorite = function (i, n, a) {
              ...
              return (
                null !== c && (s < c && n > c ? c-- : n < c && s > c && c++, (t.tweetToolPosition = c)),
