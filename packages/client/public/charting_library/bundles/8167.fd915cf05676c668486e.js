  ...
  [8167],
  {
    41339: (e, t, i) => {
      ...
      var a = i(46141),
        ...
        p = i.n(c),
        u = i(94474);
      const h = new r.TranslatedString('change price Y coordinate', o.t(null, void 0, i(66266))),
      ...
      function f(e, t, i) {
        return { property: (0, a.convertToDefinitionProperty)(e, t.price, h), info: { typeY: 1, stepY: i } };
      }
      function g(e, t) {
        return {
    ...
    97456: (e, t, i) => {
      ...
      var n = i(44352),
        ...
        d = i(68806),
        c = i(62513);
      const p = new o.TranslatedString('change {title} visibility on ticks', n.t(null, void 0, i(30810))),
        ...
        x =
          (new o.TranslatedString('change {title} visibility on ranges', n.t(null, void 0, i(29091))),
      ...
      class m {
        constructor(e, t) {
          (this._yCoordinateStepWV = null),
            ...
            (this._propertyApplier = new p.PropertyApplierWithoutSavingChart(() => e, new a.WatchedValue(false))),
        ...
        _createVisibilitiesPropertyPage() {
          ...
          return (0, l.createPropertyPage)(
            (0, d.getIntervalsVisibilitiesPropertiesDefinitions)(
              this._undoModel,
              e,
              new r.TranslatedString(this._source.name(), this._source.title(u.TitleDisplayTarget.StatusLine, !0)),
            ),
            'visibility',
            h,
          );
        ...
        _createCoordinatesPropertyPage() {
          ...
          return null !== e
            ? (e.definitions.length < this._source.pointsCount() &&
                this._source.pointAdded().subscribe(this, this._updateCoordinatesPropertyDefinitons),
        ...
        _updateCoordinatesPropertyDefinitons() {
          const e = this._coordinatesPropertyDefinitions();
          if (null !== e) {
            (0, n.ensureDefined)(this._propertyPages.find((e) => 'coordinates' === e.id)).definitions.setValue(
              e.definitions,
            ),
              ...
              o.push(
                (0, r.createCoordinatesPropertyDefinition)(
                  { x: c.property },
                  {
                    ...
                    title: n.t(null, { context: 'linetool point' }, i(63227)).format({ count: (s + 1).toString() }),
                    ...c.info,
                  },
                ),
              );
    ...
    62513: (e, t, i) => {
      ...
      var n = i(50151),
        ...
        s = i(59452),
        l = i.n(s);
      const a = new r.TranslatedString('change {propertyName} property', o.t(null, void 0, i(18567)));
      class d extends l() {
        constructor(e, t, i) {
          super(),
            (this._isProcess = !1),
        ...
        subscribe(e, t) {
          ...
          this._listenersMappers.push({ obj: e, method: t, callback: i }), this._baseProperty.subscribe(e, i);
        }
        unsubscribe(e, t) {
          var i;
