(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [5901],
  {
                ...
                (s = [].concat(t(s), [d])),
                  ...
                  (e.ontouchmove = function (t) {
                    ...
                    1 === t.targetTouches.length &&
                      ...
                      !u(n.target) &&
                        ((o && 0 === o.scrollTop && 0 < s) ||
                        ((r = o) && r.scrollHeight - r.scrollTop <= r.clientHeight && s < 0)
                          ? p(n)
                          : n.stopPropagation()));
                  }),
                  a || (document.addEventListener('touchmove', p, n ? { passive: !1 } : void 0), (a = !0));
              }
            } else {
              (m = o),
                setTimeout(function () {
            ...
            (e.clearAllBodyScrollLocks = function () {
              r
                ? (s.forEach(function (e) {
                  ...
                  a && (document.removeEventListener('touchmove', p, n ? { passive: !1 } : void 0), (a = !1)),
                  (s = []),
                  (i = -1))
                : (d(), (s = []));
            }),
            (e.enableBodyScroll = function (e) {
              if (r) {
                ...
                (e.ontouchstart = null),
                  ...
                  a &&
                    0 === s.length &&
                    (document.removeEventListener('touchmove', p, n ? { passive: !1 } : void 0), (a = !1));
              } else
    ...
    86536: (e) => {
      e.exports = { thicknessContainer: 'thicknessContainer-C05zSid7', thicknessTitle: 'thicknessTitle-C05zSid7' };
    },
    69006: (e) => {
    ...
    1369: (e) => {
      e.exports = { hue: 'hue-r4uo5Wn6', pointer: 'pointer-r4uo5Wn6', pointerContainer: 'pointerContainer-r4uo5Wn6' };
    },
    30099: (e) => {
      e.exports = {
    ...
    70673: (e, t, n) => {
      ...
      function u(e) {
        ...
        return o.createElement(
          ...
          o.createElement('span', { className: t }, o.createElement(a.Icon, { icon: i, className: c().icon })),
        );
      }
    },
    15294: (e, t, n) => {
      ...
      class c extends o.PureComponent {
        render() {
          ...
          return (
            this.props.label &&
              (c = o.createElement('span', { className: i, title: this.props.title }, this.props.label)),
            o.createElement('label', { className: s }, o.createElement(a.CheckboxInput, { ...n, className: e }), c)
          );
        }
      }
      ...
      const g = r.forwardRef((e, t) => {
        ...
        return r.createElement(d.ControlSkeleton, {
          ...
          middleSlot: r.createElement(
            h.MiddleSlot,
            null,
            r.createElement('textarea', { ...z, className: s(v().textarea, c, R && v().endslot), ref: t }),
          ),
          ...(R && { endSlot: r.createElement('span', { className: s(!W && v()['with-icon']) }, R) }),
        });
      });
      ...
      const f = (e, t, n) => (t ? void 0 : e ? -1 : n),
        ...
        C = r.forwardRef((e, t) => {
          ...
          const {
            ...
            I = (0, r.useRef)(null),
            T = (0, r.useRef)(null),
            { isMouseDown: B, handleMouseDown: k, handleMouseUp: P } = (0, c.useIsMouseDown)(),
            [D, L] = (0, i.useFocus)(),
    ...
    36104: (e, t, n) => {
      ...
      function r(e) {
        ...
        return { ...a, isFocused: s, highlight: null != n ? n : s, intent: null != t ? t : s ? 'primary' : 'default' };
      }
    },
    57733: (e, t, n) => {
      'use strict';
      ...
      class a extends o.PureComponent {
        ...
        render() {
          return o.createElement(s.Provider, { value: this.state.switchGroupContext }, this.props.children);
        }
    ...
    92399: (e, t, n) => {
      ...
      var o = n(50959),
        ...
        u = n(1405),
        p = n(12863);
      const d = { large: a.InputClasses.FontSizeLarge, medium: a.InputClasses.FontSizeMedium },
        h = {
      ...
      function m(e) {
        const {
          ...
          x = b ? o.createElement(i.StartSlot, { className: p.innerLabel, interactive: !1 }, b) : void 0,
      ...
      function T(e) {
        ...
        return o.createElement(m, {
          ...
          button: (function () {
            const { button: n, forceShowControls: a, disabled: i, title: l } = e,
            ...
            return i
              ...
              : o.createElement(
                  ...
                  null != n
                    ? n
                    : o.createElement(E, { increaseValue: p, decreaseValue: d, defaultButtonsVisible: c, title: l }),
                );
          })(),
          disabled: e.disabled,
    ...
    58593: (e, t, n) => {
        ...
        return o.createElement(
          ...
          o.createElement(
            l.PopupMenu,
            {
              ...
              onFocus: function (e) {
                ...
                const t = e.currentTarget,
                  n = (0, a.ensureNotNull)(
                    ((o = e.target), o.querySelector('[data-role="swatch"]:not([disabled], [aria-disabled])')),
                  );
                var o;
                (0, h.becomeMainElement)(n),
                  setTimeout(() => {
                    if (document.activeElement !== t || !e.target.matches(':focus-visible')) return;
                    const [n] = (0, d.queryTabbableElements)(t).sort(d.navigationOrderComparator);
                    n && n.focus();
                  });
              },
              isOpened: S,
              onClose: B,
              position: function () {
                const e = (0, a.ensureNotNull)(T.current).getBoundingClientRect();
            ...
            o.createElement(p.MenuContext.Consumer, null, (e) =>
              o.createElement(u.ColorPicker, { ...C, onColorChange: f, onToggleCustom: E, menu: e }),
            ),
            !y && n,
          ),
        );
      ...
      function w(e) {
        const { name: t, values: n, selectedValues: r, onChange: s } = e,
          a = n.map((e, t) => o.createElement(S, { key: t, value: e.toString() })),
                ...
                o.createElement(
                  ...
                  a && 'mixed' !== a
                    ...
                    : o.createElement(
                        ...
                        o.createElement('div', { className: 'mixed' === a ? I.mixedColor : I.placeholder }),
                      ),
                  r &&
                    (function () {
                      ...
                      if ('mixed' === r)
                        return o.createElement(
                          ...
                          o.createElement('div', { style: { backgroundColor: e }, className: I.line }),
                          o.createElement('div', { style: { backgroundColor: e }, className: I.line }),
                          o.createElement('div', { style: { backgroundColor: e }, className: I.line }),
                        );
    ...
    48897: (e, t, n) => {
      ...
      var o = n(50959),
        ...
        g = n(60015);
      function f(e) {
        const { value: t, onClick: n, className: s, startSlot: a, disabled: i = !1 } = e;
        return o.createElement(
          'div',
          { className: r(g.wrap, i && g.disabled, s), onClick: n, 'data-name': 'edit-button' },
          o.createElement(
            'div',
        ...
        return o.createElement(f, {
          ...
          onClick: function () {
            ...
            (0, h.showSymbolSearchItemsDialog)({
              ...
              showSpreadActions:
                u.enabled('show_spread_operators') && u.enabled('studies_symbol_search_spread_operators'),
            });
          },
          disabled: i,
      ...
      function x(e) {
        if ('definition' in e) {
          const { propType: t, properties: n, id: r, title: s = '', solutionId: a } = e.definition,
            l = n[t],
            c = l.value() || '',
            u = (e) => {
              l.setValue(e);
          ...
          return o.createElement(
            ...
            o.createElement(
              C.CellWrap,
              null,
              o.createElement(_, { symbol: (0, i.ensureDefined)(c), onSymbolChanged: u }),
            ),
          );
        }
        {
    ...
    1861: (e, t, n) => {
      ...
      function l(e) {
        ...
        if (a.dialogsOpenerManager.isOpened('SymbolSearch') || a.dialogsOpenerManager.isOpened('ChangeIntervalDialog'))
          return;
        ...
        return r.render(k, B), a.dialogsOpenerManager.setAsOpened('SymbolSearch'), y && y(), { close: P };
      }
    },
    50238: (e, t, n) => {
      'use strict';
    ...
    78260: (e, t, n) => {
      ...
      var o = n(50959),
        ...
        a = n(2746);
      function i(e) {
        return o.createElement('div', { className: s()(a.wrap, e.className) }, e.children);
      }
    },
    53424: (e, t, n) => {
      'use strict';
    ...
    31356: (e, t, n) => {
      ...
      n(41125);
      function a(e) {
        const { id: t, offset: n, disabled: a, checked: i, title: l, children: c, solutionId: u } = e;
        return o.createElement(
          r.PropertyTable.Row,
          null,
          o.createElement(
            ...
            o.createElement(s.CheckableTitle, { name: `is-enabled-${t}`, title: l, disabled: a, property: i }),
            u && !Boolean(c) && !1,
          ),
          Boolean(c) &&
            o.createElement(r.PropertyTable.Cell, { placement: 'last', 'data-section-name': t }, c, u && !1),
        );
      }
    },
    86067: (e, t, n) => {
      ...
      function i(e) {
        return o.createElement(
          ...
          o.createElement(
            ...
            o.createElement(s.CheckableTitle, { title: e.title, name: `is-enabled-${e.name}`, className: a.title }),
          ),
        );
      }
    },
    ...
    34381: (e, t, n) => {
        ...
        return (
          (0, o.useLayoutEffect)(() => {
            ...
            const e = (0, l.ensureNotNull)(t.current),
              n = () => {
                const n = (0, i.queryTabbableElements)(e).sort(i.navigationOrderComparator);
                if (0 === n.length || (n[0].parentElement && !v(n[0].parentElement, (0, l.ensureNotNull)(t.current)))) {
                  ...
                  if (null === o) return;
                  if (((0, u.becomeMainElement)(o), n.length > 0)) for (const e of n) (0, u.becomeSecondaryElement)(e);
                }
              };
            return (
          ...
          [
            ...
            function (t) {
              ...
              if (e) {
                ...
                (s = ((l = r),
                Array.from(l.querySelectorAll('button:not([disabled], [aria-disabled])')).filter(
                  (0, i.createScopedVisibleElementFilter)(l),
                )).sort(i.navigationOrderComparator)),
                  (a = s.indexOf(o));
              var l;
      ...
      function g(e) {
        document.activeElement && (0, u.becomeSecondaryElement)(document.activeElement),
      ...
      const S = function (e, t, n) {
        ...
        if (!o || t < 1) return [];
        for (var r = 0, s = 0, a = Array(y(o / t)); r < o; ) a[s++] = (0, f.default)(e, r, (r += t));
        return a;
      };
      var w = n(24377),
        _ = n(49483),
          ...
          g &&
            o.createElement(
              x.PopupMenu,
              {
                ...
                onClose: f,
                position: function () {
                  const e = (0, l.ensureNotNull)(m.current).getBoundingClientRect();
      ...
      class R extends o.PureComponent {
        ...
        render() {
          ...
          return o.createElement(
            ...
            o.createElement('div', { className: A.pointer, style: { left: 100 * n + '%', top: 100 * (1 - r) + '%' } }),
          );
        }
      }
      var W = n(1369);
        ...
        constructor() {
          super(...arguments),
            ...
            (this._handlePosition = (e) => {
              ...
              if (!o) return;
              const r = (0, l.ensureNotNull)(this._container).getBoundingClientRect();
        ...
        render() {
          ...
          return o.createElement(
            ...
            o.createElement(
              'div',
              { className: z.form },
              o.createElement('div', { className: z.swatch, style: { backgroundColor: e } }),
              o.createElement(
                'div',
              ...
              o.createElement(
                ...
                o.createElement(O.Button, { size: 's', onClick: this._handleAddColor }, Z),
              ),
            ),
            o.createElement(
              'div',
              { className: z.hueSaturationWrap },
              o.createElement(R, { className: z.saturation, hsv: t, onChange: this._handleHSV }),
              o.createElement(q, { className: z.hue, hsv: t, onChange: this._handleHSV }),
            ),
          );
        }
      }
          ...
          m
            ...
            : o.createElement(
                ...
                o.createElement(
                  'div',
                  { ref: f, onKeyDown: b },
                  o.createElement(L, { colors: T.basic, color: t, onSelect: C }),
                  o.createElement(L, { colors: T.extended, color: t, onSelect: C }),
    ...
    54368: (e, t, n) => {
      ...
      class u extends o.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._handleKeyDown = (e) => {
              ...
              37 === t && 0 !== n && this._changeOpacity(n - 1), 39 === t && 100 !== n && this._changeOpacity(n + 1);
            }),
        ...
        render() {
          const { color: e, opacity: t, hideInput: n, disabled: s } = this.props,
    ...
    6914: (e, t, n) => {
      ...
      const r = o.colorsPalette['color-white'],
        ...
        a = [200, 300, 400, 500, 600, 700, 800, 900].map((e) => `color-cold-gray-${e}`);
    ...
    59054: (e, t, n) => {
      ...
      function h(e) {
        const { isDropped: t } = e;
        return o.createElement(u.Icon, { className: s()(d.icon, t && d.dropped), icon: p });
      }
      function m(e) {
      ...
      const g = o.forwardRef((e, t) => {
        const {
          ...
          M = (0, o.useRef)(null),
          O = !d && o.createElement(l.EndSlot, null, o.createElement(m, { isDropped: b, disabled: f, className: P }));
        return o.createElement(c.PopupMenuDisclosureView, {
          ...
          button: o.createElement(i.ControlSkeleton, {
            ...
            middleSlot: o.createElement(
              l.MiddleSlot,
              null,
              o.createElement('span', { className: s()(v['button-children'], d && v.hiddenArrow) }, B),
            ),
            endSlot: O,
          }),
          popupChildren: k,
    ...
    56512: (e, t, n) => {
      ...
      var i = n(24377);
      function l() {
        const [e, t] = (0, o.useState)((0, r.getJSON)('pickerCustomColors', []));
        a('add_new_custom_color', (n) => t(c(n, e))), a('remove_custom_color', (n) => t(u(n, e)));
        const n = (0, o.useCallback)(
            (t) => {
              const n = t ? (0, i.parseRgb)(t) : null;
              e.some((e) => null !== e && null !== n && (0, i.areEqualRgb)((0, i.parseRgb)(e), n)) ||
          ...
          l = (0, o.useCallback)(
            (t) => {
              (t >= 0 || t < e.length) &&
                (s.emit('remove_custom_color', t), (0, r.setJSON)('pickerCustomColors', u(t, e)));
            },
            [e],
          );
        return [e, n, l];
    ...
    90405: (e, t, n) => {
      ...
      function b(e) {
        ...
        const a =
          null !== (n = null !== (t = r.selectedContent) && void 0 !== t ? t : r.content) && void 0 !== n ? n : r.value;
      ...
      const C = o.forwardRef((e, t) => {
        ...
        let { items: R } = e;
        if (x && N) {
          R = [{ value: void 0, content: x, id: (0, r.createDomId)(n, 'placeholder') }, ...R];
        }
        const {
            listboxId: W,
            isOpened: q,
          ...
          ce = (0, o.useMemo)(
            () => ({ role: 'listbox', 'aria-labelledby': T, 'aria-activedescendant': f(n, oe) }),
            [T, oe],
          ),
          ue = (0, o.useCallback)((e) => e.value === I, [I]),
          pe = (0, o.useCallback)((e) => D && D(e.value), [D]),
          de = (0, u.useItemsKeyboardNavigation)(m.isRtl, ne, ue, pe, !1, { next: [40], previous: [38] }),
                  ...
                  (n
                    ...
                    : !e.readonly &&
                      (('string' == typeof e.content && e.content.toLowerCase().startsWith(r)) ||
                        ('string' == typeof e.textContent && e.textContent.toLowerCase().startsWith(r)) ||
        ...
        return o.createElement(
          d.ControlDisclosureView,
          {
            ...
            buttonChildren: o.createElement(b, { selectedItem: oe, placeholder: x }),
            repositionOnScroll: M,
          },
          R.map((e, t) => {
            var r;
            if (e.readonly) return o.createElement(o.Fragment, { key: `readonly_item_${t}` }, e.content);
            const s = f(n, e);
    ...
    76917: (e, t, n) => {
      ...
      var o = n(50959),
        ...
        s = n(44352),
        a = n(36298);
      const i = (0, n(59224).getLogger)('Platform.GUI.StudyInputPropertyContainer'),
      ...
      class u extends o.PureComponent {
        constructor(e) {
          super(e),
            (this._setValue = (e, t, o) => {
              ...
              i.logNormal(`Changing property "${e}" value from "${c.value()}" to "${t}"`);
        ...
        componentDidMount() {
          ...
          e.childNames().forEach((n) => {
            (0, r.ensureDefined)(e.child(n)).subscribe(this, (e) => {
              const o = e.value();
              i.logNormal(`Property "${n}" updated to value "${o}"`), this.setState({ [n]: o }), null == t || t(o, n);
            });
          });
        }
        componentWillUnmount() {
        ...
        render() {
          const { study: e, model: t, children: n } = this.props,
            r = { study: e, model: t, values: this.state, setValue: this._setValue };
    ...
    41594: (e, t, n) => {
      'use strict';
      n.d(t, { StylePropertyContainer: () => a, StylePropertyContext: () => s, bindPropertyContext: () => i });
      var o = n(50959),
        r = n(51717);
      ...
      function i(e, t) {
        return (0, r.bindModel)(
          ({ model: n }) => o.createElement(a, { model: n, property: t.property }, o.createElement(e, { ...t })),
          t,
        );
      }
    },
    ...
    39847: (e, t, n) => {
      ...
      function b(e) {
        return o.createElement('span', { ...(0, c.renameRef)(e), className: r(e.className, g()['no-active-state']) });
      }
      function C(e) {
        const {
            icon: t,
          ...
          I = (function (e) {
            const { tabIndex: t = 0, showTooltip: n, hideTooltip: r, onFocus: s, onBlur: a, onClick: i, ref: c } = e,
              u = l();
            return {
          ...
          })({ showTooltip: v, hideTooltip: C, onFocus: y, onBlur: E, onClick: S, ref: x, tabIndex: w }),
          T = o.useMemo(
            () =>
              (function (e, t) {
        ...
        return o.createElement(
          ...
          o.createElement(a.Icon, { 'aria-hidden': !0, icon: T, className: g().icon }),
        );
      }
      var y = n(38780);
      function E(e) {
    ...
    12949: (e, t, n) => {
      ...
      function E(e) {
        ...
        return r.createElement('div', { className: u(v.inputGroup, n && v.inlineGroup, t) }, e.children);
      }
      var S = n(36565);
      function w(e = '') {
          ...
          if (t && this._isStudy(t) && t.isChildStudy()) {
            ...
            if ((0, M.isStudy)(n)) {
              const t = n.title(T.TitleDisplayTarget.StatusLine),
                r = I.StudyMetaInfo.getChildSourceInputTitles(e, n.metaInfo(), t);
              o = { ...o, ...r };
            }
          }
          if (
            ...
            n.model()
              ...
              .forEach((e) => {
                const t = e.title(T.TitleDisplayTarget.StatusLine, !0, void 0, !0),
                  n = e.id(),
                  r = e.metaInfo(),
                  a = r.styles,
                  i = r.plots || [];
        ...
        _getColorInputWithContext(e) {
          ...
          if ('properties' in i || 'tempProperties' in i) {
            ...
            return r.createElement(
              ...
              { model: a, property: e },
              r.createElement(Z.ColorWithThicknessSelect, { className: p()(s && v.hasTooltip), color: e, disabled: o }),
            );
          }
          return null;
        }
      ...
      const Q = (0, h.bind)(function (e) {
        const { value: t, onChange: n, input: o, tzName: s, hasTooltip: a } = e,
          ...
          d = (0, r.useMemo)(() => (0, j.getChartTimezoneOffsetMs)(u, s), [u, s]),
          h = (0, r.useMemo)(() => {
            const e = new Date(u + d + v(u));
            return e.setSeconds(0), e;
          }, [u, d]),
          m = (0, r.useMemo)(
            () => (0, $.twoDigitsFormat)(h.getHours()) + ':' + (0, $.twoDigitsFormat)(h.getMinutes()),
            [h],
          );
        return r.createElement(
          'div',
      ...
      class J extends r.PureComponent {
        render() {
          const { input: e, disabled: t, onChange: n, tzName: o, hasTooltip: s } = this.props;
          if ((0, a.isStudyInputOptionsInfo)(e))
            return r.createElement(D, { input: e, disabled: t, onChange: n, hasTooltip: s });
          switch (e.type) {
            case 'integer':
              return r.createElement(i.IntegerInput, { input: e, disabled: t, onChange: n, hasTooltip: s });
            case 'float':
            case 'price':
              return r.createElement(l.FloatInput, { input: e, disabled: t, onChange: n, hasTooltip: s });
            case 'bool':
              return r.createElement(c.BoolInput, { input: e, disabled: t, onChange: n, hasTooltip: s });
            case 'text':
              return r.createElement(b, { input: e, disabled: t, onChange: n, hasTooltip: s });
            case 'symbol':
              return r.createElement(C.SymbolInput, { input: e, disabled: t, onChange: n, hasTooltip: s });
            case 'session':
              return r.createElement(x, { input: e, disabled: t, onChange: n, hasTooltip: s });
            case 'source':
              return r.createElement(F, { input: e, disabled: t, onChange: n, hasTooltip: s });
            case 'resolution':
              return r.createElement(U, { input: e, disabled: t, onChange: n, hasTooltip: s });
            case 'time':
              return r.createElement(Q, { input: e, tzName: o, onChange: n, hasTooltip: s });
            case 'color':
              return r.createElement(G, { input: e, disabled: t, onChange: n, hasTooltip: s });
            default:
              return null;
          }
        }
        ...
        render() {
          ...
          return r.createElement(
            ...
            r.createElement(
              ...
              {
                'data-study-input-name': (null == a ? void 0 : a.id) && `${a.id}-label`,
                placement: 'first',
                verticalAlign: c,
                grouped: u,
                offset: h,
              },
              void 0 !== e ? e : o.t((0, s.ensureDefined)(a).name, { context: 'input' }, n(88601)),
            ),
            r.createElement(
              y.PropertyTable.Cell,
              {
                'data-study-input-name': (null == a ? void 0 : a.id) && `${a.id}-input`,
                placement: 'last',
                grouped: u,
              },
              t || r.createElement(J, { input: (0, s.ensureDefined)(a), onChange: l, disabled: i, hasTooltip: m }),
              m && r.createElement(te.IconGroupWrapper, null, p && r.createElement(ee.InputTooltip, { title: p }), !1),
            ),
          );
        }
      }
    ...
    39828: (e, t, n) => {
      ...
      const m = (0, c.makeSwitchGroupItem)(
        (((o = class extends r.PureComponent {
          ...
          render() {
            const e = u(this.props.className, h().radio, { [h().reverse]: Boolean(this.props.labelPositionReverse) }),
              t = u(h().label, { [h().disabled]: this.props.disabled }),
              n = u(h().box, { [h().noOutline]: -1 === this.props.tabIndex });
            let o = null;
            return (
              this.props.label && (o = r.createElement('span', { className: t }, this.props.label)),
              r.createElement(
                'label',
                { className: e },
                r.createElement(
      ...
      var v = n(55141),
        ...
        C = n(27698);
      function y(e) {
        const { children: t, input: o, disabled: u, onChange: p, grouped: d, tooltip: h, solutionId: y } = e,
              ...
              onChange: function (e) {
                N(e),
                  'main-symbol' === e
                    ...
                    : 'another-symbol' === e && I && (0, g.setter)(w, p)(I, o.id, o.name);
              },
            },
            r.createElement(
              l.PropertyTable.Row,
              ...
              r.createElement(
                ...
                r.createElement(m, {
                  ...
                  disabled: u,
                  label: r.createElement('span', { className: C.label }, a.t(null, { context: 'input' }, n(88046))),
                }),
              ),
            ),
            r.createElement(
              ...
              r.createElement(
                l.PropertyTable.Cell,
                {
                  placement: 'first',
                  grouped: d,
                  'data-study-input-name': (null == o ? void 0 : o.id) && `${o.id}-another-symbol-label`,
                },
                r.createElement(m, {
                  value: 'another-symbol',
                  className: C.checkbox,
                  disabled: u,
                  label: r.createElement('span', { className: C.label }, a.t(null, { context: 'input' }, n(73755))),
                }),
              ),
              r.createElement(
                l.PropertyTable.Cell,
                {
                  placement: 'last',
                  grouped: d,
                  'data-study-input-name': (null == o ? void 0 : o.id) && `${o.id}-another-symbol-input`,
                },
                t ||
                ...
                B && r.createElement(b.IconGroupWrapper, null, h && r.createElement(f.InputTooltip, { title: h }), !1),
              ),
            ),
          )
        );
        ...
        render() {
          ...
          return r.createElement(
            ...
            r.createElement(
              ...
              r.createElement(E.BoolInput, { label: e, input: t, hasTooltip: s }),
              s && r.createElement(b.IconGroupWrapper, null, n && r.createElement(f.InputTooltip, { title: n }), !1),
            ),
          );
        }
      }
        ...
        return r.createElement(
          ...
          r.createElement(
            ...
            r.createElement(
              ...
              r.createElement('span', { className: p()(k.label, a && k.hasTooltip) }, n),
              a && r.createElement(b.IconGroupWrapper, null, o && r.createElement(f.InputTooltip, { title: o }), !1),
            ),
          ...
          r.createElement(
            ...
            t.children.map(
              (e, o) => (
                ...
                r.createElement(D, { key: e.id, input: e, tooltip: o === t.children.length - 1 ? n : void 0 })
              ),
            ),
          ),
        );
            ...
            : r.createElement(
                ...
                t.children.map((e) =>
                  (0, F.isGroup)(e)
                    ...
                    : r.createElement(D, { key: e.id, input: e, tooltip: e.tooltip, solutionId: e.solutionId }),
                ),
                r.createElement('div', { className: V.groupFooter }),
              )
          : r.createElement(D, { input: t, tooltip: t.tooltip, solutionId: t.solutionId });
      }
      ...
      class W extends r.PureComponent {
        render() {
          ...
          return r.createElement(
            ...
            r.createElement(q, { study: o, model: i, property: n.inputs, inputs: t, onStudyInputChange: c }),
            ...
            d &&
              d.childNames().map((e) => {
                ...
                return this._createOffsetSection(
                  n,
                  (0, s.ensureDefined)(null === (t = a.offsets) || void 0 === t ? void 0 : t[e]),
                );
              }),
          );
        }
      ...
      function q(e) {
        const { study: t, model: n, inputs: o, property: s, onStudyInputChange: a } = e,
          l = o,
        ...
        return r.createElement(
          ...
          !1,
          !1,
          c.map((e) => r.createElement(r.Fragment, { key: e.id }, r.createElement(A, { content: e }), !1)),
        );
      }
      function z(e, t) {
        return { id: 'val', name: t.title || R.offset, defval: e.val.value(), type: 'integer', min: t.min, max: t.max };
      }
    },
    4781: (e, t, n) => {
      'use strict';
                ...
                r
                  ? (clearTimeout(this._timeout),
                    this.setState({ value: e }, () => {
                      r !== 1 / 0 && (this._timeout = setTimeout(() => this._flush(), r));
                    }))
                  : this._flush(e);
              }),
              (this._onBlur = () => {
    ...
    95052: (e, t, n) => {
      ...
      class f extends o.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._onBlur = (e) => {
              this.setState({ focused: !1 }),
                !1 !== this.props.shouldApplyValueOnBlur &&
                  (this.setState({ displayValue: b(this.props, this.props.value) }),
            ...
            (this._onValueByStepChange = (e) => {
              const { roundByStep: t = !0, step: n = 1, uiStep: o, min: r = n, formatter: s } = this.props,
              ...
              if (i.res) {
                const o = new a.Big(i.value),
                  s = o.minus(r).mod(n);
                let u = o.plus(e * l);
                !s.eq(0) && t && (u = u.plus((e > 0 ? 0 : 1) * l).minus(s)), (c = u.toNumber());
              }
              const { isPassed: u, clampedValue: p } = this._checkValueBoundaries(c);
              (c = u ? c : p),
          ...
          const { value: t } = e;
          this.state = { value: t, displayValue: b(e, t), focused: !1, errorMsg: h };
        }
        render() {
          var e;
          return o.createElement(l.NumberInputView, {
            id: this.props.id,
            inputMode:
              null !== (e = this.props.inputMode) && void 0 !== e ? e : i.CheckMobile.iOS() ? void 0 : 'numeric',
        ...
        static getDerivedStateFromProps(e, t) {
          ...
          return (t.focused && !n) || t.value === o ? null : { value: o, displayValue: b(e, o) };
        }
        _checkValueBoundaries(e) {
          ...
          const { min: i = -1 / 0, max: l = g } = this.props,
            c = (function (e, t, n) {
              const o = e >= t,
                r = e <= n;
              return { passMin: o, passMax: r, pass: o && r, clamped: (0, d.clamp)(e, t, n) };
            })(e, i, l);
          let u;
          return (
            c.passMax ||
              (u =
                null !==
                  (o = null === (t = this.props.boundariesErrorMessages) || void 0 === t ? void 0 : t.greaterThanMax) &&
                void 0 !== o
                  ? o
            ...
            c.passMin ||
              (u =
                null !==
                  (a = null === (r = this.props.boundariesErrorMessages) || void 0 === r ? void 0 : r.lessThanMin) &&
                void 0 !== a
                  ? a
    ...
    55141: (e, t, n) => {
      ...
      const p = (0, a.bind)(function (e) {
        ...
        return o.createElement(l.SymbolInputsButton, { ...e, value: u(i || a || '', n), study: n });
      });
    },
    41552: (e, t, n) => {
      'use strict';
      ...
      var o = n(50959),
        ...
        u = n(17948),
        p = n(51768);
      const d = new a.TranslatedString('change thickness', s.t(null, void 0, n(95657))),
        ...
        constructor() {
          super(...arguments),
            ...
            (this._onOpacityChange = (e) => {
              ...
              this._setProperty(t, (0, i.generateColor)(n, (0, i.alphaToTransparency)(e), !0), m);
            }),
            (this._onPopupClose = () => {
              this._trackEventLabel &&
                ((0, p.trackEvent)('GUI', 'Study settings', this._trackEventLabel), (this._trackEventLabel = null));
            });
        }
        componentWillUnmount() {
          this._onPopupClose();
    ...
    11062: (e, t, n) => {
      ...
      class l extends o.PureComponent {
        render() {
          return o.createElement(
            'div',
            { ref: this.props.reference, className: r(a.content, this.props.className) },
            this.props.children,
          );
        }
      }
      (l.InlineRowContext = i),
        ...
        (l.Cell = function (e) {
          ...
          return o.createElement(
            'div',
            { ...l, className: n },
            o.createElement('div', { className: r(a.inner, e.className) }, e.children),
          );
        }),
        (l.Separator = function (e) {
          return o.createElement(l.Row, null, o.createElement('div', { className: r(a.cell, a.separator, a.fill) }));
        }),
        (l.GroupSeparator = function (e) {
          ...
          return o.createElement(
            l.Row,
            null,
            o.createElement('div', { className: r(a.cell, a.groupSeparator, a.fill, 1 === t && a.big) }),
          );
        });
    },
    17948: (e, t, n) => {
