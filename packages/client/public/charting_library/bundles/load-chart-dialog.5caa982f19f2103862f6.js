    ...
    76068: (e, t, n) => {
      ...
      function r(e) {
        ...
        return (0, o.isCircleLogoWithUrlProps)(e)
          ...
          : a.createElement(
              'span',
              { className: r, title: e.title, 'aria-label': e['aria-label'], 'aria-hidden': e['aria-hidden'] },
              e.placeholderLetter,
            );
      }
    },
            ...
            return (
              n.forEach((e) => {
                ...
                if (((h.lastIndex = 0), (0, a.isString)(t) && t && t.toLowerCase() === o.toLowerCase()))
                  return (d = 4), void (m = null === (n = t.match(f)) || void 0 === n ? void 0 : n.index);
                if ((0, a.isString)(t) && f.test(t))
                  return (d = 3), void (m = null === (i = t.match(f)) || void 0 === i ? void 0 : i.index);
                if ((0, a.isString)(r) && f.test(r))
                  return (d = 2), void (m = null === (l = r.match(f)) || void 0 === l ? void 0 : l.index);
                if ((0, a.isString)(r) && h.test(r))
                  return (d = 2), void (m = null === (s = r.match(h)) || void 0 === s ? void 0 : s.index);
                if (Array.isArray(u))
                  for (const e of u)
                    if (f.test(e))
                      return (d = 1), void (m = null === (c = e.match(f)) || void 0 === c ? void 0 : c.index);
              }),
      ...
      function d(e) {
        ...
        return a.createElement(
          Y,
          {
            ...
            'aria-selected': d,
            'aria-checked': h,
            className: o(f, R.item, b && R.withIcon, { [R.isActive]: C, [R.isDisabled]: w || L, [R.hovered]: k }),
            title: g,
            href: D,
            target: A,
            rel: N,
          ...
          (void 0 !== v || _) &&
            a.createElement('span', { className: R.shortcut }, (J = v) && J.split('+').join(' + ')),
          void 0 !== M &&
            a.createElement(
              'span',
              { onClick: Z ? m : void 0, className: o(R.toolbox, { [R.showOnHover]: S, [R.showOnFocus]: x }) },
              M,
            ),
        );
        var J;
    ...
    12811: (e, t, n) => {
      ...
      function c(e, t) {
        return (n, c, u, m) => {
          ...
          let b = null !== (d = t.verticalAttachEdge) && void 0 !== d ? d : s.verticalAttachEdge,
          ...
          const w = b === a.Top ? -1 * v : v,
            ...
            E = { x: k - (y === i.FromRightToLeft ? n : 0) + p, y: L - (C === r.FromBottomToTop ? c : 0) + w };
    ...
    34557: (e, t, n) => {
      ...
      function T(e) {
        ...
        return (
          ...
          a.createElement(
            'div',
            { ...('overlay' === s && f), className: i()(z.container, t), onTouchStart: o, onScrollCapture: n, ref: m },
      ...
      function J(e) {
        ...
        return (
          ...
          a.createElement(Z.DialogContentItem, {
            url: _,
            title: a.createElement(W.HighlightedText, { className: k, queryString: m, rules: w, text: t.title }),
            subtitle: a.createElement(
              a.Fragment,
              null,
              a.createElement(W.HighlightedText, { className: k, queryString: m, rules: w, text: t.description }),
              ' ',
              '(',
      ...
      function ae(e) {
        const { charts: t, onClose: o, favoriteChartsService: r, chartWidgetCollection: d } = e,
          ...
          [S, x] = (0, a.useState)(() => c.getJSON('loadChartDialog.viewState', Q)),
          A = (0, a.useRef)(null),
          N = (0, a.useRef)(null),
        ...
        return a.createElement(m.AdaptivePopupDialog, {
          ...
          render: function () {
            return a.createElement(
              a.Fragment,
              null,
              a.createElement(w.DialogSearch, { reference: A, onChange: B, placeholder: s.t(null, void 0, n(52298)) }),
              a.createElement(
                L,
        ...
        function V(e, t) {
          ...
          x(n), c.setValue('loadChartDialog.viewState', JSON.stringify(n), { forceFlush: !0 }), O();
        }
      }
      var oe = n(85067);
