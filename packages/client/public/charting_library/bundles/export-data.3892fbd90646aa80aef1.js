    ...
    50210: (e, t, i) => {
      ...
      function h(e, t = {}) {
              ...
              for (let e = 0; e < t.length; e++) {
                const l = t[e],
                  o = s.includeOffsetStudyValues
                    ? (0, c.max)(
                        null !== (r = null === (n = i[e]) || void 0 === n ? void 0 : n.fieldPlotOffsets) && void 0 !== r
                          ? r
                          : [0],
                      )
                    : 0,
        ...
        for (let e = P; e <= S; ++e) {
          ...
          e.fill(NaN), s.data.push(e), i.includeDisplayedValues && s.displayedData.push(new Array(D).fill(''));
        }
        if (i.includeTime || i.includeUserTime) {
          ...
          for (let e = P; e <= S; ++e) {
            ...
            if (
              ...
              const l = t.format(r);
              i.includeTime && (s.displayedData[e - P][0] = l), i.includeUserTime && (s.displayedData[e - P][I] = l);
            }
          }
        }
        if (i.includeSeries) {
      ...
      function p(e) {
        ...
        for (let n = 0; n < t.plots.length; ++n) {
          ...
          let d,
            f = '';
          if ((0, r.isLinePlot)(c) || (0, r.isShapesPlot)(c) || (0, r.isCharsPlot)(c) || (0, r.isArrowsPlot)(c))
          ...
          const h = `${d.title}${f}`;
          o.fields.push(T(a, u, h)), o.fieldToPlotIndex.push(n + 1), o.fieldPlotOffsets.push(e.offset(c.id));
        }
        return o;
      }
      function T(e, t, i) {
