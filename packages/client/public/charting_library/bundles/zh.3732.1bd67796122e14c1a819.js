  ...
  [3732],
  {
    ...
    68716: (t) => {
      (t.exports = Object.create(null)),
        ...
        (t.exports['Diluted net income available to common stockholders_study'] = ['普通股股东可获得的稀释净收入']),
        ...
        (t.exports['Short term debt excl. current portion of LT debt_study'] = ['短期债务不包括一年内到期之长期负债']),
        ...
        (t.exports['Arnaud Legoux Moving Average_study'] = ['阿诺勒古移动平均线(Arnaud Legoux Moving Average)']),
        ...
        (t.exports['Least Squares Moving Average_study'] = ['最小二乘移动平均线(Least Squares Moving Average)']),
        ...
        (t.exports['SMI Ergodic Indicator/Oscillator_study'] = ['SMI 遍历性指标(SMI Ergodic Indicator/Oscillator)']),
        ...
        (t.exports['Bollinger Bands Strategy directed_study'] = ['布林带定向策略(Bollinger Bands Strategy directed)']),
        ...
        (t.exports['Volty Expan Close Strategy_study'] = ['Volty EXPAN Close 策略(Volty Expan Close Strategy)']),
