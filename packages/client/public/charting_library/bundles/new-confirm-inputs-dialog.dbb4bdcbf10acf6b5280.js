(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [3030],
  {
    ...
    29638: (t, e, i) => {
      ...
      function d(t) {
        ...
        function C() {
          ...
          for (const e of r) if ('symbol' === e.type && !e.optional && '' === t[e.id]) return !0;
          return !1;
        }
        function M(t, e) {
          null == I || I(t, e), b(C());
      ...
      async function u(t, e, n, u, c) {
          ...
          if ((0, s.isGroup)(t))
            if ((0, s.isInputInlines)(t)) {
              const e = (function (t) {
                ...
                return 'price' === t[0].type ? { price: t[0], time: t[1] } : { price: t[1], time: t[0] };
              })(t.children);
              if (e) {
                const { time: r, price: n } = e,
                  s = r.inline
                    ? o.t(null, { replace: { inputInline: r.inline, studyShortDescription: u } }, i(59877))
                    : o.t(null, { replace: { studyShortDescription: u } }, i(80481)),
                  p = y(t.id);
        ...
        async function d(t) {
          const e = 'time' === t.type,
            ...
            n = (function () {
              ...
              const r = t.name
                  ? o.t(null, { replace: { inputTitle: t.name, studyShortDescription: u } }, i(18571))
                  : o.t(null, { replace: { studyShortDescription: u } }, i(42917)),
                n = t.name
                  ? o.t(null, { replace: { inputTitle: t.name, studyShortDescription: u } }, i(58552))
        ...
        async function S(e, i, o, s, u) {
          const c = await t.requestSelectPoint(
            { pointType: i, pane: a, lineColor: void 0, selectPointMode: p.SelectPointMode.Study },
            o,
          );
          void 0 === a && (a = c.pane);
          const l = n.childs().inputs;
          l &&
            (s && (0, r.ensureDefined)(l.child(s)).setValue(1e3 * (c.point.time || 0)),
    ...
    64420: (t, e, i) => {
      'use strict';
      i.d(e, { getInputGroups: () => s, isGroup: () => n, isInputInlines: () => o });
      var r = i(50151);
      function n(t) {
              ...
              if (void 0 !== o)
                if (void 0 !== s)
                  if (i.has(o)) {
                    ...
                    let u;
                    n.has(e) ? (u = (0, r.ensureDefined)(n.get(e))) : ((u = new Map()), n.set(e, u)),
