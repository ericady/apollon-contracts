  ...
  [3016],
  {
    ...
    63016: (t, e, i) => {
      ...
      class d extends s.PureComponent {
        ...
        render() {
          const {
            ...
            g = this.props.style ? { ...this._createStyles(), ...this.props.style } : this._createStyles();
          return s.createElement(
            ...
            s.createElement(
              ...
              { value: this._manager },
              d && s.createElement('div', { onClick: this.props.onClickBackdrop, className: h.backdrop }),
              s.createElement(
                'div',
                {
                  ...p,
        ...
        _createStyles() {
          const { bottom: t, left: e, width: i, right: s, top: o, zIndex: n, height: a } = this.props;
        ...
        recalculateBounds() {
          ...
          if (this._isFullscreen) {
            if (
              ...
              (this._dialog.style.transform = `translate(${Math.round(t)}px, ${Math.round(e)}px)`),
                i && ((this._dialog.style.width = `${i}px`), (this._dialog.style.minWidth = 'unset')),
                s && ((this._dialog.style.height = `${s}px`), (this._dialog.style.minHeight = 'unset'));
            }
          } else if (o) {
        ...
        componentWillUnmount() {
          ...
          if (
            ...
            (null === document.activeElement ||
              ...
              (null === (t = this._dialog) || void 0 === t ? void 0 : t.contains(document.activeElement)))
          )
            try {
      ...
      (M.contextType = E.PortalContext),
        (M.defaultProps = { boundByScreen: !0, draggable: !0, centeredOnMount: !0, shouldReturnFocus: !0 });
