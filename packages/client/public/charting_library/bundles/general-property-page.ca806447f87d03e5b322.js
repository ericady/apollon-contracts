  ...
  [3596],
  {
    73023: (e, t, i) => {
      ...
      var o = i(50151),
        ...
        P = i(18611),
        f = i(97906);
      const b = new v.TranslatedString('change symbol description visibility', r.t(null, void 0, i(26717))),
      ...
      const K = n.enabled('show_average_close_price_line_and_label'),
        ...
        $ =
          (new v.TranslatedString('change symbol previous close value visibility', r.t(null, void 0, i(12707))),
          new v.TranslatedString('change bid and ask labels visibility', r.t(null, void 0, i(5100))),
          new v.TranslatedString('change pre/post market price label visibility', r.t(null, void 0, i(49889))),
          new v.TranslatedString('change high and low price labels visibility', r.t(null, void 0, i(66805)))),
        ...
        te =
          ...
          new v.TranslatedString('change indicators name labels visibility', r.t(null, void 0, i(87027)))),
        ie =
          (new v.TranslatedString(
            'change indicators and financials value labels visibility',
            r.t(null, void 0, i(90512)),
          ),
          new v.TranslatedString('change indicators value labels visibility', r.t(null, void 0, i(14922)))),
        ...
        Re =
          ...
          [
            { value: z.PriceAxisLastValueMode.LastPriceAndPercentageValue, title: r.t(null, void 0, i(76523)) },
            { value: z.PriceAxisLastValueMode.LastValueAccordingToScale, title: r.t(null, void 0, i(80170)) },
          ]);
      var Ge = i(48686),
        Ae = i(3347),
        He = i(43715);
      const Fe = new v.TranslatedString('change sessions breaks visibility', r.t(null, void 0, i(71589))),
      ...
      const je = new v.TranslatedString('change chart background color', r.t(null, void 0, i(99011))),
      ...
      function kt(e, t, o, s, c, d, u, h, p, v) {
        ...
        g.push(w, D);
        {
          const t = (function (e) {
            const t = e
                ...
                .vertlines.childs()
                .sessBreaks.childs(),
              i = (0, Ge.combineProperty)((e) => !e, e.mainSeries().isDWMProperty().weakReference());
        ...
        const x = (0, a.createOptionsPropertyDefinition)(
            ...
            { id: 'navButtons', title: mt, options: new l.WatchedValue(d.values) },
          ),
          M = (0, a.createOptionsPropertyDefinition)(
            { option: (0, a.convertToDefinitionProperty)(e, u.property, rt) },
            { id: 'paneButtons', title: wt, options: new l.WatchedValue(u.values) },
          );
        f.push(x, M);
        ...
        if ((b.push(O, R), n.enabled('chart_property_page_right_margin_editor'))) {
          const t = { value: (0, a.convertFromWVToDefinitionProperty)(e, c.value, at, [U.floor]) },
            i = {
              type: 0,
              id: 'paneRightMargin',
              title: Dt,
          ...
          if (n.enabled('show_percent_option_for_right_margin')) {
            const o = (0, a.createNumberPropertyDefinition)(
                { ...t, checked: (0, a.convertFromWVToDefinitionProperty)(e, p, st, [(e) => !e, (e) => !e]) },
                { ...i, title: Tt },
              ),
              r = (0, a.createNumberPropertyDefinition)(
                {
        ...
        const G = [
          ...
          (0, a.createPropertyDefinitionsGeneralGroup)(P, 'scalesAppearanceGroup', r.t(null, void 0, i(43115))),
          (0, a.createPropertyDefinitionsGeneralGroup)(f, 'buttonsAppearanceGroup', r.t(null, void 0, i(87845))),
          (0, a.createPropertyDefinitionsGeneralGroup)(b, 'marginsAppearanceGroup', r.t(null, void 0, i(66653))),
        ];
        return (
          m.length > 0 &&
            G.push(
      ...
      const Ut = {
        ...
        Qt =
          ...
          !1);
      const Xt = [
        { id: 'symbol-text-source-description', value: 'description', title: r.t(null, void 0, i(29601)) },
      ...
      class Yt {
        constructor(e, t, i) {
          ...
          (this._gridColorsVisibilities = {
            gridLinesMode: r,
            vertLinesVisible: (0, f.combine)((e) => 'both' === e || 'vert' === e, r.weakReference()),
            horzLinesVisible: (0, f.combine)((e) => 'both' === e || 'horz' === e, r.weakReference()),
          }),
        ...
        destroy() {
          ...
          (0, o.ensureNotNull)(this._model.timeScale()).maxRightOffsetChanged().unsubscribeAll(this),
        ...
        _createLegendPropertyPage() {
          const e = this._chartWidgetProperties.childs().paneProperties.childs().legendProperties.childs(),
            t = { property: this._series.properties().childs().statusViewStyle.childs().symbolTextSource, values: Xt },
            o = (function (e, t, o, n, s) {
              ...
              const u = (0, a.createOptionsPropertyDefinition)(
                ...
                { id: 'symbolTextSource', title: M, options: new l.WatchedValue(o.values) },
              );
              if ((d.push(u), null !== n)) {
                const t = (0, f.combineWithFilteredUpdate)(
                    (t, i) => 'market' === t && !(0, g.isEconomicSymbol)(e.mainSeries().symbolInfo()),
                    (e, t) => null !== e,
                ...
                J = (0, y.createWVFromGetterAndSubscription)(
                  () =>
                    e
                      .model()
                      .priceDataSources()
                      .some((e) => !(0, P.isActingAsSymbolSource)(e) && e.showInObjectTree()),
              ...
              return (
                K.push(Q),
                c.push((0, a.createPropertyDefinitionsGeneralGroup)(K, 'generalLegendGroup')),
                { definitions: c }
              );
        ...
        _createScalesDefinitions() {
          const e = this._chartWidgetProperties.childs().scalesProperties.childs(),
            t = {
              ...
              values: (0, u.allPriceScaleSelectionStrategyInfo)().map((e) => ({ value: e.name, title: e.title })),
            };
          null === this._availableDateFormatValues &&
            (this._availableDateFormatValues = new l.WatchedValue(
              (function (e = !1) {
                ...
                return Lt.availableDateFormats.map((i) => ({ value: i, title: new xt.DateFormatter(i, e).format(t) }));
              })(),
            ).spawn());
          const o = { property: Wt.dateFormatProperty, values: this._availableDateFormatValues },
            s = {
          ...
          return (function (e, t, i, o) {
            ...
            if (o.seriesHasClosePrice) {
              const t = (0, a.createCheckablePropertyDefinition)(
                ...
                o = (0, a.createOptionsPropertyDefinition)(
                  ...
                  { id: 'symbolLastValueLabel', title: ge, options: new l.WatchedValue(Re) },
                );
              c.push(t, o);
            }
            ...
            if (
              (c.push(v),
              s.push((0, a.createPropertyDefinitionsGeneralGroup)(c, 'scalesLabelsGroup', we)),
              o.countdownEnabled)
            ) {
              const i = (0, a.createCheckablePropertyDefinition)(
            ...
            if (o.currencyConversionEnabled || o.unitConversionEnabled) {
              const t =
                  o.currencyConversionEnabled && o.unitConversionEnabled ? Ve : o.currencyConversionEnabled ? _e : De,
                i = o.currencyConversionEnabled && o.unitConversionEnabled ? se : o.currencyConversionEnabled ? ne : ae,
                r = (0, a.createOptionsPropertyDefinition)(
                  { option: (0, a.convertToDefinitionProperty)(e, (0, q.currencyUnitVisibilityProperty)(), i) },
                  {
            ...
            const g = (0, a.createOptionsPropertyDefinition)(
              ...
              f = (0, a.createNumberPropertyDefinition)(
                {
                  ...
                  value: (0, a.getScaleRatioDefinitionProperty)(e, o.mainSeriesScaleRatioProperty, ue, [
              ...
              b = (0, a.createOptionsPropertyDefinition)(
                ...
                { id: 'scalesPlacement', title: ke, options: new l.WatchedValue(o.scalesPlacementPropertyObj.values) },
              );
            if (
              (d.push(g, f, b),
              s.push((0, a.createPropertyDefinitionsGeneralGroup)(d, 'scalesPriceScaleGroup', We)),
              ...
              const t = (0, a.createOptionsPropertyDefinition)(
                ...
                { id: 'dateFormat', title: xe, options: o.dateFormatPropertyObj.values },
              );
              u.push(t);
            }
            if (n.enabled('scales_time_hours_format')) {
              const t = (0, a.createOptionsPropertyDefinition)(
                ...
                { id: 'timeHoursFormat', title: Me, options: new l.WatchedValue(o.timeHoursFormatPropertyObj.values) },
              );
              u.push(t);
            }
            return (
              u.length > 0 && s.push((0, a.createPropertyDefinitionsGeneralGroup)(u, 'scalesTimeScaleGroup', Oe)),
              { definitions: s }
            );
