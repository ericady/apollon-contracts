  ...
  [9374],
  {
    ...
    967: (e, t, r) => {
      ...
      const i = {
        ...
        a = {
          ...
          [n.WeekDays.WEDNESDAY]: o.t(null, { context: 'day_of_week' }, r(26230)),
          [n.WeekDays.THURSDAY]: o.t(null, { context: 'day_of_week' }, r(24793)),
          [n.WeekDays.FRIDAY]: o.t(null, { context: 'day_of_week' }, r(19801)),
          [n.WeekDays.SATURDAY]: o.t(null, { context: 'day_of_week' }, r(63331)),
        };
    },
    99054: (e, t, r) => {
      'use strict';
      ...
      const o = (() => {
        ...
        return () => {
          ...
          if (void 0 === e) {
            ...
            null === (t = r.parentNode) || void 0 === t || t.removeChild(r), (e = n - a);
          }
          return e;
        };
      })();
      ...
      function u(e) {
        ...
        if (e && 1 == ++s) {
          ...
          'hidden' !== e.toLowerCase() &&
            ...
            (n(r, 'right', `${o()}px`), (t.style.paddingRight = `${s + o()}px`), (l = !0)),
    ...
    95257: (e, t) => {
      ...
      function L(e, t, n, i, a) {
        ...
        if (((l = 0), (i = '' === i ? '.' : i + ':'), k(e)))
          ...
          for (e = c.call(e), u = 0; !(s = e.next()).done; ) l += L((s = s.value), t, n, (c = i + I(s, u++)), a);
        else if ('object' === s)
          throw (
            ((t = String(e)),
            Error(
      ...
      (t.Children = {
        ...
        (t.cloneElement = function (e, t, o) {
          ...
          if (null != t) {
            ...
            for (u in t) D.call(t, u) && !T.hasOwnProperty(u) && (n[u] = void 0 === t[u] && void 0 !== l ? l[u] : t[u]);
          }
    ...
    18510: (e, t, r) => {
      ...
      var f = r(42960),
        ...
        g = r(9745);
      function T(e) {
        const t = e.hideIcon ? null : n.createElement(g.Icon, { className: k.close, icon: D, onClick: e.onClose });
        return n.createElement(
          'div',
          { className: b(k.header, e.className), 'data-dragg-area': !0, ref: e.reference },
          e.children,
          t,
        );
      }
      ...
      var M = r(71425);
      function z(e) {
        return n.createElement('div', { className: b(M.body, e.className), ref: e.reference }, e.children);
      }
      r(36383), r(23455);
      var E = r(9481),
        I = r(76422),
      ...
      class N extends n.PureComponent {
        ...
        render() {
          return n.createElement(
            S.PopupDialog,
            { className: x.popupDialog, isOpened: this.props.isOpened, onClickOutside: this.props.onClose },
            n.createElement(T, { onClose: this.props.onClose }, l.t(null, void 0, r(12014))),
            n.createElement(
              z,
              null,
              n.createElement(E.KeyboardDocumentListener, { keyCode: 27, handler: this.props.onClose }),
              n.createElement(
                'div',
                  ...
                  n.createElement(
                    ...
                    n.createElement(
                      ...
                      (function (e) {
                        ...
                        if (e.setHtml) return n.createElement('span', { dangerouslySetInnerHTML: { __html: t } });
                        return t;
                      })(e),
                    ),
                  ),
      ...
      let Y = null;
      const j = [d.MONDAY, d.TUESDAY, d.WEDNESDAY, d.THURSDAY, d.FRIDAY, d.SATURDAY, d.SUNDAY],
      ...
      function F(e) {
        ...
        if (n && o && t)
          return i
            ? l.t(
                null,
                { context: 'double fractional tick size', replace: { minmove2: String(i), pricescale: String(o / i) } },
                r(72653),
              )
            : `${t}/${o}`;
      ...
      function K(e) {
        ...
        return null !==
          (o =
            null !== (r = null === (t = e.source2) || void 0 === t ? void 0 : t.description) && void 0 !== r
              ? r
              : e.source) && void 0 !== o
          ? o
          : null;
      ...
      function G(e, t) {
        Q({ isOpened: !1, onClose: () => {}, fields: [] }), null === e && (e = s.linking.symbol.value()), (e += '');
        const n = t && t.symbolInfo,
          a = [
            ...
            { title: l.t(null, void 0, r(22992)), propName: 'front_contract', visibility: J },
            { title: l.t(null, void 0, r(64659)), propName: 'pointvalue' },
            { title: l.t(null, void 0, r(77295)), propName: 'exchange', visibility: V },
            { title: l.t(null, void 0, r(91617)), propName: 'listed_exchange', visibility: V },
            { title: l.t(null, void 0, r(46147)), propName: 'source', getter: K, visibility: Z },
            {
            ...
            },
            {
              ...
              visibility: (e) => Boolean((0, f.measureUnitId)(e)) && (0, f.isMeasureUnitSymbol)(e) && t.showUnit,
              formatter: (e) => (null != e ? e : ''),
              defValue: '',
            },
            {
              ...
              visibility: (e) => Boolean((0, f.symbolOriginalUnit)(e, t.showUnit)) && !(0, f.isMeasureUnitSymbol)(e),
              formatter: (e) => (null != e ? e : ''),
              defValue: '',
            },
            { title: l.t(null, void 0, r(45221)), propName: 'pip_size', getter: R, visibility: O },
            { title: l.t(null, void 0, r(55209)), propName: 'tick_size', getter: F },
            { title: l.t(null, void 0, r(31672)), propName: 'sector' },
            { title: l.t(null, void 0, r(91746)), propName: 'industry' },
            { title: l.t(null, void 0, r(87492)), propName: 'timezone', formatter: W.timezoneTitle, visibility: P },
            {
        ...
        if (c && c.length > 0) for (const e of c) a.push({ title: e.title, propName: e.propertyName });
        const d = n ? te(n, a) : 0,
          h = {
            isOpened: !0,
            onClose: () => {
