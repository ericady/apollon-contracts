    ...
    99054: (e, t, r) => {
      ...
      function l(e) {
        ...
        if (e && 1 == ++a) {
          ...
          i(r, 'right', '0px');
          let e = 0;
          0, t.scrollHeight <= t.clientHeight && (e -= o()), (t.style.paddingRight = (e < 0 ? 0 : e) + 'px'), (c = !1);
        }
      }
    },
    89324: (e, t, r) => {
      ...
      function c(e) {
        const t = (0, s.getSymbolSearchCompleteOverrideFunction)(),
          { defaultValue: r, showSpreadActions: a, source: c, onSearchComplete: l, ...d } = e,
          h = {
            ...d,
      ...
      const l = { SymbolSearchWatchlistDialogContentItem: null, SymbolSearchWatchlistDialog: null };
    },
    1861: (e, t, r) => {
      'use strict';
      ...
      function c(e) {
        ...
        if (n.dialogsOpenerManager.isOpened('SymbolSearch') || n.dialogsOpenerManager.isOpened('ChangeIntervalDialog'))
          return;
        ...
        return i.render(T, L), n.dialogsOpenerManager.setAsOpened('SymbolSearch'), b && b(), { close: N };
      }
    },
    51826: (e, t, r) => {
      'use strict';
