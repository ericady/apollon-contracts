  ...
  [6780],
  {
    ...
    50945: (e, t, i) => {
      ...
      class p extends a.PureComponent {
        ...
        _getPlaceHolderItem(e) {
          return e ? a.createElement(r.Icon, { className: u.defaultsButtonIcon, icon: d }) : h.defaults;
        }
      }
    },
    48531: (e, t, i) => {
      ...
      function g(e) {
        ...
        return a.createElement(
          ...
          a.createElement(h.PopupMenuItem, {
            ...
            label: t,
            onClick: o,
            toolbox: i && a.createElement(p.RemoveButton, { hidden: !_.mobiletouch && !n, onClick: c }),
          }),
        );
      }
      function f(e) {
          ...
          a.createElement(
            ...
            t &&
              a.createElement(
                o.PropertyTable,
                { reference: i, key: c },
                t.definitions.value().map((e) => a.createElement(l.Section, { key: e.id, definition: e })),
              ),
          ),
        );
      }
    ...
    75892: (e, t, i) => {
      ...
      var a = i(50959),
        ...
        x = i(14483),
        C = i(55309);
      const L = new z.TranslatedString('change {sourceTitle} title to {newSourceTitle}', d.t(null, void 0, i(40001)));
      class E extends a.PureComponent {
        constructor(e) {
            ...
            (this._renderFooterLeft = () => {
              ...
              return (0, f.isLineTool)(e)
                ...
                : a.createElement(
                    ...
                    (i) =>
                      (0, v.isStudy)(e) &&
                      a.createElement(b.StudyDefaultsManager, { model: t, source: e, mode: i ? 'compact' : 'normal' }),
                  );
            }),
            (this._subscribe = (e) => {
          ...
          const { pages: t } = this.props;
          let i;
          if (this._getActionPageById(this.props.activePageId)) i = (0, r.ensureDefined)(this.props.activePageId);
          else {
        ...
        const {
          ...
          k = !!(
            ...
            f.every((e) => {
              ...
              return (
                (null == S ? void 0 : S.id) ===
                (null === (t = b.model().lineToolsGroupModel().groupForLineTool(e)) || void 0 === t ? void 0 : t.id)
              );
            })
          ),
          [y, z] = (0, a.useState)(T),
          ...
          L = (0, a.useMemo)(
            () => t.map(({ title: e, id: t }) => ({ label: e, id: t, dataId: `sources-properties-editor-tabs-${t}` })),
            [t],
          );
