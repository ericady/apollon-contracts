      ...
      !(function (r, s, o, a) {
          ...
          (i.isFirst = !!s),
            ...
            (function (t, e) {
              ...
              (e.overallVelocityX = c.x),
                ...
                (e.scale = o ? ((l = o.pointers), (v = n), B(v[0], v[1], L) / B(l[0], l[1], L)) : 1),
                (e.rotation = o
                  ? (function (t, e) {
        ...
        E(tt, H, {
          handler: function (t) {
            ...
            1 & e && 0 === t.button && (this.pressed = !0),
              ...
              this.pressed &&
                (4 & e && (this.pressed = !1),
                this.callback(this.manager, e, { pointers: [t], changedPointers: [t], pointerType: k, srcEvent: t }));
          },
        });
          ...
          handler: function (t) {
            ...
            if ((1 === e && (this.started = !0), this.started)) {
              ...
              12 & e && i[0].length - i[1].length == 0 && (this.started = !1),
                this.callback(this.manager, e, { pointers: i[0], changedPointers: i[1], pointerType: F, srcEvent: t });
            }
          },
        });
        ...
        (xt.prototype = {
          ...
          E(Nt, zt, {
            ...
            attrTest: function (t) {
              return (
                zt.prototype.attrTest.call(this, t) && (2 & this.state || (!(2 & this.state) && this.directionTest(t)))
              );
            },
            emit: function (t) {
          ...
          E(kt, zt, {
            ...
            attrTest: function (t) {
              ...
              return (
                30 & i ? (e = t.overallVelocity) : 6 & i ? (e = t.overallVelocityX) : i & W && (e = t.overallVelocityY),
        ...
        function Lt(t, e) {
          ...
          (this.options = h({}, qt.defaults, e || {})),
            ...
            (this.oldCssProps = {}),
            (this.element = t),
            (this.input = new ((i = this).options.inputClass || (X ? st : Y ? ft : N ? dt : tt))(i, U)),
