(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [769],
  {
    ...
    11123: (e) => {
      e.exports = { wrapper: 'wrapper-M14KUVdG', emojiItem: 'emojiItem-M14KUVdG', hovered: 'hovered-M14KUVdG' };
    },
    17373: (e) => {
      e.exports = { wrapper: 'wrapper-hoWtpNyh', isActive: 'isActive-hoWtpNyh', button: 'button-hoWtpNyh' };
    },
    12134: (e) => {
    ...
    37558: (e, t, n) => {
      ...
      class a extends r.PureComponent {
        ...
        componentDidUpdate(e, t) {
          !t.stack.length && this.state.stack.length && ((0, o.setFixedBodyState)(!0), (this._isBodyFixed = !0)),
            t.stack.length &&
    ...
    41590: (e, t, n) => {
        ...
        return (
          ...
          r.createElement(
            ...
            r.createElement(
              ...
              f === p.currentDrawer && r.createElement('div', { className: u.backdrop, onClick: n }),
              r.createElement(
                h,
                { className: a(d.drawer, u[`position${t}`], v), ref: w, 'data-name': e['data-name'] },
                m,
              ),
            ),
          )
      ...
      const h = (0, r.forwardRef)((e, t) => {
        ...
        return r.createElement(m.TouchScrollContainer, { className: a(u.drawer, n), tabIndex: -1, ref: t, ...o });
      });
    },
    173: (e, t, n) => {
      'use strict';
    ...
    47291: (e, t, n) => {
      ...
      function h(e) {
        ...
        return r.createElement(
          v.Provider,
          { value: (0, r.useMemo)(() => ({ size: i, onSelect: l, ItemComponent: s, RowComponent: m }), [i, l, s, m]) },
      ...
      const d = r.memo((e) => {
        const { style: t, index: n, data: o } = e,
          a = o[n],
          { size: i, onSelect: l, ItemComponent: u, RowComponent: h = s.EmojisRow } = (0, m.useEnsuredContext)(v);
        return 'title' === a.type
          ? r.createElement('div', { style: t }, r.createElement(c, { title: a.relatedTitle }))
          : r.createElement(
              'div',
              { style: t },
              r.createElement(h, { emojis: a.content, itemSize: i, onEmojiClick: l, ItemComponent: u }),
            );
      });
    },
    38297: (e, t, n) => {
      ...
      function w(e) {
              ...
              (function (e, t) {
                ...
                return (
                  e.forEach(({ title: e, emojis: r }) => {
                    ...
                    let o = [];
                    for (const a of r)
                      o.length < t ? o.push(a) : (n.push({ type: 'emojiRow', relatedTitle: e, content: o }), (o = [a]));
            ...
            const e = (0, i.ensureNotNull)(k.current),
              t = () => {
                ...
                if (0 === t.length || (t[0].parentElement && !C(t[0].parentElement, (0, i.ensureNotNull)(k.current)))) {
                  ...
                  if (null === n) return;
                  if (((0, h.becomeMainElement)(n), t.length > 0)) for (const e of t) (0, h.becomeSecondaryElement)(e);
                }
              };
            return (
        ...
        const [_, B] = (0, r.useState)((null === (t = L[0]) || void 0 === t ? void 0 : t.relatedTitle) || ''),
          R = (0, r.useCallback)((e) => {
            y.current || B(e);
          }, []);
        return r.createElement(
          ...
          r.createElement(c.GroupTabs, {
            ...
            onTabClick: function (e) {
              ...
              D(
                (function (e) {
                  return L.findIndex(({ relatedTitle: t, type: n }) => 'title' === n && t === e);
                })(e),
              );
            },
          }),
        ...
        function D(e) {
          var t;
          m.CheckMobile.iOS() && k.current && (k.current.style.overflow = 'hidden'),
            (y.current = !0),
            null === (t = N.current) || void 0 === t || t.scrollToItem(e, 'start'),
            requestAnimationFrame(() => {
              var t;
              null === (t = N.current) || void 0 === t || t.scrollToItem(e, 'start'),
                m.CheckMobile.iOS() && k.current && (k.current.style.overflow = 'auto'),
                (y.current = !1);
            });
        }
      }
      ...
      function b(e) {
        document.activeElement && (0, h.becomeSecondaryElement)(document.activeElement),
    ...
    26601: (e, t, n) => {
      ...
      var r = n(50959),
        ...
        l = n(11123);
      const c = r.memo((e) => {
        const { emojis: t, itemSize: n, onEmojiClick: o, ItemComponent: c, className: s } = e;
        return r.createElement(
          'div',
    ...
    85034: (e, t, n) => {
      ...
      function m(e) {
        ...
        return c.PLATFORM_ACCESSIBILITY_ENABLED
          ...
          : r.createElement('div', { className: a()(s.wrapper, n && s.isActive, m), onClick: h }, i);
        function h() {
          o(t);
        }
      }
      var u = n(12134);
      function v(e) {
        const { activeTab: t, tabs: n, onTabClick: o, className: l, tabClassName: c } = e;
        return r.createElement(
          i.Toolbar,
          { orientation: 'horizontal', className: a()(u.wrapper, l) },
          n.map(({ title: e, content: n }) =>
            r.createElement(m, { key: e, tab: e, className: c, isActive: t === e, onTabClick: o }, n),
          ),
        );
      }
    },
    ...
    83682: (e, t, n) => {
      ...
      const v = 34;
      function h(e) {
        const { className: t, emoji: n, size: o = v, onClick: i, ItemComponent: l = c } = e,
    ...
    54079: (e, t, n) => {
      ...
      const u = (0, r.forwardRef)(function (e, t) {
        const { onKeyDown: n, orientation: u, blurOnEscKeydown: v = !0, blurOnClick: h = !0, ...d } = e,
          p = l.PLATFORM_ACCESSIBILITY_ENABLED ? { role: 'toolbar', 'aria-orientation': u } : {},
