(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [5093],
  {
        ...
        (TradingView.isFeatureEnabled = (function (e) {
          ...
          return function (t) {
            return (
              ...
              ((!e[t] || -1 !== e[t]) &&
                (!!(
                  'true' === i.getItem(TradingView.FeatureToggle.force_prefix + t) ||
                  ...
                  (!(
                    'false' === i.getItem(TradingView.FeatureToggle.force_prefix + t) ||
                    (window.is_authenticated &&
                      'undefined' != typeof user &&
                      user.settings &&
    ...
    93251: (e, t, s) => {
      'use strict';
      s.d(t, { removeUsdFromCryptoPairLogos: () => a, resolveLogoUrls: () => o });
      var i = s(36279);
    ...
    33283: (e, t, s) => {
      ...
      const C = (0, c.humanReadableModifiers)(c.Modifiers.Alt, !1),
        ...
        A = (0, u.hotKeySerialize)({ keys: [C, 'Click', C, 'Enter'], text: '{0} + {1}, {2} + {3}' }),
        ...
        H = (0, u.hotKeySerialize)({ keys: [C, E, S], text: '{0} + {1} + {2}' }),
        ...
        j = { zoomInOut: !0, maximize: !0, scrollLeftRight: !0, resetScale: !0, goToRealtime: !0 };
      class Y {
        constructor(e, t, s) {
          (this._widget = (0, i.ensureNotNull)((0, d.parseHtml)(R).querySelector('.control-bar-wrapper'))),
            (this._controlBar = (0, i.ensureNotNull)(this._widget.querySelector('.control-bar'))),
            (this._back = (0, i.ensureNotNull)((0, d.parseHtml)(U).querySelector('.control-bar__btn--back-present'))),
          ...
          (this._buttons = {
            ...
            this._chart.withModel(this, () => {
              (this._chartModel = this._chart.model()),
                ...
                (this._resetScalesAvailable = this._chartModel.model().resetScalesAvailable().spawn()),
                this._resetScalesAvailable.subscribe(this._updateResetScalesButtonVisibility.bind(this), {
                  callWithLast: !0,
                });
        ...
        _check() {
          ...
          e !== this._backButtonVisible &&
            ((this._backButtonVisible = e), this._back.classList.toggle($, !this._backButtonVisible));
        }
        _initVisibility() {
        ...
        _getBtnGroup(e) {
          return (0, i.ensureDefined)(this._btnGroups.find((t) => t.classList.contains(e)));
        }
    ...
    85109: (e, t, s) => {
      ...
      class f {
        constructor(e, t, s) {
          (this._el = null),
            ...
            (this._updateLoadingState = (e = this._loading.value()) => {
              if (null !== this._el) {
                ...
                t.toggle(y.eyeLoading, e && !this._disabled.value()), t.toggle(y.loading, e);
              }
          ...
          (this._withActions = s.withActions),
            ...
            null !== this._valuesParentEl && (this._loader = new b(this._valuesParentEl, { className: y.loader })),
            ...
            this._withActions &&
              ((this._showActionsHandler = (0, m.wrapHandlerWithPreventEvent)(this._showActions.bind(this))),
              (this._hideActionsHandler = (0, m.wrapHandlerWithPreventEvent)(this._hideActions.bind(this))),
              ...
              null !== this._logoAndTitleParentEl &&
                (this._logoAndTitleParentEl.addEventListener('touchend', this._selectedSourceHandler),
                this._logoAndTitleParentEl.addEventListener('mousedown', this._selectedSourceHandler),
                S ||
                  (this._logoAndTitleParentEl.addEventListener('mouseenter', this._showActionsHandler),
                  this._logoAndTitleParentEl.addEventListener('mouseleave', this._hideActionsHandler)),
          ...
          if (null !== this._logoAndTitleParentEl) {
            ...
            (this._titleElements = []),
              this._withActions &&
                ...
                (this._logoAndTitleParentEl.removeEventListener('touchend', this._selectedSourceHandler),
                this._logoAndTitleParentEl.removeEventListener('mousedown', this._selectedSourceHandler),
                S ||
                  (this._logoAndTitleParentEl.removeEventListener('mouseenter', this._showActionsHandler),
                  this._logoAndTitleParentEl.removeEventListener('mouseleave', this._hideActionsHandler))),
              (this._logoAndTitleParentEl = null);
          }
        ...
        _renderTitle() {
          ...
          for (let s = 0; s < this._titlesSpawns.length; s++) {
            const i = null !== (e = this._titlesSpawns[s].title.value()) && void 0 !== e ? e : '',
              l = this._titlesSpawns[s].class,
              o = document.createElement('div');
            o.classList.add(y.title, l, 'apply-overflow-tooltip'),
              (o.dataset.name = 'legend-source-title'),
              i.length > 0
                ? (o.appendChild(document.createTextNode(i)), o.classList.add(y.withDot))
        ...
        _renderActions() {
          ...
          for (const s of this._model.actions()) {
            const i = (0, _.createActionElement)(s, y.button, y.buttonIcon, g.blockHidden, t);
            e.appendChild(i);
          }
        }
        _isWidthButtonsMode() {
        ...
        _updateValueVisibleHandler(e, t) {
          const s = (0, o.ensure)(this._valuesElements[e].value).closest(`.${y.valueItem}`);
        ...
        _updateShowValues() {
          null !== this._valuesAdditionalWrapperEl &&
            this._valuesAdditionalWrapperEl.classList.toggle(g.blockHidden, this._isValuesShouldBeHidden());
        }
        ...
        _updateShowTitles() {
          null !== this._logoAndTitleParentEl &&
            (this._logoAndTitleParentEl.classList.toggle(g.blockHidden, this._isTitleHidden.value()),
            null !== this._actionsParentEl &&
              this._actionsParentEl.classList.toggle(g.blockHidden, this._isTitleHidden.value()));
        }
        _updateValues() {
          this._removeValuesSpawnsSubscriptions(),
            this._createValuesSpawns(),
        ...
        _updateActionVisibilities(e) {
          null !== this._actionsParentEl &&
            this._actionsParentEl
              ...
              [e].classList.toggle(g.blockHidden, !this._actionsSpawnArray[e].visible.value());
        }
        ...
        _updateCustomTextColor() {
          ...
          const t = (0, o.ensureNotNull)(this._valuesParentEl).querySelectorAll(`.${y.valueTitle}`);
      ...
      class T {
        constructor(e, t) {
          (this._lastDrawnLogos = []),
            ...
            (this._updateLogoVisibility = (e) => {
              this._logoWrapper && this._logoWrapper.classList.toggle(y.hidden, !e);
            }),
            (this._updateSymbolLogo = async (e) => {
              var t, s, i, l, o, a, n, r, d;
              if ((null === this._logoWrapper && this._renderSymbolLogo(), (0, M.default)(this._lastDrawnLogos, e)))
                return;
              const u = await ((h = e),
              Promise.all(
                h.map((e) =>
              ...
              switch (u.length) {
                case 0:
                  null === (t = this._pairContainer) || void 0 === t || t.classList.add(y.hidden),
                    null === (s = this._logoContainer) || void 0 === s || s.classList.add(W),
                    this._updateSymbolLetter(),
                    null === (i = this._symbolLetterContainer) || void 0 === i || i.classList.remove(W),
                    (this._lastDrawnLogos = e);
                  break;
                case 1:
                  x(this._logoContainer, u[0]),
                    null === (l = this._pairContainer) || void 0 === l || l.classList.add(y.hidden),
                    null === (o = this._logoContainer) || void 0 === o || o.classList.remove(W),
                    null === (a = this._symbolLetterContainer) || void 0 === a || a.classList.add(W),
                    (this._lastDrawnLogos = e);
                  break;
                case 2:
                  x(this._primaryLogo, u[0]),
                    x(this._secondaryLogo, u[1]),
                    null === (n = this._pairContainer) || void 0 === n || n.classList.remove(y.hidden),
                    null === (r = this._logoContainer) || void 0 === r || r.classList.add(W),
                    null === (d = this._symbolLetterContainer) || void 0 === d || d.classList.add(W),
                    (this._lastDrawnLogos = e);
              }
            }),
            (this._model = e),
        ...
        _renderSymbolLogo() {
          if (!this._logoWrapper) {
            ...
            (this._secondaryLogo = s.appendChild(document.createElement('span'))).className = E()(
              (0, V.getLogoStyleClasses)('xxxsmall'),
              y.logo,
            );
            (this._primaryLogo = s.appendChild(document.createElement('span'))).className = E()(
              (0, V.getLogoStyleClasses)('xxxsmall'),
              y.logo,
            );
            (this._logoContainer = e.appendChild(document.createElement('span'))).className = E()(
              (0, k.getStyleClasses)('xxxsmall'),
              y.logo,
              W,
            );
            ((this._symbolLetterContainer = e.appendChild(document.createElement('span'))).className = E()(
              (0, k.getStyleClasses)('xxxsmall'),
              y.logo,
            )),
              this._updateSymbolLetter();
        ...
        _updateSymbolLetter() {
          ...
          if (this._symbolLetterContainer) {
            const t = (0, A.safeShortName)(null !== (e = this._model.symbol()) && void 0 !== e ? e : '')[0];
      ...
      class H extends f {
        constructor(e, t, s) {
          ...
          i && (this._symbolLogoRenderer = new T(i, (0, o.ensureNotNull)(this._logoAndTitleParentEl)));
        }
        destroy() {
          var e, t;
          super.destroy(),
        ...
        _updateFlaggedState() {
          ...
          (0, o.ensureNotNull)(this._el).classList.toggle(y.flagged, Boolean(this._flagged.value())),
            this._updateTitleMaxWidth();
        }
      }
      ...
      class P extends f {
          ...
          super(e, t, s),
            ...
            (this._updateSymbolLogoRenderer = (e) => {
              ...
              d.enabled('show_symbol_logo_for_compare_studies') &&
                (null === (t = this._symbolLogoRenderer) || void 0 === t || t.destroy(),
                (this._symbolLogoRenderer = e ? new T(e, (0, o.ensureNotNull)(this._logoAndTitleParentEl)) : null));
            }),
            ...
            s.withActions &&
              ...
              null !== this._logoAndTitleParentEl &&
                this._logoAndTitleParentEl.addEventListener(D, this._wheelClickHandler));
          const i = e.symbolLogoViewModel().value();
          this._updateSymbolLogoRenderer(i), e.symbolLogoViewModel().subscribe(this._updateSymbolLogoRenderer);
        }
        destroy() {
          var e;
          this._model.symbolLogoViewModel().unsubscribe(this._updateSymbolLogoRenderer),
            ...
            null !== this._wheelClickHandler &&
              null !== this._logoAndTitleParentEl &&
              this._logoAndTitleParentEl.removeEventListener(D, this._wheelClickHandler),
            super.destroy();
        }
        _updateShowLine() {
          if (null === this._el || !this._canUpdateRowVisibility) return;
          const e = !this._globalRowVisibility.value();
          e ? this._el.classList.toggle(g.blockHidden, e) : super._updateShowLine();
        }
        _getButtonsCount() {
          switch (this._mode) {
            case 4:
        ...
        _renderValues() {
          ...
          for (const s of t) {
            const t = document.createElement('div');
            t.classList.add(y.valueItem), t.classList.toggle(g.blockHidden, !s.visible.value());
            const i = document.createElement('div');
            ...
            void 0 !== l && (i.classList.add('apply-common-tooltip'), (i.title = l)),
              t.appendChild(i),
      ...
      class j {
        constructor(e, t, s) {
          (this._el = null),
            ...
            (this._toggleStateHandler = (0, m.wrapHandlerWithPreventEvent)(s.onCollapseDataSources)),
            (this._showObjectTreeHandler = (0, m.wrapHandlerWithPreventEvent)(s.onShowObjectsTreeDialog)),
            null !== this._el &&
        ...
        _updateThemedColor(e) {
          if (null !== this._el)
            if (e.length > 0) {
              ...
              this._el.style.backgroundColor = (0, r.rgbaToString)([t, s, i, (0, r.normalizeAlphaComponent)(0.8)]);
      ...
      class J {
        constructor(e, t) {
          (this._renderToggler = null),
            ...
            this._parentEl.classList.toggle(y.noWrap, !h.trackingModeIsAvailable),
            this._parentEl.classList.toggle(y.noActions, !this._options.withActions),
            this._parentEl.classList.toggle(y.touchMode, h.trackingModeIsAvailable),
        ...
        addMainDataSource(e, t) {
          this._renderMainDataSourceEl(),
            (this._mainDataSourceRenderer = new H(e, (0, o.ensureNotNull)(this._mainDataSourceEl), {
        ...
        updateMode(e) {
          ...
          this._parentEl.classList.toggle(y.directionColumn, s),
            this._parentEl.classList.toggle(y.hideUniportantValueItems, !u.CheckMobile.any() && e <= 272);
        }
        getMainSourceHeight() {
        ...
        _renderToggle(e) {
          this._options.showToggleButton &&
            (this._renderToggler = new j(e, this._options.themedColor, this._togglerOptions));
        }
        ...
        _showCollapsedDataSourcesTooltip() {
          (0, Y.showOnElement)(this._collapsedDataSourcesEl, { text: this._options.collapsedDataSourcesTitle.value() }),
        ...
        _addOutsideEventForHideTooltip() {
          null !== this._outsideEventForCollapsedTooltip && this._outsideEventForCollapsedTooltip(),
            (this._outsideEventForCollapsedTooltip = (0, q.addOutsideEventListener)(
        ...
        _updateCollapsedSourcesCount(e) {
          ...
          const t = 0 === e;
          this._collapsedDataSourcesWrapperEl.classList.toggle(g.blockHidden, t),
            t ||
        ...
        _updateLegendVisibility() {
          this._parentEl.classList.toggle(g.blockHidden, this._isAllLegendHidden.value()),
            null !== this._dataSourcesEl &&
              this._dataSourcesEl.classList.toggle(g.blockHidden, this._isStudiesLegendHidden.value());
        }
        ...
        _setCustomBg() {
          ...
          if (e) {
            ...
            i = (0, r.rgbaToString)([e, l, o, (0, r.normalizeAlphaComponent)(1 - s / 100)]);
          }
      ...
      const ne = new te.TranslatedString('show {title}', B.t(null, void 0, s(87358))),
      ...
      class he {
        ...
        _calcNewPosition(e) {
          ...
          if (e.hasOwnProperty('touches') && e.touches.length > 0)
            ...
            t = { clientX: (0, ie.isRtl)() ? s.right : s.left, clientY: s.top + s.height + 3 };
          } else {
            const s = e;
      ...
      var ce = s(93251),
        _e = (s(76266), s(36279)),
        pe = s(28986);
      const me = d.enabled('show_symbol_logos') && d.enabled('show_symbol_logo_in_legend'),
        ge = new (class {
          constructor(e = 0) {
      ...
      class ve {
        constructor(e, t) {
          (this._symbolLogoUrls = new a.WatchedValue([])),
            ...
            (this._source = e),
            (this._isLogoVisible = (0, pe.createWVFromGetterAndSubscription)(() => t.showLogo.value(), t.showLogo)),
        ...
        _quoteSymbolChanged() {
          ...
          (this._quoteDataForLogos = {
            ...
            'currency-logoid':
              null !== (t = null == i ? void 0 : i['currency-logoid']) && void 0 !== t
                ? t
                : null == a
                ? void 0
                : a['currency-logoid'],
            'base-currency-logoid':
              null !== (s = null == i ? void 0 : i['base-currency-logoid']) && void 0 !== s
                ? s
                : null == a
                ? void 0
        ...
        _updateLogoUrls() {
          if (this._quoteDataForLogos) {
            const e = (0, ce.removeUsdFromCryptoPairLogos)(
              (0, ce.resolveLogoUrls)(this._quoteDataForLogos, _e.LogoSize.Medium),
            );
        ...
        _onSourceSymbolResolved() {
          {
            ...
            1 === t.length
              ...
              : 2 === t.length && (this._quoteDataForLogos = { 'currency-logoid': t[0], 'base-currency-logoid': t[1] }),
              this._updateLogoUrls();
          }
        }
      }
      ...
      class Le extends he {
        constructor(e, t, s, i, l) {
          ...
          this._symbolLogoViewModel.setValue(be(t, o)),
            ...
            (this._isPriceSourceHidden = (0, K.createWVFromGetterAndSubscription)(
        ...
        _updateTitles() {
          ...
          this._titles.title.setValue((0, Q.clean)(e.title, !0)),
            ...
            this._titles.priceSource.setValue((0, Q.clean)(this._isPriceSourceHidden.value() ? '' : e.priceSource, !0));
        }
        _updateValues() {
      ...
      class Xe extends he {
        ...
        _getDisabledOnIntervalState() {
          return (
            !(!(0, We.isStudy)(this._source) && !(0, We.isStudyStub)(this._source)) && !this._source.isActualInterval()
          );
        }
        _getValuesHiddenValue() {
        ...
        _createActions() {
          ...
          if (
            Ye &&
            qe &&
            (!(0, We.isStudy)(this._source) || new xe.MetaInfoHelper(this._source.metaInfo()).hasUserEditableOptions())
          ) {
            const e = {
              iconMap: new Map([
                ['large', De],
      ...
      const lt = new te.TranslatedString('change symbol description visibility', B.t(null, void 0, s(26717))),
      ...
      function Ht(e, t) {
        const s = Tt(t);
        return 0 === e[s].entries.length ? Ht(e, s) : { dayIndex: s, entries: e[s].entries };
      }
      function Dt(e, t) {
        const s = xt(t);
        return 0 === e[s].entries.length ? Dt(e, s) : { dayIndex: s, entries: e[s].entries };
      }
      function Pt(e) {
      ...
      const Bt = {
        [At.WeekDays.MONDAY]: { title: kt.weekDaysShortNames[At.WeekDays.MONDAY], isActive: !1, entries: [] },
        [At.WeekDays.TUESDAY]: { title: kt.weekDaysShortNames[At.WeekDays.TUESDAY], isActive: !1, entries: [] },
        [At.WeekDays.WEDNESDAY]: { title: kt.weekDaysShortNames[At.WeekDays.WEDNESDAY], isActive: !1, entries: [] },
        [At.WeekDays.THURSDAY]: { title: kt.weekDaysShortNames[At.WeekDays.THURSDAY], isActive: !1, entries: [] },
        [At.WeekDays.FRIDAY]: { title: kt.weekDaysShortNames[At.WeekDays.FRIDAY], isActive: !1, entries: [] },
        [At.WeekDays.SATURDAY]: { title: kt.weekDaysShortNames[At.WeekDays.SATURDAY], isActive: !1, entries: [] },
        [At.WeekDays.SUNDAY]: { title: kt.weekDaysShortNames[At.WeekDays.SUNDAY], isActive: !1, entries: [] },
      };
      function It(e, t) {
        ...
        for (const i of t) {
          ...
          for (let l = 0; l < n.length; l++) {
            const o = n[l],
              ...
              u = (0, Ct.lowerbound)(e[t].entries, d, (e, t) => e.start.value < t),
              h = {
                start: { value: d, title: Pt(a), isFirstOrLastPoint: a === i.start() },
                end: { value: r / Lt.minutesPerDay, title: Pt(r), isFirstOrLastPoint: n.length - 1 === l },
                type: s,
                tooltip: Nt(i),
      ...
      class Rt {
        constructor(e) {
          (this.sessionsDays = new a.WatchedValue((0, n.clone)(Bt))),
            (this.todaySession = new a.WatchedValue((0, n.clone)({ entries: [] }))),
        ...
        currentTimeValue() {
          return null === this._todayInExchangeTime
            ? -1
            : Lt.get_minutes_from_midnight(this._todayInExchangeTime) / Lt.minutesPerDay;
        }
        timezone() {
          ...
          const s = this._createSubSessionSpecs(e),
            i =
              (l =
                ...
                new Date().getDay()) < At.WeekDays.SATURDAY
                ? l + 1
                : At.WeekDays.SUNDAY;
          var l;
          ...
          !(function (e) {
            ...
            for (const l of Object.keys(e)) {
              ...
              for (let e = 0; e < p; e++) {
                ...
                const r = l ? c.entries[c.entries.length - 1] : (0, o.ensureNotNull)(i),
                  d = {
                    start: {
            ...
            (function (e) {
              for (const i of Object.keys(e)) {
                ...
                r.start.isFirstOrLastPoint ||
                  (r.showStartForLastEntry = ((t = o), (s = e[a].entries), It(t[t.length - 1], s[s.length - 1]))),
                  d.end.isFirstOrLastPoint || (d.showEndForFirstEntry = zt(o, e[n].entries));
              }
              var t, s;
            })(a),
        ...
        _createSubSessionSpecs(e) {
          ...
          if (void 0 === e.subsessions)
            return new Map([[0, new Wt.SessionSpec(e.timezone, e.session, e.session_holidays, e.corrections)]]);
          const t = 'regular',
            s = 'premarket',
            i = 'postmarket',
            l = [t, s, i],
      ...
      function Qt(e) {
        const { segment: t, forceStart: s, forceEnd: i } = e,
          ...
          o = l < 0.03,
          a = { left: 100 * t.start.value + '%', width: `calc(${100 * l}% + ${o ? 2 : 0}px)` },
          n = C(
            jt.segment,
            Zt.get(t.type),
        ...
        return Ut.createElement('div', { className: n, style: a, 'data-tooltip': r });
      }
      function Kt(e) {
      ...
      function es(e) {
        ...
        !a.start.isFirstOrLastPoint && a.showStartForLastEntry
          ...
          : i.push(a.start);
        const n = !a.end.isFirstOrLastPoint && a.showEndForFirstEntry ? o.entries[0].end : a.end;
        if ((i[0].value !== n.value && i.push(n), 0 === i.length)) return null;
        i.sort((e, t) => e.value - t.value);
        const r = i.map((e) => Ut.createElement('div', { key: qt(e), className: jt.timeMark }, e.title)),
        ...
        return Ut.createElement(
          ...
          Ut.createElement(
            ...
            Ut.createElement('div', { className: u, style: { left: 100 * i[0].value + '%', width: `${d}%` } }, r),
          ),
        );
      }
      class ts {
          ...
          return (
            ...
            : (function (e) {
                const { key: t, className: s, now: i, timezone: l } = e,
                  o = (0, Gt.useWatchedValueReadonly)({ watchedValue: e.sessionDays }),
                ...
                return Ut.createElement(
                  ...
                  Ut.createElement(
                    ...
                    Ut.createElement(
                      ...
                      Ut.createElement('div', { className: jt.now, style: { left: 100 * i + '%' } }),
                    ),
                  ),
                  Ut.createElement(es, { sessionDays: o, currentTimeMark: i }),
                  Ut.createElement('div', { className: jt.timezone }, `${Jt}: ${l}`),
                );
              })({
                key: e,
                className: t,
      ...
      class Js extends os {
        ...
        setModel(e) {
          if ((this._dataUpdatedInfo.destroy(), null === e))
            return (this._model = e), void (this._dataUpdatedInfo = new a.WatchedValue(null).spawn());
        ...
        _shouldBeHiddenByStatus(e) {
          var t;
          return (
            !!(null === (t = this._options.shouldBeHiddenRegardlessOfStatus) || void 0 === t ? void 0 : t.value()) ||
        ...
        _updateStatus(e) {
          ...
          this._status.setValue(null !== (t = null == s ? void 0 : s.mode) && void 0 !== t ? t : null, !0),
        ...
        async _getHtmls() {
          ...
          try {
            ...
            js.logError(`Can't get exchange description, reason: ${(0, $s.errorToString)(e)}`);
          }
          for (const r of i) {
            const i = r.mode;
            if (
              ((l[i] = []),
              ['DelayToRealtime', 'DelayNoRealtime', 'DelayWithoutMarketAgreement', ...Ys].includes(i) &&
                (l[i].push(Vs.format({ symbolName: o, time: this._model.time().toString() })),
                ...
                'DelayWithoutMarketAgreement' === i &&
                  l[i].push(Ds.format({ listedExchange: this._model.listedExchange() })),
                this._options.subscriptionFullInfo &&
                  Ys.includes(i) &&
                  l[i].push(ks.format({ listedExchange: this._model.listedExchange() }))),
              'EOD' === i && (l[i] = [Ws]),
              'TickByTick' === i)
            ) {
              const o =
                    ...
                    : (0, is.htmlEscape)(
                        B.t(
                          null,
                          {
                            ...
                            replace: { amount: (null !== (e = r.updatePeriod) && void 0 !== e ? e : 1).toString() },
                            plural:
                  ...
                  void 0 === r.updatePeriod
                    ...
                    : (0, is.htmlEscape)(
                        B.t(
                          ...
                          {
                            count: r.updatePeriod,
                            replace: { amount: (null !== (t = r.updatePeriod) && void 0 !== t ? t : 1).toString() },
                            plural:
            ...
            if (null !== n && 'BATSToRealtime' === i) {
              ...
              0,
                l[i].push(
                  ...
                  '' !== e ? (0, is.htmlEscape)(Is).format({ exchange: e }) : (0, is.htmlEscape)(Bs),
                );
            }
          }
        ...
        _getShortTexts() {
          ...
          for (const o of i) {
            const i = o.mode;
            if (
              (['DelayToRealtime', 'DelayNoRealtime', ...Ys, 'DelayWithoutMarketAgreement'].includes(i) && (l[i] = Ss),
              'EOD' === i && (l[i] = fs),
              'TickByTick' === i)
            ) {
              const t =
                  ...
                  : (0, is.htmlEscape)(
                      B.t(
                        null,
                        {
                          ...
                          replace: {
                            amount: (null !== (e = o.updatePeriod) && void 0 !== e ? e : 1).toString(),
                          },
                        },
                        s(5223),
                      ),
            ...
            if ('BATSToRealtime' === i) {
              ...
              0, (l[i] = '' !== e ? Es.format({ exchange: e, originalExchange: Cs }) : Cs);
            }
          }
          return Object.keys(l).length > 0 ? l : null;
        }
        _updateBlinkingMode() {
          ...
          for (const s of e) if (!t.includes(s.mode)) return void this.isBlinkingMode.setValue(!0);
      ...
      class ai extends os {
        constructor(e, t, s) {
          super({ iconMap: ti, classNameMap: si, tooltipMap: ii, titleMap: li, titleColorMap: oi, size: t }),
        ...
        _getTooltip(e) {
          var t;
          return null !== (t = e ? this._getDataSourceErrorStatusCustomTitle() : null) && void 0 !== t
            ? t
            : super._getTooltip(e);
        }
        _getTitle(e) {
      ...
      class ci extends os {
        constructor(e, t) {
          super({ tooltipMap: ui, iconMap: ri, classNameMap: di, titleMap: ui, titleColorMap: hi, size: t }),
        ...
        async _updateFullTooltip() {
          ...
          const s = t.map((t, s) => {
            ...
            return {
              icon: this._getIcon(e),
              iconClassName: this._getFullTooltipIconClassNames(e),
              title: null !== (i = t.title) && void 0 !== i ? i : 0 === s ? this._getTitle(e) : null,
              titleColor: this._getTitleColor(e),
        ...
        _updateStatus(e) {
          var t, s;
          const i = null !== (s = null === (t = e[0]) || void 0 === t ? void 0 : t.severity) && void 0 !== s ? s : null,
        ...
        _getDataProblemCustomTitle() {
          var e, t;
          return (
            (null === (t = null === (e = this._dataProblems.value()) || void 0 === e ? void 0 : e[0]) || void 0 === t
              ? void 0
              : t.title) || null
          );
        }
      ...
      function Vi(e, t, s) {
        for (const i of t) for (const t of i.split(' ')) e.classList.toggle(t, s);
      }
      class ki {
      ...
      class Ai {
        ...
        _updateFullInfo(e) {
          ...
          const t = e.map((e) => {
            ...
            return {
              ...
              title: e.title,
              titleColor: null !== (s = e.color) && void 0 !== s ? s : this.customColor().value(),
              html: e.content,
              size: this.size(),
        ...
        _buildAction(e) {
          var t;
          return e && e.onClick
            ? { text: null !== (t = e.text) && void 0 !== t ? t : '', tooltip: e.tooltip, onClick: e.onClick }
            : null;
        }
        _unSyncModel() {
          this._symbolModel &&
        ...
        _syncModel() {
          ...
          this._visible.setValue(
            null !== (t = null === (e = this._symbolModel) || void 0 === e ? void 0 : e.visible().value()) &&
              void 0 !== t &&
              t,
          ),
            this._color.setValue(
              null !== (i = null === (s = this._symbolModel) || void 0 === s ? void 0 : s.color().value()) &&
                void 0 !== i
                ? i
                : null,
            ),
            this._icon.setValue(
              null !== (o = null === (l = this._symbolModel) || void 0 === l ? void 0 : l.icon().value()) &&
                void 0 !== o
                ? o
                : null,
            ),
            this._tooltip.setValue(
              null !== (n = null === (a = this._symbolModel) || void 0 === a ? void 0 : a.tooltip().value()) &&
                void 0 !== n
                ? n
                : null,
            ),
            this._updateFullInfo(
              null !== (d = null === (r = this._symbolModel) || void 0 === r ? void 0 : r.tooltipContent().value()) &&
                void 0 !== d
                ? d
                : null,
            ),
      ...
      const zi = B.t(null, void 0, s(83949)),
        ...
        al = { market: Ui, pre_market: Gi, post_market: $i, out_of_session: ji, holiday: Yi };
      function nl(e) {
        return B.t(null, { plural: '{number} minutes', count: e }, s(67151)).format({ number: e.toString() });
      }
      function rl(e) {
        return B.t(null, { plural: '{number} hours', count: e }, s(24430)).format({ number: e.toString() });
      }
      function dl(e) {
        ...
        return 0 === t && 0 === i && 0 === l
          ...
          ? Zi.format({
              days:
                ((o = t), B.t(null, { plural: '{number} days', count: o }, s(58609)).format({ number: o.toString() })),
              hours: rl(i),
            })
          : i > 0
      ...
      const ul = {
          market: (e) => ('post_market' === e.status ? Ki : Qi).format({ remainingTime: dl(e.remainingSeconds) }),
          pre_market: (e) => Ji.format({ remainingTime: dl(e.remainingSeconds) }),
          post_market: (e) => Qi.format({ remainingTime: dl(e.remainingSeconds) }),
          out_of_session: (e) =>
            ('pre_market' === e.status ? el : Ji).format({ remainingTime: dl(e.remainingSeconds) }),
          holiday: (e) => ('pre_market' === e.status ? el : Ji).format({ remainingTime: dl(e.remainingSeconds) }),
        },
        hl = new Map([
          ['market', null],
          ['pre_market', null],
      ...
      class cl extends os {
        constructor(e, t) {
          super({
            ...
            this.setModel(e),
            et.showMarketOpenStatusProperty.subscribe(this, this._showMarketOpenStatusPropertyChanged);
        }
        destroy() {
        ...
        _getIcon(e) {
          return this._isExpiredFutures() ? expiredIconMap.get(this._size) || null : super._getIcon(e);
        }
        _getClassName(e) {
        ...
        _isExpiredFutures() {
          ...
          return (
            null !==
              (s =
                null ===
                  (t = null === (e = this._model) || void 0 === e ? void 0 : e.futuresContractExpirationTime()) ||
                void 0 === t
                  ? void 0
                  : t.expired().value()) &&
            void 0 !== s &&
      ...
      class _l {
        constructor(e, t) {
          ...
          (this.errorWidgetIsShown = new a.WatchedValue(!1)),
            ...
            (this._renderer = new ki(this._size, this._tooltips, { onClick: this._handleToggleDropdown.bind(this) })),
            ...
            (this._handleDropdownMenuClose = () => {
              var e;
              (this._menuOpened = !1),
                null === (e = this._source.symbol()) || void 0 === e || e.unsubscribe(this._handleDropdownMenuClose),
            ...
            (this._source = e),
            (this._symbol =
              null !== (i = null === (s = e.symbol()) || void 0 === s ? void 0 : s.spawn()) && void 0 !== i ? i : null),
            (this._options = t),
        ...
        _isPrimaryWidgetShown() {
          var e, t;
          return (
            null !== (t = null === (e = this._source.isSymbolInvalid()) || void 0 === e ? void 0 : e.value()) &&
            void 0 !== t &&
            t
          );
        }
        ...
        _recreateWidgets() {
          ...
          if (this._options.sourceStatusesEnabled) {
            ...
            if (null === this._dataSourceErrorStatusViewModel) {
              ...
              const e = { visible: this._dataSourceHasErrorVisible, model: this._dataSourceErrorStatusViewModel };
          ...
          if (this._options.marketStatusEnabled) {
            ...
            if (null === this._marketStatusViewModel) {
              ...
              null !== t &&
                ((this._sessionWidget = new ts(this._source)), (s.additionalWidgets = [this._sessionWidget])),
          ...
          if (
            null !== (a = null === (l = (i = this._source).isMainSeries) || void 0 === l ? void 0 : l.call(i)) &&
            void 0 !== a &&
            a
          ) {
            const e = Li.CustomStatusModel.getInstance(),
              t =
                null !== (r = null === (n = this._symbol) || void 0 === n ? void 0 : n.value()) && void 0 !== r
                  ? r
                  : null;
            if (null === this._customStatusViewModel) {
              (this._customStatusViewModel = new Ai(e, this._size)), this._customStatusViewModel.setSymbol(t);
            ...
            } else this._customStatusViewModel.setModel(e), this._customStatusViewModel.setSymbol(t);
          }
        }
        _updateTooltips() {
          const e = [];
        ...
        _handleToggleDropdown(e) {
          ...
          (this._menuPosition = e),
            ...
            this._menuOpened &&
              (null === (t = this._source.symbol()) || void 0 === t || t.subscribe(this._handleDropdownMenuClose),
              (s = `Open full tooltip for statuses: ${this._tooltips.value().join(', ')}`),
              (0, I.trackEvent)('GUI', "Statuses widget's action", s)),
            this._updateDropdownMenu();
        }
        _updateDropdownMenu() {
          Promise.all([s.e(3842), s.e(5649), s.e(2731), s.e(962), s.e(3179), s.e(8643)])
            .then(s.bind(s, 52685))
            .then((e) => {
              e.render({
      ...
      class gl {
        constructor(e, t) {
          ...
          this._dataSourceErrorStatus = (0, K.createWVFromGetterAndSubscriptions)(
        ...
        isMainSeries() {
          var e, t, s;
          return (
            null !== (s = null === (t = (e = this._source).isMainSeries) || void 0 === t ? void 0 : t.call(e)) &&
            void 0 !== s &&
            s
          );
        }
        ...
        constructor(e, t) {
          super(e, t),
            ...
            this._marketStatus.subscribe(
              (e) => {
                null === e &&
                  (null !== this._forceDisableHiddenStateTimeout && clearTimeout(this._forceDisableHiddenStateTimeout),
                  this._forceDisableHiddenState.setValue(!1),
                  (this._forceDisableHiddenStateTimeout = setTimeout(() => {
                    (this._forceDisableHiddenStateTimeout = null), this._forceDisableHiddenState.setValue(!0);
                  }, 3500)));
              },
              { callWithLast: !0 },
            ),
      ...
      class Ml {
        ...
        destroy() {
          ...
          e.scalesProperties.childs().textColor.unsubscribeAll(this),
            ...
            e.paneProperties.childs().legendProperties.childs().backgroundTransparency.unsubscribeAll(this);
        }
        ...
        onShowLegendWidgetContextMenu(e, t) {
          ...
          return (function (e, t, s, i, l, o) {
            ...
            if (void 0 !== n) {
              const e = n.get(1);
              void 0 !== e && e.length > 0 && (a.push(...e), a.push(new Je.Separator()));
            }
            ...
            if (
              (e
                .model()
                .priceDataSources()
                .some((e) => !(0, Oe.isActingAsSymbolSource)(e) && e.showInObjectTree()) &&
                (a.push(
                  new Je.Action({
            ...
            return (
              t.settings &&
                (a[a.length - 1] instanceof Je.Separator || a.push(new Je.Separator()),
                a.push(
                  new Je.Action({
              ...
              Qe.ContextMenuManager.showMenu(a, l, void 0, { menuName: 'LegendPropertiesContextMenu' }, o)
            );
        ...
        updateLayout() {
          ...
          if (0 === n)
            for (let t = e.length - 1; t >= 0; t--) {
              const s = e[t];
              l.push(
                new Xe(this._model, s, this._dataSourceViewModelsOptions, this._callbacks, this._options.contextMenu),
              ),
            ...
            for (let s = e.length - 1; s >= 0; s--) {
              ...
              this._dataSourceViewModels[t]
                ? (this._dataSourceViewModels[t].updateSource(i),
                  this._dataSourcesStatusesWidgets[t].updateSource(this._statusSourceAdapter(i)))
                : (l.push(
                    new Xe(
                      this._model,
                      i,
        ...
        _updateWidgetModeByHeight() {
          null !== this._size &&
            ((this._availableHeight = 0.8 * this._size.height), this._updateCollapsedSourcesModeThrottle());
        }
        _updateCustomWidgetModeBySize() {
          if (null === this._size) return;
          const e = (0, i.size)({ width: this._availableWidth(), height: this._size.height });
          ...
          if (this._availableHeight > 0 && e > 2) {
            ...
            if (null !== i) {
              ...
              if (e > a + 1) {
                ...
                for (let i = 0; i < e; i++) {
                  const e = i < a;
                  this._dataSourceViewModels[i].setGlobalVisibility(e && (!t || 0 === i)),
                    e || (s += `${0 === s.length ? '' : ', '}${this._dataSourceViewModels[i].getFullTitle()}`);
                }
                return (
                  this._collapsedDataSourcesTitle.setValue(s), void this._collapsedDataSourcesCount.setValue(e - a)
                );
              }
            }
          }
    ...
    69289: (e, t, s) => {
      ...
      class m {
        ...
        _updateWidgetMode() {
          ...
          s.classList.toggle(p.blockHidden, e || t),
            i.classList.toggle(p.blockHidden, e || !t || !this._actions.more.visible.value());
        }
        _render() {
        ...
        _updateThemedColor(e) {
          if (e.length > 0) {
            ...
            this._parentEl.style.color = (0, u.rgbaToString)([t, s, i, (0, u.normalizeAlphaComponent)(0.8)]);
      ...
      const N = i.mobiletouch,
        ...
        Z = (0, L.hotKeySerialize)({ keys: [(0, a.humanReadableModifiers)(a.Modifiers.Mod, !1)], text: `{0} + ${Y}` });
      class X {
        constructor(e, t, s, i, l) {
          (this._actions = {}),
            (this._moreCMShown = !1),
            ...
            (this._maximizeButtonVisibility = new k.WatchedValue(this._getMaximizeButtonVisibility())),
            (this._minimizeButtonVisibility = new k.WatchedValue(this._getMinimizeButtonVisibility())),
            (this._collapseButtonVisibility = new k.WatchedValue(this._getCollapseButtonVisibility())),
            (this._restoreButtonVisibility = new k.WatchedValue(this._getRestoreButtonVisibility())),
            this._createActions(),
            (this._visibilityTypeProperty = (0, n.actualBehavior)()),
        ...
        _getCollapseButtonVisibility() {
          ...
          const e = this._paneWidget.state();
          return (
            !e.maximized().value() && !e.collapsed().value() && this._model.model().paneCollapsingAvailable().value()
          );
        }
