(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [4403],
  {
    ...
    94720: (e, t, n) => {
      ...
      function u(e) {
        const { startIcon: t, icon: n, iconOnly: r, children: s, endIcon: i, primaryText: c, secondaryText: u } = e,
          d = null != t ? t : n,
          h = !(t || n || i || r) && !s && c && u;
            ...
            (function (e) {
              return (
                ...
                o.createElement(
                  ...
                  o.createElement('span', { className: a()['primary-text'] }, ' ', e.primaryText, ' '),
                  'string' == typeof e.secondaryText
                    ? o.createElement('span', { className: a()['secondary-text'] }, ' ', e.secondaryText, ' ')
                    : o.createElement(
                        'span',
      ...
      function f(e) {
        const { reference: t, ...n } = e,
          { isGrouped: r, cellState: s, disablePositionAdjustment: l } = (0, o.useContext)(d.ControlGroupContext),
          i = c({ ...n, isGrouped: r, cellState: s, disablePositionAdjustment: l });
        return o.createElement('button', { ...m(n), className: i, ref: t }, o.createElement(u, { ...n }));
      }
      ...
      function C(e) {
        const { intent: t, size: n, appearance: o, useFullWidth: r, icon: s, ...l } = e;
        return { ...l, color: b(t), size: g(n), variant: p(o), stretch: r, startIcon: s };
      }
      function R(e) {
    ...
    67029: (e, t, n) => {
      ...
      function g(e, t) {
        const {
          ...
          { isGrouped: N, cellState: B, disablePositionAdjustment: z = !1 } = (0, o.useContext)(a.ControlGroupContext),
    ...
    78274: (e, t, n) => {
      ...
      function i(e) {
        ...
        return o.createElement('span', { className: r(l()['inner-slot'], n && l().interactive, s && l().icon, t) }, i);
      }
      function a(e) {
        const { className: t, children: n } = e;
        return o.createElement('span', { className: r(l()['inner-slot'], l()['inner-middle-slot'], t) }, n);
      }
      function c(e) {
        const { className: t, interactive: n = !0, icon: s = !1, children: i } = e;
        return o.createElement('span', { className: r(l()['inner-slot'], n && l().interactive, s && l().icon, t) }, i);
        ...
        return o.createElement(h.ControlSkeleton, {
          ...
          middleSlot: o.createElement(
            ...
            o.createElement('input', {
              ...V,
              className: r(p().input, p()[`size-${W}`], _, T && p()['with-start-slot'], A && p()['with-end-slot']),
              disabled: I,
              readOnly: K,
              ref: j,
            }),
    ...
    48027: (e, t, n) => {
      ...
      function s(e) {
        ...
        return { ...e, intent: s || (a ? 'primary' : 'default'), highlight: null != l ? l : a, onFocus: u, onBlur: d };
      }
    },
    7953: (e, t, n) => {
      'use strict';
      ...
      var o = n(50959),
        ...
        a = n(22064);
      function c(e) {
        const { id: t, listboxId: n, disabled: c, buttonTabIndex: u = 0, onFocus: d, onBlur: h, onClick: m } = e,
          [f, p] = (0, o.useState)(!1),
          [b, g] = (0, l.useFocus)(),
          C = b || f,
    ...
    36762: (e, t, n) => {
      ...
      function l(e, t, n, l, i, a = {}, c) {
        const u = (0, o.useCallback)(
          ...
          { next: p = f.next, previous: b = f.previous, first: g = f.first, last: C = f.last } = a;
      ...
      function c(e, t, n, o, r, l) {
        ...
        if (
          ...
          const t = (function (e, t, n, o = 0) {
              ...
              return { start: t[r.start] - n[r.start] - o, middle: s - l, end: t[r.end] - n[r.end] + o };
            })(e, o, r, l.additionalScroll),
            n = (function (e) {
        ...
        })({ ...l, target: t, targetRect: o, wrap: n, wrapRect: r, additionalScroll: c, direction: e });
      }
      class u {
        constructor(e = null) {
      ...
      function d(e = {}) {
        const { activeItem: t, getKey: n, ...s } = e,
          ...
          a = (function (e) {
            ...
            return (
              (0, o.useEffect)(() => ((t.current = new u(e)), () => (0, r.ensureNotNull)(t.current).destroy()), []), t
            );
          })(l.current),
          c = (0, o.useCallback)(() => {
            null !== a.current &&
              ...
              o.createElement(
                ...
                o.createElement(
                  ...
                  f &&
                    o.createElement(
                      l.Button,
                      { className: b, name: 'cancel', appearance: 'stroke', onClick: this._handleCancel },
                  ...
                  o.createElement(
                    ...
                    o.createElement(
                      l.Button,
                      { className: p, disabled: u, name: 'submit', onClick: h, 'data-name': 'submit-button' },
