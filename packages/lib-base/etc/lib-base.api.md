...
{
  constructor(
    readable: _ReadableLiquityWithExtraParams<T>,
    cache: _LiquityReadCache<T>
  );
  // (undocumented)
...
// @internal (undocumented)
export interface _LiquityReadCache<T extends unknown[]>
  extends _LiquityReadCacheBase<T> {
  // (undocumented)
  getTroves(
    params: TroveListingParams & {
      beforeRedistribution: true;
...
export type _LiquityReadCacheBase<T extends unknown[]> = {
  [P in keyof ReadableLiquity]: ReadableLiquity[P] extends (
    ...args: infer A
  ) => Promise<infer R>
...
// @public
export type LiquityReceipt<R = unknown, D = unknown> =
  | PendingReceipt
  | MinedReceipt<R, D>;
...
export abstract class LiquityStore<T = unknown> {
  ...
  subscribe(
    listener: (params: LiquityStoreListenerParams<T>) => void
  ): () => void;
  // @internal (undocumented)
  protected _update(
...
// @public
export type LiquityStoreState<T = unknown> = LiquityStoreBaseState &
...
export interface PopulatableLiquity<R = unknown, S = unknown, P = unknown>
  ...
  closeTrove(): Promise<
    PopulatedLiquityTransaction<
      P,
      SentLiquityTransaction<S, LiquityReceipt<R, TroveClosureDetails>>
    >
  >;
  depositCollateral(
    amount: Decimalish
  ...
  depositLUSDInStabilityPool(
    ...
    PopulatedLiquityTransaction<
      ...
      SentLiquityTransaction<
        S,
        LiquityReceipt<R, StabilityDepositChangeDetails>
      >
    >
  >;
  ...
  liquidate(
    ...
    PopulatedLiquityTransaction<
      P,
      SentLiquityTransaction<S, LiquityReceipt<R, LiquidationDetails>>
    >
  >;
  liquidateUpTo(
  ...
  transferCollateralGainToTrove(): Promise<
    PopulatedLiquityTransaction<
      ...
      SentLiquityTransaction<
        S,
        LiquityReceipt<R, CollateralGainTransferDetails>
      >
    >
  >;
  unstakeLQTY(
  ...
  withdrawGainsFromStabilityPool(): Promise<
    PopulatedLiquityTransaction<
      ...
      SentLiquityTransaction<
        S,
        LiquityReceipt<R, StabilityPoolGainsWithdrawalDetails>
      >
    >
  >;
...
export interface SentLiquityTransaction<
  S = unknown,
  T extends LiquityReceipt = LiquityReceipt,
> {
...
export class TroveWithPendingRedistribution extends UserTrove {
  ...
  constructor(
    ...
    debt?: Decimal,
    stake?: Decimal,
    snapshotOfTotalRedistributed?: Trove
  );
  // (undocumented)
